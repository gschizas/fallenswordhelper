...
var fsSystem = {
	...
	findNode: function(xpath, doc) {
		var nodes=fsSystem.findNodes(xpath, doc);
	...
	findNodeText: function(xpath, doc) {
		var node=fsSystem.findNode(xpath, doc);
		if (!node) return null;
		nodes.textContent;
	},
...
Number.prototype.padZero = fsSystem.padZero;
String.prototype.repeat = fsSystem.repeatString;
Array.prototype.filterBy = fsSystem.filterBy;
