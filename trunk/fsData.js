	...
	buffList: function() {
		if (!Data.buffArray) {
			Data.buffArray = [
				...
				{name: "Sacrifice",          stamina: 25, "duration": 90,   treeId: 2, skillId: 75, buff: "+0.02% per point additional xp and -0.25% per point less gold for defeating creatures in combat.", nicks: "sacrifice,sac"},
