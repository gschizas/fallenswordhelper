	...
	buffList: function() {
		if (!Data.buffArray) {
			Data.buffArray = [
				...
				{name: "Cursed Rune",        stamina: 30, "duration": 120,  minCastLevel: 1000,treeId: 0, skillId: 89, buff: "0.2% per point stat bonus to your equipped rune. Excludes \\'Gain\\' bonuses. Double chance of durability loss. Prevents Unbreakable from working while active.", nicks: "cursed rune,cring"},
				...
				{name: "Cursed Ring",        stamina: 30, "duration": 120,  minCastLevel: 1400,treeId: 0, skillId: 88, buff: "0.2% per point stat bonus to your equipped ring. Excludes \\'Gain\\' bonuses. Double chance of durability loss. Prevents Unbreakable from working while active.", nicks: "cursed rune,crune"},
				...
				{name: "Side Step",          stamina: 30, "duration": 90,   minCastLevel: 1000,treeId: 1, skillId: 86, buff: "Increases the maximum percentage (above 100%) of the Dodge enhancement by +0.2% per point.", nicks: "side step,ss"},
				...
				{name: "Golden Shield",      stamina: 30, "duration": 60,   minCastLevel: 1200,treeId: 2, skillId: 103,buff: "+0.05% per point chance to double your armor and defense at the start of combat.", nicks: "golden shield,gold,gs"},
