var ssLayout = {
	...
	injectMenu: function() {
		...
		ssLayout.injectOneMenu("Quest Manager", "index.php?cmd=notepad&subcmd=questmanager", 7, "menuSource_0");
		ssLayout.injectOneMenu("Inventory Manager", "index.php?cmd=notepad&subcmd=invmanager", 8, "menuSource_0");
		ssLayout.injectOneMenu("Recipe Manager", "index.php?cmd=notepad&subcmd=recipemanager", 9, "menuSource_0");
		ssLayout.injectOneMenu("Guild Inventory", "index.php?cmd=notepad&subcmd=guildinvmanager", 2, "menuSource_5");
