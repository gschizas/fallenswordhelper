	...
	questMatrix: function() {
		if (!Data.questArray) {
			var questArray = [
				...
				{'questName':'Revenge', 'level':47, 'location':'Highridge Crag (Vale)'},
				{'questName':'The Antidote', 'level':49, 'location':'Highridge Crag (Yarn Retreat)'},
				{'questName':'Wild Tales', 'level':50, 'location':'Highridge Crag (Shard Gate)'},
