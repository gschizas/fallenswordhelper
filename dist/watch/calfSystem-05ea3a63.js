...
const allowBack = () => { runDefault(import('./allowBack-d90033d6.js')); };
const injectBioWidgets = () => { runDefault(import('./bioWidgets-809281f6.js')); };
const injectGuild = () => { runDefault(import('./guild-17ca6a61.js')); };
const injectProfile = () => { runDefault(import('./profile-1245c023.js')); };
const injectProfileDropItems = () => { runDefault(import('./injectProfileDropItems-60a082b7.js')); };
const injectQuestBookFull = () => { runDefault(import('./injectQuestBookFull-f44bb9a1.js')); };
const injectStoreItems = () => { runDefault(import('./injectStoreItems-c78c0597.js')); };
const inventing = () => { runDefault(import('./inventing-299e0d82.js')); };
const viewArchive = () => { runDefault(import('./viewArchive-4b75ce47.js')); };

const injectBuffLog = (i) => { import('./injectBuffLog-40350952.js').then((m) => m.default(i)); };
const injectFsBoxContent = (i) => { import('./injectFsBoxContent-eabbf08b.js').then((m) => m.default(i)); };
const injectMonsterLog = (i) => { import('./monstorLog-cb6e9e72.js').then((m) => m.default(i)); };
const injectNotepadShowLogs = (i) => { import('./combatLog-1854d329.js').then((m) => m.default(i)); };
const injectOnlinePlayers = (i) => { import('./injectOnlinePlayers-0d2989c5.js').then((m) => m.default(i)); };
const injectRecipeManager = (i) => { import('./recipeMgr-630c773d.js').then((m) => m.default(i)); };
const insertQuickExtract = (i) => { import('./quickExtract-28ed4b16.js').then((m) => m.default(i)); };
const insertQuickWear = (i) => { import('./quickWear-985ccb0f.js').then((m) => m.default(i)); };

const injectAuctionSearch = (i) => { import('./lists-9943f9c2.js').then((m) => m.injectAuctionSearch(i)); };
const injectQuickLinkManager = (i) => { import('./lists-9943f9c2.js').then((m) => m.injectQuickLinkManager(i)); };
const injectFindBuffs = (i) => { import('./findBuffs-5daba6ea.js').then((m) => m.injectFindBuffs(i)); };
const injectFindOther = (i) => { import('./findBuffs-5daba6ea.js').then((m) => m.injectFindOther(i)); };
...
const injectArena = () => { runDefault(import('./arena-2ebe777f.js').then(function (n) { return n.a; })); };
const arenaDoJoin = () => { runDefault(import('./arenaDoJoin-7c6a8d66.js')); };
const arenaJoin = () => {
  runDefault(import('./arenaJoin-e4b1eb51.js'));
};
const completedArenas = () => {
  runDefault(import('./completedArenas-c8b69307.js'));
};
const setupMoves = () => {
  runDefault(import('./setup-2ae04937.js'));
};
const storeMoves = () => { runDefault(import('./store-b7a8052f.js')); };
const results = () => { runDefault(import('./results-e955e5ed.js')); };
...
const injectAuctionHouse = () => {
  runDefault(import('./injectAuctionHouse-a1104872.js'));
};
const quickCreate = () => {
  runDefault(import('./quickCreate-80e9c3de.js'));
};
...
const composingBreakdown = () => { runDefault(import('./breakdown-cbde03d2.js')); };
const composingCreate = () => { runDefault(import('./composingCreate-a5111aaa.js')); };
const injectComposing = () => { runDefault(import('./composing-9e712061.js')); };
...
const injectAdvisor = () => {
  runDefault(import('./guildAdvisor-3c13bde5.js'));
};
...
const injectGroups = () => {
  runDefault(import('./groups-f6284625.js'));
};
const injectGroupStats = () => {
  runDefault(import('./injectGroupStats-b551d258.js'));
};
...
const guildHall = () => { runDefault(import('./hall-ed296b86.js')); };
...
const injectGuildAddTagsWidgets = () => {
  runDefault(import('./injectGuildAddTagsWidgets-dbda1a70.js'));
};
const injectReportPaint = () => {
  runDefault(import('./guildReport-83028c0e.js'));
};
...
const guildChat = () => { runDefault(import('./guildChat-93733c16.js')); };
const guildLog = () => { runDefault(import('./guildLog-4d667c43.js')); };
const guildMailbox = () => {
  runDefault(import('./guildMailbox-063e9ae2.js'));
};
const injectGuildBank = () => {
  runDefault(import('./injectGuildBank-de01869e.js'));
};
const injectGuildRanks = () => {
  runDefault(import('./rank-8cac704d.js'));
};
const injectRPUpgrades = () => {
  runDefault(import('./injectRPUpgrades-75594003.js'));
};
const injectScouttower = () => {
  runDefault(import('./injectScouttower-b7cccea8.js'));
};
...
const itemsView = () => { runDefault(import('./itemsView-8acbf0fe.js')); };
...
const playerLog = () => { runDefault(import('./playerLog-692ac575.js')); };
const outbox = () => { runDefault(import('./outbox-bd80ef95.js')); };
...
const newsFsbox = () => { runDefault(import('./newsFsbox-c956ea8a.js')); };
const newsShoutbox = () => { runDefault(import('./newsShoutbox-e42aa6d9.js')); };
...
const unknownPage = () => { runDefault(import('./unknownPage-6b36099f.js')); };
...
const injectInventoryManagerNew = () => {
  runDefault(import('./inventory-421fd6fd.js'));
};
const injectNewGuildLog = () => {
  runDefault(import('./newGuildLog-17336ed7.js'));
};
const injectNotepad = () => {
  runDefault(import('./injectNotepad-7d4cfe2c.js'));
};
const injectSaveSettings = () => { runDefault(import('./load-7384352c.js')); };
const reliclist = () => {
  runDefault(import('./reliclist-1dd7a890.js'));
};
const advisor$1 = () => { runDefault(import('./advisor-0954b734.js')); };
const crawler = () => {
  runDefault(import('./crawler-76c329a5.js'));
};
const newGuildLog5 = () => {
  runDefault(import('./newGuildLog5-f727bed3.js'));
};
const whosGotWhat = () => {
  runDefault(import('./whosGotWhat-190dbd48.js'));
};
...
const injectQuestTracker = () => {
  runDefault(import('./injectQuestTracker-a02952ef.js'));
};
...
const showAllQuestSteps = () => {
  runDefault(import('./showAllQuestSteps-d82e6fd9.js'));
};
...
const injectScavenging = () => {
  runDefault(import('./scavenging-c04c87d2.js'));
};
...
const globalQuest = () => { runDefault(import('./globalQuest-886907eb.js')); };
const injectTopRated = () => { runDefault(import('./toprated-5c0da711.js')); };
...
const injectTrade = () => { runDefault(import('./trade-23425ee5.js')); };
...
const craftForge = () => { runDefault(import('./craftForge-0bd40860.js')); };
const injectBank = () => { runDefault(import('./injectBank-33fe7aa6.js')); };
const injectBazaar = () => { runDefault(import('./bazaar-70907c3b.js')); };
const injectFindPlayer = () => {
  runDefault(import('./injectFindPlayer-8a3680ca.js'));
};
const injectMailbox = () => { runDefault(import('./mailbox-401d4653.js')); };
const injectQuickBuff = () => {
  runDefault(import('./quickBuff-1b712e81.js'));
};
const injectTitan = () => { runDefault(import('./injectTitan-62e17ac1.js')); };
const injectSettings = () => {
  runDefault(import('./injectSettings-3eac8386.js'));
};
const injectWorld = () => { runDefault(import('./injectWorld-f0a3d489.js')); };
const ladder = () => { runDefault(import('./ladder-5d67a7b5.js')); };
const marketplace = () => { runDefault(import('./marketplace-0a7dc1dd.js')); };
const points = () => { runDefault(import('./points-deb9257b.js')); };
const superelite$1 = () => { runDefault(import('./superelite-b5afd0bd.js')); };
