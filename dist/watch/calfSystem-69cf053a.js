...
const allowBack = () => { runDefault(import('./allowBack-219b6959.js')); };
const injectBioWidgets = () => { runDefault(import('./bioWidgets-d2df8b4e.js')); };
const injectGuild = () => { runDefault(import('./guild-962f1819.js')); };
const injectProfile = () => { runDefault(import('./profile-95ee33ef.js')); };
const injectProfileDropItems = () => { runDefault(import('./injectProfileDropItems-829abfb0.js')); };
const injectQuestBookFull = () => { runDefault(import('./injectQuestBookFull-5c002335.js')); };
const injectStoreItems = () => { runDefault(import('./injectStoreItems-6f12f73c.js')); };
const inventing = () => { runDefault(import('./inventing-197c173e.js')); };
const results = () => { runDefault(import('./results-429608b0.js')); };
const viewArchive = () => { runDefault(import('./viewArchive-5593e897.js')); };

const injectBuffLog = (i) => { import('./injectBuffLog-fe7d1863.js').then((m) => m.default(i)); };
const injectFsBoxContent = (i) => { import('./injectFsBoxContent-86f39ad0.js').then((m) => m.default(i)); };
const injectMonsterLog = (i) => { import('./monstorLog-a8a027c4.js').then((m) => m.default(i)); };
const injectNotepadShowLogs = (i) => { import('./combatLog-6c73f964.js').then((m) => m.default(i)); };
const injectOnlinePlayers = (i) => { import('./injectOnlinePlayers-d0472111.js').then((m) => m.default(i)); };
const injectRecipeManager = (i) => { import('./recipeMgr-d132bc01.js').then((m) => m.default(i)); };
const insertQuickExtract = (i) => { import('./quickExtract-5dbc12f0.js').then((m) => m.default(i)); };
const insertQuickWear = (i) => { import('./quickWear-410bd258.js').then((m) => m.default(i)); };

const injectAuctionSearch = (i) => { import('./lists-6e5cfd9b.js').then((m) => m.injectAuctionSearch(i)); };
const injectQuickLinkManager = (i) => { import('./lists-6e5cfd9b.js').then((m) => m.injectQuickLinkManager(i)); };
const injectFindBuffs = (i) => { import('./findBuffs-3f92c118.js').then((m) => m.injectFindBuffs(i)); };
const injectFindOther = (i) => { import('./findBuffs-3f92c118.js').then((m) => m.injectFindOther(i)); };
...
const injectArena = () => { runDefault(import('./arena-d075a40f.js')); };
const arenaDoJoin = () => { runDefault(import('./arenaDoJoin-39d97646.js')); };
const arenaJoin = () => {
  runDefault(import('./arenaJoin-62c36549.js'));
};
const completedArenas = () => {
  runDefault(import('./completedArenas-19c57226.js'));
};
const setupMoves = () => {
  runDefault(import('./setup-f1ad2ea7.js'));
};
const storeMoves = () => { runDefault(import('./store-70e795b3.js')); };
...
const injectAuctionHouse = () => {
  runDefault(import('./injectAuctionHouse-8b4d4a92.js'));
};
const quickCreate = () => {
  runDefault(import('./quickCreate-f9a4de18.js'));
};
...
const composingBreakdown = () => { runDefault(import('./breakdown-f1aac666.js')); };
const composingCreate = () => { runDefault(import('./composingCreate-622abda6.js')); };
const injectComposing = () => { runDefault(import('./composing-0fab40c0.js')); };
...
const injectAdvisor = () => {
  runDefault(import('./guildAdvisor-25971b6a.js'));
};
...
const injectGroups = () => {
  runDefault(import('./groups-0f07aa48.js'));
};
const injectGroupStats = () => {
  runDefault(import('./injectGroupStats-c24687ea.js'));
};
...
const guildHall = () => { runDefault(import('./hall-8a223682.js')); };
...
const injectGuildAddTagsWidgets = () => {
  runDefault(import('./injectGuildAddTagsWidgets-39a9318b.js'));
};
const injectReportPaint = () => {
  runDefault(import('./guildReport-8f8bd1e3.js'));
};
...
const guildChat = () => { runDefault(import('./guildChat-cc43a75b.js')); };
const guildLog = () => { runDefault(import('./guildLog-5d362e9f.js')); };
const guildMailbox = () => {
  runDefault(import('./guildMailbox-15b24d22.js'));
};
const injectGuildBank = () => {
  runDefault(import('./injectGuildBank-8516b021.js'));
};
const injectGuildRanks = () => {
  runDefault(import('./rank-3b5eb837.js'));
};
const injectRPUpgrades = () => {
  runDefault(import('./injectRPUpgrades-0a7467ef.js'));
};
const injectScouttower = () => {
  runDefault(import('./injectScouttower-7a3e07e9.js'));
};
...
const itemsView = () => { runDefault(import('./itemsView-08624619.js')); };
...
const playerLog = () => { runDefault(import('./playerLog-62ab5d21.js')); };
const outbox = () => { runDefault(import('./outbox-56c1f95a.js')); };
...
const newsFsbox = () => { runDefault(import('./newsFsbox-ae043768.js')); };
const newsShoutbox = () => { runDefault(import('./newsShoutbox-37f8211f.js')); };
...
const unknownPage = () => { runDefault(import('./unknownPage-cb67732a.js')); };
...
const injectInventoryManagerNew = () => {
  runDefault(import('./inventory-7e6cf65e.js'));
};
const injectNewGuildLog = () => {
  runDefault(import('./newGuildLog-65b8b0d2.js'));
};
const injectNotepad = () => {
  runDefault(import('./injectNotepad-1dc8b9d0.js'));
};
const injectSaveSettings = () => { runDefault(import('./load-1c395cc7.js')); };
const reliclist = () => {
  runDefault(import('./reliclist-a38e6f9d.js'));
};
const advisor$1 = () => { runDefault(import('./advisor-846b0d69.js')); };
const crawler = () => {
  runDefault(import('./crawler-3b554ed9.js'));
};
const newGuildLog5 = () => {
  runDefault(import('./newGuildLog5-f6d9e3d0.js'));
};
const whosGotWhat = () => {
  runDefault(import('./whosGotWhat-7563ac3f.js'));
};
...
const injectQuestTracker = () => {
  runDefault(import('./injectQuestTracker-331250e5.js'));
};
...
const showAllQuestSteps = () => {
  runDefault(import('./showAllQuestSteps-0d5fa644.js'));
};
...
const injectScavenging = () => {
  runDefault(import('./scavenging-ddb9817c.js'));
};
...
const globalQuest = () => { runDefault(import('./globalQuest-de71a07f.js')); };
const injectTopRated = () => { runDefault(import('./toprated-a2fa20c1.js')); };
...
const injectTrade = () => { runDefault(import('./trade-d274d532.js')); };
...
const craftForge = () => { runDefault(import('./craftForge-1d93d317.js')); };
const injectBank = () => { runDefault(import('./injectBank-2cb9092d.js')); };
const injectBazaar = () => { runDefault(import('./bazaar-77d8cebf.js')); };
const injectFindPlayer = () => {
  runDefault(import('./injectFindPlayer-081f6873.js'));
};
const injectMailbox = () => { runDefault(import('./mailbox-e56afc57.js')); };
const injectQuickBuff = () => {
  runDefault(import('./quickBuff-44ffa588.js'));
};
const injectTitan = () => { runDefault(import('./injectTitan-6d42d8ba.js')); };
const injectSettings = () => {
  runDefault(import('./injectSettings-ea1719ff.js'));
};
const injectWorld = () => { runDefault(import('./injectWorld-429ef859.js')); };
const ladder = () => { runDefault(import('./ladder-a3082a7c.js')); };
const marketplace = () => { runDefault(import('./marketplace-7aedca02.js')); };
const points = () => { runDefault(import('./points-849a0508.js')); };
const superelite$1 = () => { runDefault(import('./superelite-2b013042.js')); };
...
//# sourceMappingURL=calfSystem-69cf053a.js.map
