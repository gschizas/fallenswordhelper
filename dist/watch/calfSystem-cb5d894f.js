...
const allowBack = () => { runDefault(import('./allowBack-b0c9db1e.js')); };
const injectBioWidgets = () => { runDefault(import('./bioWidgets-2f65cf64.js')); };
const injectGuild = () => { runDefault(import('./guild-c061bde5.js')); };
const injectProfile = () => { runDefault(import('./profile-f06f50a0.js')); };
const injectProfileDropItems = () => { runDefault(import('./injectProfileDropItems-3a25f7d9.js')); };
const injectQuestBookFull = () => { runDefault(import('./injectQuestBookFull-968c4f2e.js')); };
const injectStoreItems = () => { runDefault(import('./injectStoreItems-f26eae57.js')); };
const inventing = () => { runDefault(import('./inventing-eaa4a62d.js')); };
const viewArchive = () => { runDefault(import('./viewArchive-ddfe3ac4.js')); };

const injectBuffLog = (i) => { import('./injectBuffLog-7fdbc288.js').then((m) => m.default(i)); };
const injectFsBoxContent = (i) => { import('./injectFsBoxContent-33bb530a.js').then((m) => m.default(i)); };
const injectMonsterLog = (i) => { import('./monstorLog-cc781505.js').then((m) => m.default(i)); };
const injectNotepadShowLogs = (i) => { import('./combatLog-dce57209.js').then((m) => m.default(i)); };
const injectOnlinePlayers = (i) => { import('./injectOnlinePlayers-dce7c823.js').then((m) => m.default(i)); };
const injectRecipeManager = (i) => { import('./recipeMgr-4fe80b73.js').then((m) => m.default(i)); };
const insertQuickExtract = (i) => { import('./quickExtract-bf8e57de.js').then((m) => m.default(i)); };
const insertQuickWear = (i) => { import('./quickWear-70fff238.js').then((m) => m.default(i)); };

const injectAuctionSearch = (i) => { import('./lists-4d749ae5.js').then((m) => m.injectAuctionSearch(i)); };
const injectQuickLinkManager = (i) => { import('./lists-4d749ae5.js').then((m) => m.injectQuickLinkManager(i)); };
const injectFindBuffs = (i) => { import('./findBuffs-4aadc72e.js').then((m) => m.injectFindBuffs(i)); };
const injectFindOther = (i) => { import('./findBuffs-4aadc72e.js').then((m) => m.injectFindOther(i)); };
...
const injectArena = () => { runDefault(import('./arena-caed8a11.js').then(function (n) { return n.a; })); };
const arenaDoJoin = () => { runDefault(import('./arenaDoJoin-3bcf71a3.js')); };
const arenaJoin = () => {
  runDefault(import('./arenaJoin-9307feb5.js'));
};
const completedArenas = () => {
  runDefault(import('./completedArenas-165a081b.js'));
};
const setupMoves = () => {
  runDefault(import('./setup-bbd3a2e0.js'));
};
const storeMoves = () => { runDefault(import('./store-ac34a917.js')); };
const results = () => { runDefault(import('./results-cad50d0d.js')); };
...
const injectAuctionHouse = () => {
  runDefault(import('./injectAuctionHouse-4c868b35.js'));
};
const quickCreate = () => {
  runDefault(import('./quickCreate-fc032bc7.js'));
};
...
const composingBreakdown = () => { runDefault(import('./breakdown-caf0f892.js')); };
const composingCreate = () => { runDefault(import('./composingCreate-9aaf17c5.js')); };
const injectComposing = () => { runDefault(import('./composing-05eb4069.js')); };
...
const injectAdvisor = () => {
  runDefault(import('./guildAdvisor-6ea08f39.js'));
};
...
const injectGroups = () => {
  runDefault(import('./groups-98c21316.js'));
};
const injectGroupStats = () => {
  runDefault(import('./injectGroupStats-5d60c75c.js'));
};
...
const guildHall = () => { runDefault(import('./hall-0c9c5e2e.js')); };
...
const injectGuildAddTagsWidgets = () => {
  runDefault(import('./injectGuildAddTagsWidgets-3351572e.js'));
};
const injectReportPaint = () => {
  runDefault(import('./guildReport-f1c46984.js'));
};
...
const guildChat = () => { runDefault(import('./guildChat-8a4a2b20.js')); };
const guildLog = () => { runDefault(import('./guildLog-327afbce.js')); };
const guildMailbox = () => {
  runDefault(import('./guildMailbox-dfd7ad69.js'));
};
const injectGuildBank = () => {
  runDefault(import('./injectGuildBank-6f1762b2.js'));
};
const injectGuildRanks = () => {
  runDefault(import('./rank-7490a3a1.js'));
};
const injectRPUpgrades = () => {
  runDefault(import('./injectRPUpgrades-e48abf49.js'));
};
const injectScouttower = () => {
  runDefault(import('./injectScouttower-08dbdd4f.js'));
};
...
const itemsView = () => { runDefault(import('./itemsView-66ddbfd6.js')); };
...
const playerLog = () => { runDefault(import('./playerLog-811870a3.js')); };
const outbox = () => { runDefault(import('./outbox-47c486c2.js')); };
...
const newsFsbox = () => { runDefault(import('./newsFsbox-82097609.js')); };
const newsShoutbox = () => { runDefault(import('./newsShoutbox-07be1fd8.js')); };
...
const unknownPage = () => { runDefault(import('./unknownPage-a67d33ee.js')); };
...
const injectInventoryManagerNew = () => {
  runDefault(import('./inventory-2cac49a3.js'));
};
const injectNewGuildLog = () => {
  runDefault(import('./newGuildLog-6f3d6ce3.js'));
};
const injectNotepad = () => {
  runDefault(import('./injectNotepad-d4d16b83.js'));
};
const injectSaveSettings = () => { runDefault(import('./load-327a0ae6.js')); };
const reliclist = () => {
  runDefault(import('./reliclist-8f50bf98.js'));
};
const advisor$1 = () => { runDefault(import('./advisor-66ed9657.js')); };
const crawler = () => {
  runDefault(import('./crawler-62a12f87.js'));
};
const newGuildLog5 = () => {
  runDefault(import('./newGuildLog5-9651331a.js'));
};
const whosGotWhat = () => {
  runDefault(import('./whosGotWhat-ab371d23.js'));
};
...
const injectQuestTracker = () => {
  runDefault(import('./injectQuestTracker-c759a002.js'));
};
...
const showAllQuestSteps = () => {
  runDefault(import('./showAllQuestSteps-d478bf42.js'));
};
...
const injectScavenging = () => {
  runDefault(import('./scavenging-702e5686.js'));
};
...
const globalQuest = () => { runDefault(import('./globalQuest-9b417fe9.js')); };
const injectTopRated = () => { runDefault(import('./toprated-91971730.js')); };
...
const injectTrade = () => { runDefault(import('./trade-c01e4097.js')); };
...
const craftForge = () => { runDefault(import('./craftForge-03e1a8eb.js')); };
const injectBank = () => { runDefault(import('./injectBank-bbfe4232.js')); };
const injectBazaar = () => { runDefault(import('./bazaar-30da0e26.js')); };
const injectFindPlayer = () => {
  runDefault(import('./injectFindPlayer-bc38a331.js'));
};
const injectMailbox = () => { runDefault(import('./mailbox-35b63ef4.js')); };
const injectQuickBuff = () => {
  runDefault(import('./quickBuff-65877cd6.js'));
};
const injectTitan = () => { runDefault(import('./injectTitan-0d571fd1.js')); };
const injectSettings = () => {
  runDefault(import('./injectSettings-9155bb53.js'));
};
const injectWorld = () => { runDefault(import('./injectWorld-5135b9b7.js')); };
const ladder = () => { runDefault(import('./ladder-b2739dcb.js')); };
const marketplace = () => { runDefault(import('./marketplace-00525dfa.js')); };
const points = () => { runDefault(import('./points-1125829f.js')); };
const superelite$1 = () => { runDefault(import('./superelite-b129fa15.js')); };
...
//# sourceMappingURL=calfSystem-cb5d894f.js.map
