...
const allowBack = () => { runDefault(import('./allowBack-de3ded02.js')); };
const injectBioWidgets = () => { runDefault(import('./bioWidgets-977ca3be.js')); };
const injectGuild = () => { runDefault(import('./guild-483aecf6.js')); };
const injectProfile = () => { runDefault(import('./profile-67d131cf.js')); };
const injectProfileDropItems = () => { runDefault(import('./injectProfileDropItems-70cbb77d.js')); };
const injectQuestBookFull = () => { runDefault(import('./injectQuestBookFull-47027b34.js')); };
const injectStoreItems = () => { runDefault(import('./injectStoreItems-a08715d2.js')); };
const inventing = () => { runDefault(import('./inventing-73be8e0d.js')); };
const viewArchive = () => { runDefault(import('./viewArchive-d565dfab.js')); };

const injectBuffLog = (i) => { import('./injectBuffLog-91801544.js').then((m) => m.default(i)); };
const injectFsBoxContent = (i) => { import('./injectFsBoxContent-77002c44.js').then((m) => m.default(i)); };
const injectMonsterLog = (i) => { import('./monstorLog-dd3f99e5.js').then((m) => m.default(i)); };
const injectNotepadShowLogs = (i) => { import('./combatLog-f6692443.js').then((m) => m.default(i)); };
const injectOnlinePlayers = (i) => { import('./injectOnlinePlayers-6debf3f3.js').then((m) => m.default(i)); };
const injectRecipeManager = (i) => { import('./recipeMgr-bb52002e.js').then((m) => m.default(i)); };
const insertQuickExtract = (i) => { import('./quickExtract-21fbb713.js').then((m) => m.default(i)); };
const insertQuickWear = (i) => { import('./quickWear-8411c795.js').then((m) => m.default(i)); };

const injectAuctionSearch = (i) => { import('./lists-d6601dad.js').then((m) => m.injectAuctionSearch(i)); };
const injectQuickLinkManager = (i) => { import('./lists-d6601dad.js').then((m) => m.injectQuickLinkManager(i)); };
const injectFindBuffs = (i) => { import('./findBuffs-3d172c75.js').then((m) => m.injectFindBuffs(i)); };
const injectFindOther = (i) => { import('./findBuffs-3d172c75.js').then((m) => m.injectFindOther(i)); };
...
const injectArena = () => { runDefault(import('./arena-c0538972.js').then(function (n) { return n.a; })); };
const arenaDoJoin = () => { runDefault(import('./arenaDoJoin-2279b48b.js')); };
const arenaJoin = () => {
  runDefault(import('./arenaJoin-95d81c11.js'));
};
const completedArenas = () => {
  runDefault(import('./completedArenas-4c16c8bb.js'));
};
const setupMoves = () => {
  runDefault(import('./setup-136b4e60.js'));
};
const storeMoves = () => { runDefault(import('./store-47d77059.js')); };
const results = () => { runDefault(import('./results-47e6df9d.js')); };
...
const injectAuctionHouse = () => {
  runDefault(import('./injectAuctionHouse-116f65ab.js'));
};
const quickCreate = () => {
  runDefault(import('./quickCreate-9a18f386.js'));
};
...
const composingBreakdown = () => { runDefault(import('./breakdown-53457a07.js')); };
const composingCreate = () => { runDefault(import('./composingCreate-4c2d92b7.js')); };
const injectComposing = () => { runDefault(import('./composing-a448e5de.js')); };
...
const injectAdvisor = () => {
  runDefault(import('./guildAdvisor-fa170a2d.js'));
};
...
const injectGroups = () => {
  runDefault(import('./groups-aaabd56f.js'));
};
const injectGroupStats = () => {
  runDefault(import('./injectGroupStats-27b9fa28.js'));
};
...
const guildHall = () => { runDefault(import('./hall-91e4b646.js')); };
...
const injectGuildAddTagsWidgets = () => {
  runDefault(import('./injectGuildAddTagsWidgets-69197c33.js'));
};
const injectReportPaint = () => {
  runDefault(import('./guildReport-45463723.js'));
};
...
const guildChat = () => { runDefault(import('./guildChat-977bff19.js')); };
const guildLog = () => { runDefault(import('./guildLog-983774ad.js')); };
const guildMailbox = () => {
  runDefault(import('./guildMailbox-af2caf6e.js'));
};
const injectGuildBank = () => {
  runDefault(import('./injectGuildBank-c17e5989.js'));
};
const injectGuildRanks = () => {
  runDefault(import('./rank-d5bba888.js'));
};
const injectRPUpgrades = () => {
  runDefault(import('./injectRPUpgrades-dc9fff45.js'));
};
const injectScouttower = () => {
  runDefault(import('./injectScouttower-efb3e67e.js'));
};
...
const itemsView = () => { runDefault(import('./itemsView-8301d7d9.js')); };
...
const playerLog = () => { runDefault(import('./playerLog-7d6e3b00.js')); };
const outbox = () => { runDefault(import('./outbox-673fb4d2.js')); };
...
const newsFsbox = () => { runDefault(import('./newsFsbox-06cbbddd.js')); };
const newsShoutbox = () => { runDefault(import('./newsShoutbox-8b6752c9.js')); };
...
const unknownPage = () => { runDefault(import('./unknownPage-64f64e99.js')); };
...
const injectInventoryManagerNew = () => {
  runDefault(import('./inventory-2b14a2f2.js'));
};
const injectNewGuildLog = () => {
  runDefault(import('./newGuildLog-78351502.js'));
};
const injectNotepad = () => {
  runDefault(import('./injectNotepad-543b102e.js'));
};
const injectSaveSettings = () => { runDefault(import('./load-1d68ca08.js')); };
const reliclist = () => {
  runDefault(import('./reliclist-b6eba314.js'));
};
const advisor$1 = () => { runDefault(import('./advisor-b35e53e2.js')); };
const crawler = () => {
  runDefault(import('./crawler-4a21d771.js'));
};
const newGuildLog5 = () => {
  runDefault(import('./newGuildLog5-eb20947d.js'));
};
const whosGotWhat = () => {
  runDefault(import('./whosGotWhat-c7050b21.js'));
};
...
const injectQuestTracker = () => {
  runDefault(import('./injectQuestTracker-74546f5f.js'));
};
...
const showAllQuestSteps = () => {
  runDefault(import('./showAllQuestSteps-0e167109.js'));
};
...
const injectScavenging = () => {
  runDefault(import('./scavenging-0c9d863d.js'));
};
...
const globalQuest = () => { runDefault(import('./globalQuest-1fb8139a.js')); };
const injectTopRated = () => { runDefault(import('./toprated-e5ab695c.js')); };
...
const injectTrade = () => { runDefault(import('./trade-d20a49b2.js')); };
...
const craftForge = () => { runDefault(import('./craftForge-55f044a3.js')); };
const injectBank = () => { runDefault(import('./injectBank-95285417.js')); };
const injectBazaar = () => { runDefault(import('./bazaar-4f45d106.js')); };
const injectFindPlayer = () => {
  runDefault(import('./injectFindPlayer-ff527f4c.js'));
};
const injectMailbox = () => { runDefault(import('./mailbox-75d531b0.js')); };
const injectQuickBuff = () => {
  runDefault(import('./quickBuff-5c94d3f8.js'));
};
const injectTitan = () => { runDefault(import('./injectTitan-2d6d0bbe.js')); };
const injectSettings = () => {
  runDefault(import('./injectSettings-9e6736b6.js'));
};
const injectWorld = () => { runDefault(import('./injectWorld-18132a18.js')); };
const ladder = () => { runDefault(import('./ladder-6d8dd53a.js')); };
const marketplace = () => { runDefault(import('./marketplace-91bca66c.js')); };
const points = () => { runDefault(import('./points-0ec86686.js')); };
const superelite$1 = () => { runDefault(import('./superelite-a370625b.js')); };
...
//# sourceMappingURL=calfSystem-e592bbc5.js.map
