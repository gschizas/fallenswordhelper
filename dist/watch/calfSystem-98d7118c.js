...
const allowBack = () => { runDefault(import('./allowBack-07bad7ed.js')); };
const injectBioWidgets = () => { runDefault(import('./bioWidgets-1c62d815.js')); };
const injectGuild = () => { runDefault(import('./guild-cdbc33c0.js')); };
const injectProfile = () => { runDefault(import('./profile-632bb033.js')); };
const injectProfileDropItems = () => { runDefault(import('./injectProfileDropItems-16935a36.js')); };
const injectQuestBookFull = () => { runDefault(import('./injectQuestBookFull-6b13edd0.js')); };
const injectStoreItems = () => { runDefault(import('./injectStoreItems-8e78a20b.js')); };
const inventing = () => { runDefault(import('./inventing-1123ad5d.js')); };
const viewArchive = () => { runDefault(import('./viewArchive-d0efe4a8.js')); };

const injectBuffLog = (i) => { import('./injectBuffLog-aa0a37f1.js').then((m) => m.default(i)); };
const injectFsBoxContent = (i) => { import('./injectFsBoxContent-0d0cb889.js').then((m) => m.default(i)); };
const injectMonsterLog = (i) => { import('./monstorLog-2f251393.js').then((m) => m.default(i)); };
const injectNotepadShowLogs = (i) => { import('./combatLog-d835f527.js').then((m) => m.default(i)); };
const injectOnlinePlayers = (i) => { import('./injectOnlinePlayers-ffbffafc.js').then((m) => m.default(i)); };
const injectRecipeManager = (i) => { import('./recipeMgr-cb43c029.js').then((m) => m.default(i)); };
const insertQuickExtract = (i) => { import('./quickExtract-101b0fb3.js').then((m) => m.default(i)); };
const insertQuickWear = (i) => { import('./quickWear-44611edf.js').then((m) => m.default(i)); };

const injectAuctionSearch = (i) => { import('./lists-6750647b.js').then((m) => m.injectAuctionSearch(i)); };
const injectQuickLinkManager = (i) => { import('./lists-6750647b.js').then((m) => m.injectQuickLinkManager(i)); };
const injectFindBuffs = (i) => { import('./findBuffs-db3aebdb.js').then((m) => m.injectFindBuffs(i)); };
const injectFindOther = (i) => { import('./findBuffs-db3aebdb.js').then((m) => m.injectFindOther(i)); };
...
const injectArena = () => { runDefault(import('./arena-78a3140b.js').then(function (n) { return n.a; })); };
const arenaDoJoin = () => { runDefault(import('./arenaDoJoin-e5a47e6f.js')); };
const arenaJoin = () => {
  runDefault(import('./arenaJoin-7d4a2872.js'));
};
const completedArenas = () => {
  runDefault(import('./completedArenas-b48e0d1c.js'));
};
const setupMoves = () => {
  runDefault(import('./setup-231411d6.js'));
};
const storeMoves = () => { runDefault(import('./store-73827651.js')); };
const results = () => { runDefault(import('./results-e0fe3a1b.js')); };
...
const injectAuctionHouse = () => {
  runDefault(import('./injectAuctionHouse-460978b1.js'));
};
const quickCreate = () => {
  runDefault(import('./quickCreate-51aea2b4.js'));
};
...
const composingBreakdown = () => { runDefault(import('./breakdown-e7b36dcd.js')); };
const composingCreate = () => { runDefault(import('./composingCreate-340744b6.js')); };
const injectComposing = () => { runDefault(import('./composing-33e956b6.js')); };
...
const injectAdvisor = () => {
  runDefault(import('./guildAdvisor-e2aea7a5.js'));
};
...
const injectGroups = () => {
  runDefault(import('./groups-0c2b09aa.js'));
};
const injectGroupStats = () => {
  runDefault(import('./injectGroupStats-2cb7a3e9.js'));
};
...
const guildHall = () => { runDefault(import('./hall-5f3fd88f.js')); };
...
const injectGuildAddTagsWidgets = () => {
  runDefault(import('./injectGuildAddTagsWidgets-6e64a217.js'));
};
const injectReportPaint = () => {
  runDefault(import('./guildReport-1635d04d.js'));
};
...
const guildChat = () => { runDefault(import('./guildChat-1fca018e.js')); };
const guildLog = () => { runDefault(import('./guildLog-4984ce7a.js')); };
const guildMailbox = () => {
  runDefault(import('./guildMailbox-34ee31e7.js'));
};
const injectGuildBank = () => {
  runDefault(import('./injectGuildBank-8a0b912c.js'));
};
const injectGuildRanks = () => {
  runDefault(import('./rank-c75e7b05.js'));
};
const injectRPUpgrades = () => {
  runDefault(import('./injectRPUpgrades-1873e1a3.js'));
};
const injectScouttower = () => {
  runDefault(import('./injectScouttower-efeba75b.js'));
};
...
const itemsView = () => { runDefault(import('./itemsView-6edcf6a0.js')); };
...
const playerLog = () => { runDefault(import('./playerLog-2f8fa962.js')); };
const outbox = () => { runDefault(import('./outbox-ef701e90.js')); };
...
const newsFsbox = () => { runDefault(import('./newsFsbox-d7b85e4c.js')); };
const newsShoutbox = () => { runDefault(import('./newsShoutbox-e71e703d.js')); };
...
const unknownPage = () => { runDefault(import('./unknownPage-17f01b54.js')); };
...
const injectInventoryManagerNew = () => {
  runDefault(import('./inventory-4e1d88f0.js'));
};
const injectNewGuildLog = () => {
  runDefault(import('./newGuildLog-f30a025c.js'));
};
const injectNotepad = () => {
  runDefault(import('./injectNotepad-d9699a0c.js'));
};
const injectSaveSettings = () => { runDefault(import('./load-3fd93abe.js')); };
const reliclist = () => {
  runDefault(import('./reliclist-97a7a027.js'));
};
const advisor$1 = () => { runDefault(import('./advisor-5c7b3fd4.js')); };
const crawler = () => {
  runDefault(import('./crawler-3d86715c.js'));
};
const newGuildLog5 = () => {
  runDefault(import('./newGuildLog5-4ac921dc.js'));
};
const whosGotWhat = () => {
  runDefault(import('./whosGotWhat-79cd97e4.js'));
};
...
const injectQuestTracker = () => {
  runDefault(import('./injectQuestTracker-c0f38673.js'));
};
...
const showAllQuestSteps = () => {
  runDefault(import('./showAllQuestSteps-f1aa1b68.js'));
};
...
const injectScavenging = () => {
  runDefault(import('./scavenging-43c286e6.js'));
};
...
const globalQuest = () => { runDefault(import('./globalQuest-96892c21.js')); };
const injectTopRated = () => { runDefault(import('./toprated-4b3b8183.js')); };
...
const injectTrade = () => { runDefault(import('./trade-6c1c8477.js')); };
...
const craftForge = () => { runDefault(import('./craftForge-33554336.js')); };
const injectBank = () => { runDefault(import('./injectBank-e175bf90.js')); };
const injectBazaar = () => { runDefault(import('./bazaar-e935903b.js')); };
const injectFindPlayer = () => {
  runDefault(import('./injectFindPlayer-38764d11.js'));
};
const injectMailbox = () => { runDefault(import('./mailbox-525b1a26.js')); };
const injectQuickBuff = () => {
  runDefault(import('./quickBuff-8b4efc73.js'));
};
const injectTitan = () => { runDefault(import('./injectTitan-68f5d366.js')); };
const injectSettings = () => {
  runDefault(import('./injectSettings-c71e9622.js'));
};
const injectWorld = () => { runDefault(import('./injectWorld-451f28d8.js')); };
const ladder = () => { runDefault(import('./ladder-dc69c0dc.js')); };
const marketplace = () => { runDefault(import('./marketplace-cd14f8c9.js')); };
const points = () => { runDefault(import('./points-1f06c0a2.js')); };
const superelite$1 = () => { runDefault(import('./superelite-88ca2229.js')); };
...
//# sourceMappingURL=calfSystem-98d7118c.js.map
