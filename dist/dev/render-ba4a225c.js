import{v as t,G as n,ay as s,e,a1 as o,b as f,p as a,D as u,ad as c,C as r,A as i,q as l}from"./calfSystem-0e5d6faf.js"
import{r as d}from"./roundToString-ca66f7f1.js"
import{t as p}from"./toLowerCase-adcc7aa6.js"
...
function L(t){return`<tr><td>${t[0]}</td><td>: ${t[1][0]}${t[1][1]}</td></tr>`}function j(t,n){return t[n[1][1]]+=n[1][0],t}function v(){const n=l(S.buffs),s=(e=n.reduce(j,{k:0,fsp:0,stam:0,unknown:0}),b.map(t(m,e)).join(""))
var e
...
let s,e
n?(s=function(t){return t[0].includes("k")?"k":t[0].includes("f")?"fsp":"stam"}(n),[e]=n[0].match(/([+-]?[.\d]+)/)):(s="unknown",e="1"),S.buffs[u(t)]=[parseFloat(e),s],S.count+=1}(t):(S.count-=1,delete S.buffs[s]),S.count>0?v():(r("&nbsp;",i("buffCost")),S.buffCostTotalText="")}function y(t){if("fshSendBuffMsg"===t.target.id)return void function(t){t.count>0&&k(t)}(S)
...
//# sourceMappingURL=render-ba4a225c.js.map
