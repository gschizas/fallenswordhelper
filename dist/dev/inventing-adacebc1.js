import{r as n,y as t,p as e,h as i,o as s,S as o,U as a,C as r,N as c,by as u,ax as f,aw as m,P as l,j as p}from"./calfSystem-70b0df7f.js"
import{c as v}from"./createInput-9a444f78.js"
import{i as d}from"./insertTextBeforeEnd-2891dca4.js"
import{j as b,o as h}from"./jsonFail-7bdff1ba.js"
import{x as g}from"./xPath-e5305b17.js"
function j(n){return function(n){return t({cmd:"inventing",subcmd:"doinvent",recipe_id:n})}(n)}let C,y,N
function w(n){var t
b(n,N)||h((t=n.r).item?`<span class="fshGreen">You successfully invented the item [${t.item.n}].</span>`:'<span class="fshRed">You have failed to invent the item.</span>',N)}function x(n){r(n,y),r("",N)}function I(){const n=Number(C.value)
if(!n)return void x("")
...
//# sourceMappingURL=inventing-adacebc1.js.map
