import{o as t,b_ as n,b as e,p as o,v as a,cn as r,C as i,aI as s,a1 as c,F as u,bt as l,l as p,ay as f,Q as d,h as m,r as b,a as h,q as g,B as y,i as M,ai as j,aS as L,ab as C,ak as x,f as I,aA as $,D as v,e as N,aa as H,Y as R,N as k,b6 as S,bw as T,z as w}from"./calfSystem-fd021443.js"
import"./numberIsNaN-c0f5c8eb.js"
import"./toLowerCase-4cca5593.js"
import{c as A}from"./createInput-309e97c5.js"
import{t as E}from"./testRange-699db9a4.js"
import{o as B}from"./onlineDot-4ccbcf3f.js"
import{b as D}from"./batch-111227ce.js"
import{i as F}from"./isChecked-fadd6c27.js"
import{a as G}from"./alpha-39cc7a36.js"
import{c as W}from"./createTable-c0a20196.js"
import"./dialogMsg-280d6f63.js"
import"./errorDialog-c89dc139.js"
import"./dialog-a08a4c3c.js"
import{e as _}from"./useItem-518ed308.js"
import"./ajaxReturnCode-ee8e978d.js"
import"./daUseItem-602cd31a.js"
import{c as P}from"./createTr-49a32cf0.js"
import{e as q}from"./eventHandler5-29815432.js"
import{s as Q}from"./selfIdIs-e22a1c50.js"
import{c as Y}from"./createSelect-11128e92.js"
import{g as z}from"./getMembrList-71a7118e.js"
import"./guildInventory-9be72936.js"
import{a as J}from"./queue-e4972b7e.js"
...
var e
return n.value=t,n.text=t,n}function It(t,n){m(t,xt(n[0]))}function $t(t){if(!yt){yt=Ct()
const n=function(t){const n=Y({className:"tip-static",dataset:{tipped:'Set to "Ignore" to exclude from report'}})
return m(n,xt("Ignore")),t.forEach(a(It,n)),n}(t)
...
gt.replaceChild(n,gt.children[0]),h(3,D,[[5,3,g(t.myMap),0,a(vt,n),a(Ht,n)]])}const kt="fsh_potMap",St={pottab1:!1,pottab2:!1,pottab3:!1,myMap:{},minpoint:12,maxpoint:20}
function Tt(t,n){t.myMap[n]||(t.myMap[n]=n)}function wt(t,n,e){"SELECT"===e.target.tagName&&(t.myMap[e.target.name]=e.target.value,x(kt,t),Lt(t,n))}function At(t,n,e){return n[e]=t?"Ignore":e,n}function Et(t,n,e){!function(t,n,e){t.myMap=f(n).reduce(a(At,e),{})}(t,n,e),x(kt,t),Rt(t),Lt(t,n)}function Bt(t){return/^pottab\d$/.test(t.id)}function Dt(t,n){t[n.id]=n.checked,x(kt,t)}function Ft(t,n,e){const o=e.target.id,a=E(e.target.value,0,999)
a&&(t[o]=a,x(kt,t),Lt(t,n))}function Gt(n,e,o){I(o,"change",a(wt,n,e)),t(o,q(function(t,n){return[[Q("fshIgnoreAll"),a(Et,t,n,!0)],[Q("fshReset"),a(Et,t,n,null)],[Bt,a(Dt,t)]]}(n,e))),I(o,"input",a(Ft,n,e))}function Wt(t,n){const e=function(t){return p({id:"potReport",innerHTML:`<input id="pottab1" type="checkbox"${F(t.pottab1)}><label for="pottab1">Composed Potion Inventory</label><input id="pottab2" type="checkbox"${F(t.pottab2)}><label for="pottab2">Mapping</label><input id="pottab3" type="checkbox"${F(t.pottab3)}><label for="pottab3">Thresholds</label>`})}(t),r=p({id:"panels"})
...
L(e,C(n,{})),e.myMap=function(t,n){return f(n).forEach(a(Tt,t)),bt(t.myMap)}(e,t),x(kt,e),Wt(e,t)}function Pt(t){j(kt).then(a(_t,t))}let qt,Qt,Yt,zt,Jt
function Ut(t,n){const e=Qt[n]
m(e,t)}function Kt(t){qt.push(dt(t)),function(t){if(t.endsWith(" (Potion)")){const n=t.slice(0,-9)
Yt[n]=(Yt[n]||0)+1}}(t.previousElementSibling.innerHTML)}function Ot(){D([5,3,qt,0,Ut,a(Pt,Yt)])}function Vt(){Qt=$("#pCC table table tr:not(.fshHide) td:nth-of-type(3n)"),Yt={},qt=[],D([5,3,Qt,0,Kt,Ot])}function Xt(t){const n=v(t)
N.membrList[n]&&i(function(t){return`${B({last_login:N.membrList[t].last_login})}<a href="${H}${N.membrList[t].id}">${t}</a> [ <span class="a-reply fshLink" target_player=${t}>m</span> ]`}(n),t)}function Zt(){const t=$('#pCC table table tr:not(.fshHide) td[bgcolor="#DAA534"][colspan="2"] b')
D([5,3,t,0,Xt])}function tn(t){t.children[0].hasAttribute("bgcolor")&&(Jt=T(zt,t.children[0].children[0])),Jt||(t.className="fshHide")}function nn(){if(zt=R("user"),!zt)return
if(!k('#pCC table table td[bgcolor="#DAA534"] b').some(S(zt)))return
const t=$("#pCC table table tr")
D([5,2,t,0,tn])}function en(){h(3,Zt)}export default function(){w()||(z(!1).then(en),h(2,nn),h(3,Vt),t(e("table",o)[1],n(et)))}
//# sourceMappingURL=guildReport-52ca4a8c.js.map
