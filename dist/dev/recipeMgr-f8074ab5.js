import{G as t,aW as e,bt as n,C as i,ak as r,A as s,g as a,x as o,i as c,v as d,D as u,b_ as p,a$ as f,K as m,l as h,h as l,w as g,z as $,ai as b,o as v,p as x}from"./calfSystem-94018cd0.js"
import"./toLowerCase-5662df04.js"
import"./alpha-5c4ca470.js"
import{a as _}from"./all-e6dbe465.js"
import{d as N}from"./doSortParams-cf9ee58d.js"
import{a as k}from"./stringSort-7d0ff554.js"
let w,C=[]
...
return i&&c(t,`Skipping folder "${n}"  as it has the word "quest" in folder name.<br>`),!i}function O(t,e){return f(e.parentNode.href).then(t)}function Q(t,e,n){const i=d(W,t,e),r=function(t,e,n){return P(o(e)).filter(H).filter(d(J,t)).map(d(O,n))}(t,n,i)
return r.push(i(n)),_(r)}let U,V
function X(){c(V,"Finished parsing ... formatting ..."),r("fsh_recipeBook",U),I(V,U)}function Y(){U={},U.recipe=[],i("<br>Parsing inventing screen ...<br>",V),g({cmd:"inventing"}).then(d(Q,V,U)).then(X)}function Z(t,e){U=e,i('<table class="fshInvFilter"><thead><tr><th width="90%"><b>&nbsp;Recipe Manager</b></th><th width="10%" class="fshBtnBox">[<span id="rfsh" class="fshLink">Refresh</span>]</th></tr></thead></table>',t),V=h(),l(t,V),U?I(V,U):Y()}function tt(t){"rfsh"===t.target.id&&Y(),"sortName"===t.target.id&&function(t){N(t.target),U.recipe.sort(k),I(V,U)}(t)}export default function(t){if($())return
const e=t||x
b("fsh_recipeBook").then(d(Z,e)),v(e,tt)}
//# sourceMappingURL=recipeMgr-f8074ab5.js.map
