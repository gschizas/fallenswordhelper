import{y as t,z as n,g as s,p as i,P as e,Q as a,v as c,k as o,l as r,h as f,o as u,q as d,C as l,R as m,A as p}from"./calfSystem-70b0df7f.js"
import{c as h}from"./createInput-9a444f78.js"
import{c as k}from"./createLabel-f4168a93.js"
import{c as b}from"./createUl-64948536.js"
import{c as g}from"./chunk-0030535f.js"
import{j as v,o as T}from"./jsonFail-7bdff1ba.js"
...
n&&l("",n)}function I(t,n){v(n,t)||m(n.r)&&function(t,n){n.r.forEach(q),T(`${n.r.length.toString()} item(s) taken.`,t)}(t,n)}function M(t,n){j(n).then(c(I,t))}function Q(t,n,s){s.target.classList.contains("fshBls")&&function(t,n,s){const i=s.dataset.id,{invIds:e}=t[i]
...
e(s,n),a(s,"change",c(B,t,n))}(t,o),x("qtOff","Quick Take",o)}
//# sourceMappingURL=mailbox-9214daba.js.map
