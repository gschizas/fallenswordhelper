import{bh as t,v as n,bi as s,X as e,aN as a,aa as o,i as r,h as i,o as c,N as l,S as u,G as d,n as f,e as p,cp as h,a1 as m,D as b,l as g,w as C,C as S,z as w}from"./calfSystem-94018cd0.js"
import{c as x}from"./createInput-cfb8faf0.js"
import{o as j}from"./onlineDot-954d045b.js"
import"./createUl-64d10195.js"
import"./createButton-080d3bb7.js"
import{g as v}from"./getMembrList-fc5e54d6.js"
import{d as G,g as N}from"./getGroupStats-39417237.js"
...
t.parentNode.replaceChild(s,t),function(t,s){C({cmd:"guild",subcmd:"groups",subcmd2:"join",group_id:t}).then(n(F,s))}(/confirmJoin\((\d+)\)/.exec(t.href)[1],s)}}function P(){m("groups","joinAllGroupsUnderSize"),l('#pCC a[href*="confirmJoin"]').forEach(H)}function _(){const t=u('#pCC input[value="Join All Available Groups"]'),n=t.parentNode
d("enableMaxGroupSizeToJoin")&&(X=d("maxGroupSizeToJoin"),f(t),function(t){const n=z(t,`Join All Groups < ${X} Members`)
c(n,P)}(n)),function(t){const n=z(t,"Fetch Group Stats")
c(n,k)}(n),p.subcmd2===h&&P()}export default function(){w()||(v(!1).then(y),function(){const t=d("minGroupLevel")
...
//# sourceMappingURL=groups-6a69f0c7.js.map
