import{y as t,z as n,g as s,p as e,P as i,Q as a,v as c,k as o,l as r,h as f,o as u,q as d,C as l,R as m,A as p}from"./calfSystem-8dc0fa4b.js"
import{c as h}from"./createInput-29f46dac.js"
import{c as k}from"./createLabel-fd3e7486.js"
import{c as b}from"./createUl-ea106be9.js"
import{c as g}from"./chunk-a5b00e9c.js"
import{j as v,o as T}from"./jsonFail-efc9ada5.js"
...
!function(t,n){d(n).forEach(c(L,t))}(e,t),f(n,e),u(e,c(Q,t,s))}function E(t){const n=r({id:"quickTake",innerHTML:'<div class="fshCenter"><br><font size="3"><b>Quick Take</b></font><br><br>Select which item to take all similar items from your Mailbox.</div><div></div>'}),s=function(t){const n=r(),s=b()
return f(n,s),f(t,n),s}(n)
f(n,r()),C(t,n,s),f(e,n)}function B(t,n){x("qtOn","Mailbox",n),E(t.reduce(y,{}))}export default function(){if(n())return
const t=s("a",e)
...
//# sourceMappingURL=mailbox-08a1140f.js.map
