import{G as t,aW as e,bt as n,C as i,ak as r,A as s,g as a,x as c,i as o,v as d,D as u,bZ as p,a$ as f,K as m,l as h,h as l,w as g,z as b,ai as $,o as v,p as x}from"./calfSystem-fd021443.js"
import"./toLowerCase-4cca5593.js"
import"./alpha-39cc7a36.js"
import{a as _}from"./all-93b0c1ea.js"
import{d as N}from"./doSortParams-29adb5a0.js"
import{a as k}from"./stringSort-6ec221ba.js"
let w,C=[]
...
t.amountPresent=parseInt(n[0],10),t.amountNeeded=parseInt(n[1],10)}}(i,t.parentNode.nextElementSibling),i}function E(t,e){return t.filter(d(B,e)).map(R)}function F(t,e,n,i){const r=c(i)
o(t,`Parsing blueprint ${n.name}...<br>`)
const d=function(t){return a("td",s("pCC",t))}(r)
n.items=E(d,"/inventory/2x3."),n.components=E(d,"/inventory/1x1mini."),[n.target]=E(d,"/hellforge/2x3."),e.recipe.push(n)}function L(t,e,n){o(t,`Found blueprint "${u(n)}".<br>`)
...
return i&&o(t,`Skipping folder "${n}"  as it has the word "quest" in folder name.<br>`),!i}function J(t,e){return f(e.parentNode.href).then(t)}function O(t,e,n){const i=d(W,t,e),r=function(t,e,n){return P(c(e)).filter(Z).filter(d(H,t)).map(d(J,n))}(t,n,i)
return r.push(i(n)),_(r)}let Q,U
function V(){o(U,"Finished parsing ... formatting ..."),r("fsh_recipeBook",Q),I(U,Q)}function X(){Q={},Q.recipe=[],i("<br>Parsing inventing screen ...<br>",U),g({cmd:"inventing"}).then(d(O,U,Q)).then(V)}function Y(t,e){Q=e,i('<table class="fshInvFilter"><thead><tr><th width="90%"><b>&nbsp;Recipe Manager</b></th><th width="10%" class="fshBtnBox">[<span id="rfsh" class="fshLink">Refresh</span>]</th></tr></thead></table>',t),U=h(),l(t,U),Q?I(U,Q):X()}function tt(t){"rfsh"===t.target.id&&X(),"sortName"===t.target.id&&function(t){N(t.target),Q.recipe.sort(k),I(U,Q)}(t)}export default function(t){if(b())return
const e=t||x
$("fsh_recipeBook").then(d(Y,e)),v(e,tt)}
//# sourceMappingURL=recipeMgr-22f9a95c.js.map
