import{ay as n,v as e,G as t,b4 as a,I as s,aO as l,ab as i,a5 as r,bg as o,z as f,ai as u,o as c,f as h,x as d,ak as p}from"./calfSystem-0e5d6faf.js"
import{n as v}from"./numberIsNaN-a4c8282b.js"
import{b as m,p as g,c as y}from"./levelHighlight-5250147f.js"
import"./all-9248ebd2.js"
import{l as M,p as b}from"./lvlTests-6c0bd1bb.js"
import{l as L}from"./loadDataTables-6dbe583c.js"
import{o as P}from"./onlinePlayersPage-d3b9fc45.js"
...
return l-n>3e5?'<span> (takes a while to refresh so only do it if you really need to) </span><span id="fshRefresh" class="fshLink">[Refresh]</span>':`<span>[ Wait ${Math.round(300-(l-n)/1e3)}s ]</span>`}()}<div id="fshOutput"></div>`),u("fsh_onlinePlayers").then(H),c(T[0],E),h(T[0],"keyup",w)}export default function(n){f()||(T=n?$(n):$("#pCC"),L().then(F))}
//# sourceMappingURL=injectOnlinePlayers-b852c44a.js.map
