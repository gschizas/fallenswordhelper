import{S as t,C as n,T as e,U as s,b as a,V as i,D as f,W as u,X as c,N as r,v as l,Y as o,A as d,Z as b,_ as h,z as p,$ as m,o as k}from"./calfSystem-9b1fa4ca.js"
import{d as q,q as v}from"./quickbuffSuccess-a38bece6.js"
...
t&&b(t)}function M(t){return`<span class="fshLime">On</span>&nbsp;<span class="fshBuffOn">(${function(t){const n=Math.floor(t/60),e=t%60
let s=h(n,"m")
return n>0&&e>0&&(s+=" "),s+=h(e,"s"),s}(t)})</span>`}function _(n,e){const s=n[e]||0
...
//# sourceMappingURL=quickBuff-c99cb6fb.js.map
