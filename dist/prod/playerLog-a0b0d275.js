import{y as e,w as n,ah as t,av as a,v as s,aw as r,aj as i,bk as o,bi as c,ax as l,x as d,D as f,a0 as u,e as p,l as h,h as g,C as m,T as b,ab as v,bm as y,W as L,bs as w,bt as k,bu as T,bv as C,a4 as x,z as S,aR as _,b3 as P,G as R,R as M,a5 as A,i as H,bq as j,F as B}from"./calfSystem-d06402b1.js"
import{t as G}from"./toLowerCase-a009b564.js"
import{d as O}from"./dataRows-48658c8b.js"
import"./all-0c4e78e9.js"
import{a as z}from"./allthen-5b4db3f0.js"
import{q as I}from"./quickBuffHref-7624c50e.js"
import{b as D}from"./buffObj-f572dfdf.js"
import{g as N}from"./getMembrList-fe9ec2a4.js"
import{a as Y}from"./addLogColoring-7de7f9ed.js"
...
function oe(e,n){(function(e,n){return ie.every(t=>t(e,n))})(e,n)&&re(e)}function ce(e,n){return L(n.nicks).includes(G(e))}function le(e){return D.find(s(ce,e)).id}function de(e,n){let t=""
return t=n?I(e,L(n[0].replace(/`~|~`/g,"")).map(le).join(";")):I(e),` | <a ${t}>Buff</a></span>`}function fe(e,n){const t=e.cells[2].innerHTML,a=function(e){return e.substring(0,e.indexOf("<small>")+7)}(t)
...
return t?de(t[1],e.match(/`~.*?~`/)):""}(t)}${function(e){return p.addAttackLinkToLog?` | <a href="${C}${e}">Attack</a>`:""}(n)}${function(e){return e.substring(e.indexOf(">Trade</a>")+10,e.indexOf("</small>"))}(t)}</nobr>${function(e){return e.substring(e.indexOf("</small>"),e.length)}(t)}`,e.cells[2])}function ue(e,n,t){!function(e,n,t){let a=""
const s=e.cells[1].innerHTML,r=s.substring(0,s.indexOf(">Report")+7),i=s.substring(s.indexOf("Message</a>")+11,s.length)
n||(a=` | <a title="Add to Ignore List" href="${T}${t}">Ignore</a>`),m(`${r}</a>${a}${i}`,e.cells[1])}(e,n,t),fe(e,t)}function pe(e,n){"Notification"===n&&function(e){return e.cells[2]&&/You ranked \w{3} in your PvP Band! You have gained \d x PvP Ladder Token/.test(f(e.cells[2]))}(e)&&function(e){const n=o(c(e.cells[1]))
...
const a=B.exec(e.cells[2].innerHTML)[1],s=c(e.cells[2].children[0])
...
ke(e)&&(t=e.cells[2].children[0],a=c(t),s=!0)
const r=ve(s,a,t)
!function(e,n,t,a){"Chat"===e&&ue(n,t,a)}(n,e,r,a),function(e,n,t,a){"Notification"===n&&ke(e)&&we(e,t,a)}(e,n,a,r)}function Ce(e){const n=j(e.cells[0].children[0])
n&&(Te(e,n),oe(e,n),pe(e,n))}function xe(e){window.openQuickMsgDialog(e.target.getAttribute("target_player"),"",e.target.getAttribute("replyTo"))}function Se(e){["showPvPSummaryInLog","lastLadderReset","enableChatParsing"].forEach(A),function(e){const n=e.rows[0].cells[2]
n&&H(n,'&nbsp;&nbsp;<span class="fshWhite">(Guild mates show up in <span class="fshGreen">green</span>)</span>')}(e),function(e){O(e.rows,3,0).forEach(Ce)}(e),$(".a-reply").on("click",xe)}function _e(){p.addAttackLinkToLog=R("addAttackLinkToLog")
...
//# sourceMappingURL=playerLog-a0b0d275.js.map
