import{R as t,C as n,S as s,T as e,b as a,U as i,D as f,V as u,W as c,N as r,v as l,X as o,A as d,Y as b,Z as h,z as m,_ as p,o as k}from"./calfSystem-d06402b1.js"
import{s as q}from"./setTipped-f9a342fb.js"
import{d as v,q as T}from"./quickbuffSuccess-ec383d72.js"
function $(f){const u=function(n){let s=t("span.fshLastActivity",n)
if(!s){s=e({className:"fshLastActivity"})
const t=a("h1",n)[0]
i(s,t)}return s}(t(`div.player[data-username="${f.username}"]`))
n(`Last Activity: ${s(f.last_login)}<br>Stamina: ${f.current_stamina} / ${f.stamina} ( ${Math.floor(f.current_stamina/f.stamina*100)}% )`,u)}function S(t){return Number(f(t).replace(/\[|\]/g,""))}function y(t,s,a){if(!s)return void n("",a)
...
//# sourceMappingURL=quickBuff-a5e45127.js.map
