import{c6 as n,C as e,v as t,aF as s,ax as o,a4 as a,c8 as c,R as i,_ as r,l,U as u,Q as p,a0 as m,i as d,ak as f,bl as g,N as h,h as b,o as v,p as C,B as S,e as k,c9 as x,D as N,aL as E,j,G as y,A as L,K as A,P as $}from"./calfSystem-cb871cc0.js"
import{c as q}from"./createInput-91fe6fc0.js"
import{c as F}from"./createTable-5db037a2.js"
import{r as I,g as B}from"./rnd-590875bb.js"
import{p as P,a as T}from"./pubsub-e941acc1.js"
function Q(n,t){e("",n.children[0]),n.children[0].classList.add("fshPot"),n.children[0].style.backgroundImage=`url(${s}composing/${B(1,11)}_${B(1,51)}.png)`,e(`Creating '<span class="fshBold">${t}</span>' Potion`,n.children[2]),e("",n.children[3])}function _(n){const t=n.parentNode
t&&(e('<div class="fshScs">Success</div>',t),Q(t.previousElementSibling.previousElementSibling,n[n.selectedIndex].text),0===o('[id|="composing-template"]:not(#composing-template-multi)').length&&a(c,!1))}function w(n,t){const s=n.parentNode
s&&(t.error?e(`<div class="fshScs">${t.error}</div>`,s):_(n))}function R(e){var s;(s=e.value,n({cache:!1,dataType:"json",data:{cmd:"composing",subcmd:"createajax",template_id:s,fshrnd:I()}})).then(t(w,e))}function D(n,t){e("",n),n.classList.add("fshSpinner","fshSpinner12","fshComposingSpinner"),R(t),P("quickcreate")}function G(n,e){n.classList.add(`left-${e.toString()}`)}function K(n){G(n,o(".quickCreate .sendLink").length)}function M(n){const e=n.target,{templateId:t}=e.dataset
...
b(n,o),v(C,M),T("quickcreate",t(K,o))}function O(n){m("composing","FastCompose"),d(n,"<br>")
...
//# sourceMappingURL=composing-d17bd931.js.map
