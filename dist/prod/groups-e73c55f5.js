import{v as t,W as n,aK as e,a9 as s,i as a,h as o,o as r,N as i,R as c,G as l,n as f,e as u,cf as d,a0 as p,D as h,l as m,w as g,C as b,z as C}from"./calfSystem-4f7c0235.js"
import{c as w}from"./createInput-6766e17a.js"
import{o as S}from"./onlineDot-e2a5d8e2.js"
import"./createUl-fee39535.js"
import"./createButton-75879847.js"
import{g as x}from"./getMembrList-c30083ce.js"
import{d as j,g as v}from"./getGroupStats-9f7266f1.js"
import"./groupViewStats-020846f2.js"
...
function k(t){return!t.includes("#000099")}function E(t){b('<span class="fshXSmall fshBlue" style="line-height: 19px;">Joined</span>',t)}function F(e){const s=e.parentNode.parentNode.parentNode.cells[1]
...
e.parentNode.replaceChild(n,e),function(n,e){g({cmd:"guild",subcmd:"groups",subcmd2:"join",group_id:n}).then(t(E,e))}(/confirmJoin\((\d+)\)/.exec(e.href)[1],n)}}function H(){p("groups","joinAllGroupsUnderSize"),i('#pCC a[href*="confirmJoin"]').forEach(F)}function X(){const t=c('#pCC input[value="Join All Available Groups"]'),n=t.parentNode
...
r(n,z)}(n),u.subcmd2===d&&H()}export default function(){C()||(x(!1).then(J),function(){const t=l("minGroupLevel")
...
//# sourceMappingURL=groups-e73c55f5.js.map
