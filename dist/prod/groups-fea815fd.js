import{v as t,W as n,aK as e,a9 as s,i as a,h as o,o as r,N as i,R as c,G as l,n as d,e as f,cf as u,a0 as p,D as h,l as m,w as b,C as g,z as C}from"./calfSystem-72fdbe97.js"
import{c as w}from"./createInput-00d19dd2.js"
import{o as S}from"./onlineDot-8dcf0c88.js"
import"./createUl-43d45b37.js"
import"./createButton-24b50aa0.js"
import{g as x}from"./getMembrList-4c65de64.js"
import{d as j,g as v}from"./getGroupStats-756b3cc6.js"
import"./groupViewStats-d15a6c7a.js"
...
e.parentNode.replaceChild(n,e),function(n,e){b({cmd:"guild",subcmd:"groups",subcmd2:"join",group_id:n}).then(t(E,e))}(/confirmJoin\((\d+)\)/.exec(e.href)[1],n)}}function H(){p("groups","joinAllGroupsUnderSize"),i('#pCC a[href*="confirmJoin"]').forEach(F)}function X(){const t=c('#pCC input[value="Join All Available Groups"]'),n=t.parentNode
l("enableMaxGroupSizeToJoin")&&(L=l("maxGroupSizeToJoin"),d(t),function(t){const n=R(t,`Join All Groups < ${L} Members`)
r(n,H)}(n)),function(t){const n=R(t,"Fetch Group Stats")
r(n,z)}(n),f.subcmd2===u&&H()}export default function(){C()||(x(!1).then(J),function(){const t=l("minGroupLevel")
...
//# sourceMappingURL=groups-fea815fd.js.map
