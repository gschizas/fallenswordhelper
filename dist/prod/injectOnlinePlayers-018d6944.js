import{av as n,v as e,G as t,b3 as a,I as s,aL as l,aa as i,a4 as r,bc as o,z as f,ah as u,o as c,f as h,x as d,aj as p}from"./calfSystem-4b4fbec4.js"
import{n as v}from"./numberIsNaN-3b37a036.js"
import{b as m,p as g,c as y}from"./levelHighlight-3b6f5607.js"
import"./all-32d11926.js"
import{l as L,p as M}from"./lvlTests-2a610713.js"
import{l as b}from"./loadDataTables-66d6febe.js"
import{o as P}from"./onlinePlayersPage-c7424856.js"
...
return l-n>3e5?'<span> (takes a while to refresh so only do it if you really need to) </span><span id="fshRefresh" class="fshLink">[Refresh]</span>':`<span>[ Wait ${Math.round(300-(l-n)/1e3)}s ]</span>`}()}<div id="fshOutput"></div>`),u("fsh_onlinePlayers").then(H),c(T[0],E),h(T[0],"keyup",k)}export default function(n){f()||(T=n?$(n):$("#pCC"),b().then(F))}
//# sourceMappingURL=injectOnlinePlayers-018d6944.js.map
