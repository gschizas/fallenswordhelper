import{by as e,c6 as t,C as s,A as a,c8 as n,o as i,p as r,aT as c,bc as d}from"./calfSystem-c91e004c.js"
import{i as l}from"./isArray-e79fe430.js"
import{i as o}from"./isChecked-ba1d4cd2.js"
import{e as u}from"./eventHandler5-dd4a30e9.js"
import{s as h}from"./selfIdIs-3b64a445.js"
import{a as f,m}from"./makePageTemplate-a9399fd4.js"
let p
function g(e,t){return"checkbox"===p.tags[e]?`<input type="checkbox"${o(t)} disabled>`:function(e){return p.url&&""!==p.url[e]}(e)?`<a href="${p.url[e].replace("@replaceme@",t)}">${t}</a>`:t}function k(e,t){return`${e}<th>${t}</th>`}function y(e,t,s,a){let n="<tr>"
...
return t}(t),n+=`<td><span class="HelperTextLink" data-itemId="${s}" id="fshDel${s}">[Del]</span></td></tr>`,e+n}function b(){let e='<table cellspacing="2" cellpadding="2" class="fshGc" width="100%"><tr class="fshOr">'
e+=p.headers.reduce(k,""),e+="<th>Action</th></tr>",e+=p.currentItems.reduce(y,""),e+=function(){let e="<tr>"
for(let t=0;t<p.tags.length;t+=1)e+=`<td align=center><input type="${p.tags[t]}" class="custominput" id="fshIn${p.fields[t]}"></td>`
return e}(),e+='<td><span class="HelperTextLink" id="fshAdd">[Add]</span></td></tr></table><table width="100%"><tr><td class="fshCenter">'+`<textarea cols=70 rows=20 id="fshEd">${JSON.stringify(p.currentItems)}</textarea></td></tr>`+'<tr><td class="fshCenter"><input id="fshSave" type="button" value="Save" class="custombutton">&nbsp;<input id="fshReset" type="button" value="Reset" class="custombutton"></td></tr></tbody></table>',a(p.id)&&(s(e,a(p.id)),n(p.gmname,p.currentItems))}function I(e){const t=e.getAttribute("data-itemId")
p.currentItems.splice(t,1),b()}function w(){let e={}
