import{r as n,y as t,p as e,h as i,o as s,R as o,T as a,C as c,N as r,bt as u,au as f,at as m,P as l,j as p}from"./calfSystem-70c0e373.js"
import{c as v}from"./createInput-0bc2f786.js"
import{i as d}from"./insertTextBeforeEnd-37c89319.js"
import{j as h,o as b}from"./jsonFail-e3317ea9.js"
import{x as g}from"./xPath-879cd5fa.js"
function j(n){return function(n){return t({cmd:"inventing",subcmd:"doinvent",recipe_id:n})}(n)}let C,y,N
function I(n){var t
h(n,N)||b((t=n.r).item?`<span class="fshGreen">You successfully invented the item [${t.item.n}].</span>`:'<span class="fshRed">You have failed to invent the item.</span>',N)}function $(n){c(n,y),c("",N)}function w(){const n=Number(C.value)
if(!n)return void $("")
...
//# sourceMappingURL=inventing-5d038964.js.map
