import{r as n,y as t,p as e,h as i,o as s,R as o,T as a,C as r,N as u,bt as c,au as f,at as m,P as l,j as p}from"./calfSystem-2fb02284.js"
import{c as d}from"./createInput-a9eddcea.js"
import{i as v}from"./insertTextBeforeEnd-d19aa52d.js"
import{j as h,o as b}from"./jsonFail-062109b9.js"
import{x as g}from"./xPath-15a24817.js"
...
t=x(n),v(t,"Select how many to quick invent"),C=d({className:"custominput fshNumberInput",min:0,type:"number",value:1}),i(t,C),function(n){const t=d({className:"custombutton",type:"button",value:"Quick invent items"})
...
if(!e)return
const s=function(n){return c({href:R(n),target:"_blank"})}(e)
l(s,n),i(s,n)}function T(n){S(n,n)}function P(){!function(){const n=g('.//b[.="Target Invention"]/../../following-sibling::*[1]//img')
S(o("#pCC b"),n)}(),u('#pCC img[src*="/items/"]').forEach(T)}export default function(){p()&&(P(),E(e.lastElementChild))}
//# sourceMappingURL=inventing-b236dbc6.js.map
