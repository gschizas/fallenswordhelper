import{bd as t,v as n,be as s,W as e,aK as a,a9 as o,i as r,h as i,o as c,N as l,R as u,G as d,n as f,e as p,ck as h,a0 as b,D as m,l as g,w as C,C as w,z as S}from"./calfSystem-70c0e373.js"
import{c as x}from"./createInput-0bc2f786.js"
import{o as j}from"./onlineDot-cbb49e00.js"
import"./createUl-48b7bdd1.js"
import"./createButton-1947cfb3.js"
import{g as v}from"./getMembrList-159f55f9.js"
import{d as G,g as N}from"./getGroupStats-b5acd605.js"
import"./groupViewStats-1416c40b.js"
...
if(e(m(s)).filter(F).length<E){const s=g({className:"group-action-link fshRelative",innerHTML:'<span class="fshSpinner fshSpinner12"></span>',style:{height:"19px",width:"19px"}})
t.parentNode.replaceChild(s,t),function(t,s){C({cmd:"guild",subcmd:"groups",subcmd2:"join",group_id:t}).then(n(H,s))}(/confirmJoin\((\d+)\)/.exec(t.href)[1],s)}}function X(){b("groups","joinAllGroupsUnderSize"),l('#pCC a[href*="confirmJoin"]').forEach(P)}function _(){const t=u('#pCC input[value="Join All Available Groups"]'),n=t.parentNode
d("enableMaxGroupSizeToJoin")&&(E=d("maxGroupSizeToJoin"),f(t),function(t){const n=y(t,`Join All Groups < ${E} Members`)
c(n,X)}(n)),function(t){const n=y(t,"Fetch Group Stats")
c(n,L)}(n),p.subcmd2===h&&X()}export default function(){S()||(v(!1).then(q),function(){const t=d("minGroupLevel")
...
//# sourceMappingURL=groups-181e9688.js.map
