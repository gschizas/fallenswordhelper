import{aP as t,aF as s,ab as e,av as n,q as a,am as r,e as i,j as o,ah as c,p as f,C as h,A as l,o as d,v as u,aj as p}from"./calfSystem-2fb02284.js"
import"./toLowerCase-64958418.js"
import"./alpha-abff131f.js"
import{d as m}from"./doSortParams-7f1ae904.js"
import{p as g,s as y,a as C}from"./stringSort-a61f8e1d.js"
...
return s+=a(t).map($).join("<br>"),s+"</span>"}return'<span class="fshGrey">**Missing**</span>'}function v(n,a){return t(n[a],{name:a,image:(r=n[a].image_id,`<img class="tip-static" src="${s}creatures/${r}.png" data-tipped="<img src='${s}creatures/${r}.png' width=200 height=200>" width=40 height=40>`),level:e(n[a].level),attack:b(n[a].attack),defense:b(n[a].defense),armor:b(n[a].armor),damage:b(n[a].damage),hp:b(n[a].hp),enhancements:k(n[a].enhancements)})
