import{v as t,G as n,av as s,e,a0 as o,b as f,p as a,D as c,ac as u,C as r,A as i,q as l}from"./calfSystem-07c25a1c.js"
import{a as p}from"./roundToString-e73e5144.js"
import{t as b}from"./toLowerCase-5806cc21.js"
const d=[[t=>t.fsp>0,t=>`${p(t.fsp,2)} FSP`],[t=>t.fsp>0&&t.k>0,()=>" and "],[t=>t.k>0,t=>`${t.k} k`],[t=>t.stam>0&&(t.fsp>0||t.k>0),()=>" and "],[t=>t.stam>0,t=>`${t.stam} Stam(${p(t.stam/25,1)}fsp)`],[t=>t.unknown>0,t=>` (${t.unknown} buff(s) with unknown cost)`]]
...
function B(t){return t&&"BR"!==t.nodeName}function T(t){return b(t.replace($,"")).match(w)}function C(t){let n=function(t){let n="",s=t
for(;B(s);){const t=c(s)
...
let s,e
n?(s=function(t){return t[0].includes("k")?"k":t[0].includes("f")?"fsp":"stam"}(n),[e]=n[0].match(/([+-]?[.\d]+)/)):(s="unknown",e="1"),S.buffs[c(t)]=[parseFloat(e),s],S.count+=1}(t):(S.count-=1,delete S.buffs[s]),S.count>0?j():(r("&nbsp;",i("buffCost")),S.buffCostTotalText="")}function y(t){if("fshSendBuffMsg"===t.target.id)return void function(t){t.count>0&&k(t)}(S)
...
//# sourceMappingURL=render-397c9f7c.js.map
