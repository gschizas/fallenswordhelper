import{y as t,z as a,b as e,p as s,g as n,i,o as r,A as d,f as o,B as u,C as c,h as l,D as p}from"./calfSystem-2fb02284.js"
import"./numberIsNaN-076e64a6.js"
import"./testRange-e9149af3.js"
import{t as m}from"./testQuant-fe6a377a.js"
import{j as f,o as b}from"./jsonFail-062109b9.js"
...
const e=B()
e&&function(t,a){u(a,d("quantity")),h=t.getAttribute("itemid"),d("fshBazaarWarning").removeAttribute("class")
const e=t.cloneNode(!1)
e.className="bazaarSelected tip-dynamic"
const s=d("selectedItem")
c("",s),l(s,e)}(a,e)}function j(){const t=B()
t&&u(t,d("quantity"))}function N(t){const a=d("buy_result")
f(t,a)||t.s&&b("You purchased the item!",a)}function _(){if(!h)return
const t=p(d("quantity"))
u(`Buying ${t} items`,d("buyResultLabel"))
...
const t=e("img",s)[0]
t.className="fshFloatLeft",n("a",s).forEach(q),g=g.replace(/@\d@/g,""),i(t.parentNode,g),r(d("fshBazaar"),z),o(d("buy_amount"),"input",j),r(d("fshBuy"),_)}
//# sourceMappingURL=bazaar-2d3fba81.js.map
