import{b4 as n,N as t,q as e,v as a,aj as s,bc as r,I as o,c,b3 as i,y as l,aP as f,z as d,a0 as u,ah as m,bd as p,be as v}from"./calfSystem-fb94ddf0.js"
import{i as b}from"./isArray-dc6b23b1.js"
import{s as h}from"./setTipped-fee0b5e8.js"
import{a as g}from"./allthen-b2156df7.js"
import{l as y,p as x}from"./lvlTests-c7abb5dc.js"
import{l as L}from"./loadDataTables-795746bb.js"
import{c as M}from"./changeMinMax-c6cc0bbc.js"
import{f as T,a as _,m as j,t as k}from"./assets-90b59f36.js"
import{u as w}from"./updateUrl-e00f8709.js"
...
var e})(n,e)&&K(t)}function V(n,t,e){h(e.players.map(a(U,n)).join("<br>"),t),t.classList.add("tip-static"),n&&"Join"===t.value&&function(n,t,e){e.players.filter(t=>t.guild_id===n).length===e.max_players/4&&K(t)}(n,t,e)}const W=[n,n=>b(n.players),n=>n.players.length>0]
...
3!==t?a.order([3,"asc"],[t,e]).draw():a.order([3,e]).draw()}(t,t.index(),e)}function nn(n){return l(f({cmd:"arena"},n))}function tn(){return nn({subcmd:"view"})}function en(n,t){const e=$("tr",t).first()
$("a",e).contents().unwrap(),$(t).prepend($("<thead/>").append(e))}function an(){R(),N(),$.fn.dataTable.ext.search.push(J)}function sn(r,[o,c,l]){const f=$('table[width="635"]',r)
f.each(en),function(n){F=n||{},E=F.id||{},F.id={}}(o),function(n){n.children("tbody").children("tr").each(I)}(f),function(r){if(!n(r))return
...
s.forEach(a(X,i())),s.forEach(a(Q,e))}(l),an(),f.DataTable(k),function(n){$(Y,n).off("click"),n.on("click",Y,Z)}(r),r.on("click",'input.custombutton[type="submit"]',w)}function rn(n,e){p("arena.process"),t('#arenaTypeTabs tr[style="display: none;"]').forEach(n=>n.remove()),sn(n,e),v("arena.process")}function on(){if(d())return
...
//# sourceMappingURL=arena-a12b0fb0.js.map
