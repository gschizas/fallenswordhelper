import{R as t,C as n,S as e,T as s,b as a,U as i,D as f,V as u,W as c,N as r,v as l,X as o,A as d,Y as h,Z as b,z as p,_ as m,o as k}from"./calfSystem-c91e004c.js"
import{d as q,q as v}from"./quickbuffSuccess-f93a16e3.js"
function T(f){const u=function(n){let e=t("span.fshLastActivity",n)
if(!e){e=s({className:"fshLastActivity"})
const t=a("h1",n)[0]
i(e,t)}return e}(t(`div.player[data-username="${f.username}"]`))
n(`Last Activity: ${e(f.last_login)}<br>Stamina: ${f.current_stamina} / ${f.stamina} ( ${Math.floor(f.current_stamina/f.stamina*100)}% )`,u)}function $(t){return Number(f(t).replace(/\[|\]/g,""))}function S(t,e,a){if(!e)return void n("",a)
const f=$(t.nextElementSibling.children[0].children[0]),u=function(t,n){if(!n){const n=s({className:"fshPlayer"})
...
//# sourceMappingURL=quickBuff-cde11ea7.js.map
