import{bd as t,v as n,be as e,W as s,aK as a,a9 as o,i as r,h as i,o as c,N as l,R as f,G as u,n as d,e as p,ck as h,a0 as m,D as b,l as g,w as C,C as w,z as S}from"./calfSystem-c91e004c.js"
import{c as x}from"./createInput-2ffac67f.js"
import{o as j}from"./onlineDot-ae8b9648.js"
import"./createUl-23cd595f.js"
import"./createButton-ce930ef9.js"
import{g as v}from"./getMembrList-5e470800.js"
import{d as G,g as N}from"./getGroupStats-f83c086f.js"
import"./groupViewStats-cb24f5a5.js"
...
t.parentNode.replaceChild(e,t),function(t,e){C({cmd:"guild",subcmd:"groups",subcmd2:"join",group_id:t}).then(n(H,e))}(/confirmJoin\((\d+)\)/.exec(t.href)[1],e)}}function X(){m("groups","joinAllGroupsUnderSize"),l('#pCC a[href*="confirmJoin"]').forEach(P)}function _(){const t=f('#pCC input[value="Join All Available Groups"]'),n=t.parentNode
u("enableMaxGroupSizeToJoin")&&(E=u("maxGroupSizeToJoin"),d(t),function(t){const n=y(t,`Join All Groups < ${E} Members`)
...
//# sourceMappingURL=groups-28f58a6a.js.map
