import{y as t,z as n,g as s,p as i,P as e,Q as a,v as c,k as o,l as r,h as f,o as d,q as u,C as l,A as m}from"./calfSystem-fb94ddf0.js"
import{i as p}from"./isArray-dc6b23b1.js"
import{c as h}from"./createInput-ba8eca60.js"
import{c as b}from"./createLabel-32cbbbf5.js"
import{c as k}from"./createUl-65b855dd.js"
import{c as g}from"./chunk-17f7dc07.js"
import{j as v,o as T}from"./jsonFail-c6a52da6.js"
function j(n){return function(n){return t({cmd:"tempinv",subcmd:"takeitems",item:n})}(n)}function x(t,n,s){const i=b({id:t,className:"sendLink",htmlFor:"fshQuickTake",textContent:`Toggle ${n}`})
...
!function(t,n){u(n).forEach(c(L,t))}(i,t),f(n,i),d(i,c(Q,t,s))}function E(t){const n=r({id:"quickTake",innerHTML:'<div class="fshCenter"><br><font size="3"><b>Quick Take</b></font><br><br>Select which item to take all similar items from your Mailbox.</div><div></div>'}),s=function(t){const n=r(),s=k()
...
//# sourceMappingURL=mailbox-dd0ed063.js.map
