...
const injectBioWidgets = () => { runDefault(import('./bioWidgets-d980252a.js')); };
const injectGuild = () => { runDefault(import('./guild-cd89c632.js')); };
const injectProfile = () => { runDefault(import('./profile-9ad50e33.js').then(function (n) { return n.p; })); };
const injectProfileDropItems = () => { runDefault(import('./injectProfileDropItems-ba52482f.js')); };
const injectQuestBookFull = () => { runDefault(import('./injectQuestBookFull-92cac307.js')); };
const inventing = () => { runDefault(import('./inventing-bf41a8da.js')); };
const news = () => { runDefault(import('./news-b7d2e896.js')); };
const ufsgAllowBack = () => { runDefault(import('./ufsgAllowBack-ed27e415.js')); };
const viewArchive = () => { runDefault(import('./viewArchive-855fb7fa.js')); };

const injectBuffLog = (i) => { import('./injectBuffLog-91a16fe0.js').then((m) => m.default(i)); };
const injectFsBoxContent = (i) => { import('./injectFsBoxContent-f8ddf9c2.js').then((m) => m.default(i)); };
const injectMonsterLog = (i) => { import('./monstorLog-9d9460b3.js').then((m) => m.default(i)); };
const injectNotepadShowLogs = (i) => { import('./combatLog-10c453a1.js').then((m) => m.default(i)); };
const injectOnlinePlayers = (i) => { import('./injectOnlinePlayers-ccb7cb9c.js').then((m) => m.default(i)); };
const injectRecipeManager = (i) => { import('./recipeMgr-78d88ce9.js').then((m) => m.default(i)); };
const insertQuickExtract = (i) => { import('./quickExtract-f1a49d65.js').then((m) => m.default(i)); };
const insertQuickWear = (i) => { import('./quickWear-79e4e900.js').then((m) => m.default(i)); };

const injectAuctionSearch = (i) => { import('./lists-4e5f49d7.js').then((m) => m.injectAuctionSearch(i)); };
const injectQuickLinkManager = (i) => { import('./lists-4e5f49d7.js').then((m) => m.injectQuickLinkManager(i)); };
const injectFindBuffs = (i) => { import('./findBuffs-2f3e9f7c.js').then((m) => m.injectFindBuffs(i)); };
const injectFindOther = (i) => { import('./findBuffs-2f3e9f7c.js').then((m) => m.injectFindOther(i)); };
...
function getLinkConfig(theNav, myNav) {
  ...
  if (linkConfig.some(([, b]) => b)) {
    import('./injectItems-2161c680.js')
...
function moveUp(title) {
  import('./moveRHSBoxUpOnRHS-3a5e71e1.js').then((m) => m.default(title));
}

function moveLeft(title) {
  import('./moveRHSBoxToLHS-fc83cf9c.js').then((m) => m.default(title));
}
...
function callAllyEnemy() {
  if (calf.enableAllyOnlineList
    ...
    runDefault(import('./allyEnemy-6194ced2.js'));
  }
}
...
function callBounties() {
  if (calf.enableWantedList
    ...
    runDefault(import('./activeWantedBounties-ccb2e44d.js'));
  }
}

function callGuildInfo() {
  if (calf.enableGuildInfoWidgets) {
    runDefault(import('./addGuildInfoWidgets-66ef3213.js'));
  }
}

function callAllies() {
  if (calf.enableOnlineAlliesWidgets) {
    runDefault(import('./addOnlineAlliesWidgets-a47a5f2a.js'));
  }
}

function callTemple() {
  if (calf.enableTempleAlert) {
    runDefault(import('./injectTempleAlert-5ff60108.js'));
  }
}

function callUpgrade() {
  if (calf.enableUpgradeAlert) {
    runDefault(import('./injectUpgradeAlert-dc02fad9.js'));
  }
}

function callComposing() {
  if (calf.enableComposingAlert) {
    runDefault(import('./injectComposeAlert-e0d906c1.js'));
  }
}

function statbar() {
  if (getValue('statBarLinks')) {
    runDefault(import('./statBar-7790ac05.js'));
  }
}

function staminaCalc() {
  if (getValue('staminaCalculator')) {
    runDefault(import('./injectStaminaCalculator-ea92abe9.js'));
  }
}

function levelCalc() {
  if (getValue('levelUpCalculator')) {
    runDefault(import('./injectLevelupCalculator-158811c7.js'));
  }
}

function fsBoxLog() {
  if (getValue('fsboxlog')) {
    runDefault(import('./injectFSBoxLog-95111a5f.js'));
  }
}

function expandQb() {
  if (getValue('resizeQuickBuff')) {
    runDefault(import('./interceptQuickBuff-17edd4d0.js'));
  }
}

function joinAll() {
  if (getValue('joinAllLink')) {
    runDefault(import('./injectJoinAllLink-069bb11b.js'));
  }
}

function guildLogHref() {
  if (getValue('useNewGuildLog')) {
    runDefault(import('./changeGuildLogHREF-bb97cc8a.js'));
  }
}

function gameStats() {
  if (getValue('addServerNode')) {
    runDefault(import('./injectServerNode-61ccd52b.js'));
  }
}

function scoutTower() {
  if (getValue('addScoutTowerLink')) {
    runDefault(import('./scoutTowerLink-3aa8494c.js'));
  }
}

function guildActivityTracker() {
  if (jQueryPresent() && getValue(defEnableGuildActivityTracker)) {
    runDefault(import('./guildActivity-ff6041ee.js'));
  }
}

function seTracker() {
  if (jQueryPresent() && calf.enableSeTracker && calf.cmd !== 'superelite') {
    import('./seLog-fe7433a4.js').then((m) => m.seLog());
  }
}
...
const injectArena = () => { runDefault(import('./arena-bb4859d1.js').then(function (n) { return n.a; })); };
const arenaDoJoin = () => { runDefault(import('./arenaDoJoin-d8daa2eb.js')); };
const arenaJoin = () => {
  runDefault(import('./arenaJoin-8f06a23e.js'));
};
const completedArenas = () => {
  runDefault(import('./completedArenas-a496e980.js'));
};
const setupMoves = () => {
  runDefault(import('./setup-8fb52d5d.js'));
};
const storeMoves = () => { runDefault(import('./store-c8d68f99.js')); };
const results = () => { runDefault(import('./results-49e79c40.js')); };
...
const injectAuctionHouse = () => {
  runDefault(import('./injectAuctionHouse-27718557.js'));
};
const quickCreate = () => {
  runDefault(import('./quickCreate-27673d34.js'));
};
...
const composingBreakdown = () => { runDefault(import('./breakdown-016eb35f.js')); };
const composingCreate = () => { runDefault(import('./composingCreate-9b525724.js')); };
const injectComposing = () => { runDefault(import('./composing-d5f05045.js')); };
...
const injectAdvisor = () => {
  runDefault(import('./guildAdvisor-22bd1898.js'));
};
...
const injectGroups = () => {
  runDefault(import('./groups-a28817b7.js'));
};
const injectGroupStats = () => {
  runDefault(import('./injectGroupStats-7bfbb9d0.js'));
};
...
const guildHall = () => { runDefault(import('./hall-dae16dde.js')); };
...
const injectReportPaint = () => {
  runDefault(import('./guildReport-ea811f75.js'));
};
const injectGuildAddTagsWidgets = () => {
  runDefault(import('./injectGuildAddTagsWidgets-9916a64d.js'));
};
const storeitems = () => {
  runDefault(import('./storeitems-c93cea4d.js'));
};
...
const guildChat = () => { runDefault(import('./guildChat-b40bda76.js')); };
const guildLog = () => { runDefault(import('./guildLog-a8d3ddae.js')); };
const guildMailbox = () => {
  runDefault(import('./guildMailbox-932e9717.js'));
};
const injectGuildBank = () => {
  runDefault(import('./injectGuildBank-1a6cd47f.js'));
};
const injectGuildRanks = () => {
  runDefault(import('./rank-3c53b437.js'));
};
const injectRPUpgrades = () => {
  runDefault(import('./injectRPUpgrades-629efc56.js'));
};
const injectScouttower = () => {
  runDefault(import('./injectScouttower-146872dd.js'));
};
...
function injectWorld() {
  if (isNewMap()) {
    runDefault(import('./newMap-a223f29d.js'));
  }
}

const itemsView = () => { runDefault(import('./itemsView-dbbeeb3b.js')); };
...
const playerLog = () => { runDefault(import('./playerLog-31db1901.js')); };
const outbox = () => { runDefault(import('./outbox-5a511fac.js')); };
...
const newsFsbox = () => { runDefault(import('./newsFsbox-82b92ba4.js')); };
const newsShoutbox = () => { runDefault(import('./newsShoutbox-f834bcb9.js')); };
...
const unknownPage = () => { runDefault(import('./unknownPage-bb93746e.js')); };
...
const injectInventoryManagerNew = () => {
  runDefault(import('./inventory-b88d554e.js'));
};
const injectNewGuildLog = () => {
  runDefault(import('./newGuildLog-67505604.js'));
};
const injectNotepad = () => {
  runDefault(import('./injectNotepad-1e310fe9.js'));
};
const injectSaveSettings = () => { runDefault(import('./load-d797cf3e.js')); };
const reliclist = () => {
  runDefault(import('./reliclist-fcf6b1cc.js'));
};
const advisor$1 = () => { runDefault(import('./advisor-c35e28bd.js')); };
const crawler = () => {
  runDefault(import('./crawler-c59c71b0.js'));
};
const newGuildLog5 = () => {
  runDefault(import('./newGuildLog5-0bdecc1f.js'));
};
const whosGotWhat = () => {
  runDefault(import('./whosGotWhat-7ef3ae35.js'));
};
...
const injectQuestTracker = () => {
  runDefault(import('./injectQuestTracker-f6cad3f0.js'));
};
...
const showAllQuestSteps = () => {
  runDefault(import('./showAllQuestSteps-db840f11.js'));
};
...
const injectScavenging = () => {
  runDefault(import('./scavenging-68e17a63.js'));
};
...
const globalQuest = () => { runDefault(import('./globalQuest-8b6e4dc3.js')); };
const injectTopRated = () => { runDefault(import('./toprated-2ee7cabf.js')); };
...
const injectTrade = () => { runDefault(import('./trade-e8490b6f.js')); };
...
const craftForge = () => { runDefault(import('./craftForge-f6a88cd8.js')); };
const injectBank = () => { runDefault(import('./injectBank-12856d08.js')); };
const injectBazaar = () => { runDefault(import('./bazaar-829db1a3.js')); };
const injectFindPlayer = () => {
  runDefault(import('./injectFindPlayer-906c0d5c.js'));
};
const injectMailbox = () => { runDefault(import('./mailbox-69866caa.js')); };
const injectQuickBuff = () => {
  runDefault(import('./quickBuff-2451d658.js'));
};
const injectTitan = () => { runDefault(import('./injectTitan-62345ed7.js')); };
const injectSettings = () => {
  runDefault(import('./injectSettings-c2f09c9a.js'));
};
const ladder = () => { runDefault(import('./ladder-0ff65fad.js')); };
const marketplace = () => { runDefault(import('./marketplace-25405070.js')); };
const points = () => { runDefault(import('./points-23955a00.js')); };
const superelite = () => { runDefault(import('./superelite-379bb1f7.js')); };
...
export { escapeHtml as $, setInnerHtml as A, getText as B, searchPlayerUrl as C, querySelector as D, querySelectorArray as E, playerLinkSelector as F, getValue as G, defCharacterVirtualLevel as H, getElementsByClassName as I, defStatLevel as J, getTextTrim as K, quickbuffUrl as L, arrayFrom as M, indexPhp as N, isArray as O, once as P, clickThis as Q, getUrlParameter as R, insertHtml as S, nowSecs as T, scouttowerUrl as U, setValue as V, sendEvent as W, jQueryDialog as X, injectNotepadShowLogs as Y, injectMonsterLog as Z, getCalfPrefs as _, add as a, profile as a$, theLinks as a0, playerIdUrl as a1, notepadBlankUrl as a2, fallback as a3, contains as a4, insertHtmlAfterBegin as a5, now as a6, defLastLadderReset as a7, server as a8, cmdUrl as a9, sendGoldonWorld$1 as aA, retryAjax as aB, defStatAttack as aC, defStatDefense as aD, defStatArmor as aE, defStatDamage as aF, defStatHp as aG, cdn as aH, months as aI, defRefreshActionList as aJ, defStairway as aK, defShopPrompt as aL, defViewCreature as aM, jsonParse as aN, defFetchPlayerBackpackCount as aO, defControlsKeydown as aP, places as aQ, mercRE as aR, handleEvent as aS, fromEntries as aT, isObject as aU, defaults as aV, time as aW, timeEnd as aX, loadCss as aY, defTr as aZ, infoBox as a_, pointsUrl as aa, querySelectorAll as ab, sendException as ac, parseError as ad, defFetchPlayerBuffs as ae, defPlayerBuffs as af, defPlayerUpdate as ag, defTeleport as ah, defPvE as ai, isUndefined as aj, isFunction as ak, defAfterUpdateActionlist as al, defFetchWorldRealmDynamic as am, defFetchWorldRealmActions as an, hideQTip as ao, worldUrl as ap, defSubcmd as aq, guideUrl as ar, defRealmUpdate as as, defPlayerLevel as at, keys as au, defenderMultiplier as av, defRelicView as aw, doSendGold as ax, defPlayerGold as ay, initSendGoldOnWorld as az, createDiv as b, injectFsBoxContent as b$, off as b0, attribType as b1, itemType as b2, arenaUrl as b3, oldActionSpinner as b4, defTd as b5, playerId as b6, showPlayerUrl as b7, infoBoxFrom as b8, containsText as b9, auctionSearchUrl as bA, getValueJSON as bB, setValueJSON as bC, profileUrl as bD, defCmd as bE, composingUrl as bF, defNeedToCompose as bG, defLastComposeCheck as bH, screenview as bI, news as bJ, injectQuestBookFull as bK, inventing as bL, classHandler as bM, playerIDRE as bN, classPair as bO, injectGuild as bP, defJoinallgroupsundersize as bQ, pCR as bR, pCL as bS, secureUrl as bT, tradeUrl as bU, bountyUrl as bV, parseTemplePage as bW, displayDisconnectedFromGodsMessage as bX, blacksmithUrl as bY, dropItemsUrl as bZ, defStatbarLevel as b_, getCustomUrlParameter as ba, attackplayerUrl as bb, doAddIgnore as bc, combatSelector as bd, chatSelector as be, noteSelector as bf, ahSearchUrl as bg, rarity as bh, isString as bi, guildLogUrl as bj, GMSTORAGE_PATH as bk, guildRE as bl, enhancementType as bm, guildViewUrl as bn, daViewProfile as bo, lastActivityRE as bp, defEnableGuildActivityTracker as bq, draggable as br, recallUserUrl as bs, defStatVl as bt, runDefault as bu, asyncPThree as bv, updateArchiveUrl as bw, archiveUrl as bx, fshBuffLog as by, composingFragmentType as bz, calf as c, joinallUrl as c0, joinUnderUrl as c1, newGuildLogLoc as c2, newGuildLogUrl as c3, injectAuctionSearch as c4, injectOnlinePlayers as c5, injectFindOther as c6, injectFindBuffs as c7, injectRecipeManager as c8, injectBuffLog as c9, injectQuickLinkManager as ca, auctionhouseUrl as cb, insertQuickExtract as cc, insertQuickWear as cd, dispatch as ce, defTable as d, entries as e, insertHtmlBeforeEnd as f, getElementsByTagName as g, hasClass as h, insertElement as i, jQueryPresent as j, on as k, itemRE as l, getArrayByTagName as m, cElement as n, onclick as o, pCC as p, extend as q, indexAjax as r, partial as s, createDocument as t, indexAjaxData as u, guildSubcmdUrl as v, callApp as w, jQueryNotPresent as x, getElementById as y, setText as z };
//# sourceMappingURL=calfSystem-21d16a0e.js.map
