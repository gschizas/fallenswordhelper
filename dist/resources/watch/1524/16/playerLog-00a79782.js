import { l as entries, aW as isObject, a4 as getTextTrim, N as querySelector, bc as attackplayerUrl, H as querySelectorArray, bd as chatSelector, y as setText, be as doAddIgnore, v as callApp, R as nowSecs, r as partial, aV as fromEntries, a5 as insertHtmlAfterBegin, i as insertElement, b as createDiv, bf as combatSelector, e as insertHtmlBeforeEnd, bg as playerLinkSelector, a3 as arrayFrom, D as getValue, o as onclick, bh as noteSelector, bi as tradeUrl, bj as secureUrl, A as getText, T as setValue, a7 as defLastLadderReset, w as jQueryNotPresent } from './calfSystem-6e4b53e3.js';
...
import { b as buffList } from './buffObj-f9986624.js';
...
import { a as addLogColoring } from './addLogColoring-eabc2870.js';
...
async function addPvPSummary(logTable) {
  const combatImg = querySelectorArray(combatSelector, logTable);
  if (combatImg.length === 0) { return; }
  const combatRows = combatImg.map(closestTr);
...
//# sourceMappingURL=playerLog-00a79782.js.map
