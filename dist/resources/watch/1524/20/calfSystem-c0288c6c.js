...
const injectBioWidgets = () => { runDefault(import('./bioWidgets-4880d36c.js')); };
const injectGuild = () => { runDefault(import('./guild-bfc147d3.js')); };
const injectProfile = () => { runDefault(import('./profile-6a8f9c2c.js').then(function (n) { return n.p; })); };
const injectProfileDropItems = () => { runDefault(import('./injectProfileDropItems-0db4c07a.js')); };
const injectQuestBookFull = () => { runDefault(import('./injectQuestBookFull-497a47cf.js')); };
const injectStoreItems = () => { runDefault(import('./injectStoreItems-45b3ceb8.js')); };
const inventing = () => { runDefault(import('./inventing-88038d57.js')); };
const news = () => { runDefault(import('./news-76c1629f.js')); };
const ufsgAllowBack = () => { runDefault(import('./ufsgAllowBack-e8c37d6f.js')); };
const viewArchive = () => { runDefault(import('./viewArchive-956ddcac.js')); };

const injectBuffLog = (i) => { import('./injectBuffLog-4089ef59.js').then((m) => m.default(i)); };
const injectFsBoxContent = (i) => { import('./injectFsBoxContent-f99c20be.js').then((m) => m.default(i)); };
const injectMonsterLog = (i) => { import('./monstorLog-4c646d8e.js').then((m) => m.default(i)); };
const injectNotepadShowLogs = (i) => { import('./combatLog-17b62d02.js').then((m) => m.default(i)); };
const injectOnlinePlayers = (i) => { import('./injectOnlinePlayers-0dfb0fb1.js').then((m) => m.default(i)); };
const injectRecipeManager = (i) => { import('./recipeMgr-010713fa.js').then((m) => m.default(i)); };
const insertQuickExtract = (i) => { import('./quickExtract-94f2312e.js').then((m) => m.default(i)); };
const insertQuickWear = (i) => { import('./quickWear-963d5cd1.js').then((m) => m.default(i)); };

const injectAuctionSearch = (i) => { import('./lists-819454cc.js').then((m) => m.injectAuctionSearch(i)); };
const injectQuickLinkManager = (i) => { import('./lists-819454cc.js').then((m) => m.injectQuickLinkManager(i)); };
const injectFindBuffs = (i) => { import('./findBuffs-f9c9d6e1.js').then((m) => m.injectFindBuffs(i)); };
const injectFindOther = (i) => { import('./findBuffs-f9c9d6e1.js').then((m) => m.injectFindOther(i)); };
...
function getLinkConfig(theNav, myNav) {
  ...
  if (linkConfig.some(([, b]) => b)) {
    import('./injectItems-87ce6bc0.js')
...
function moveUp(title) {
  import('./moveRHSBoxUpOnRHS-47d3ff9a.js').then((m) => m.default(title));
}

function moveLeft(title) {
  import('./moveRHSBoxToLHS-e7a6636d.js').then((m) => m.default(title));
}
...
function callAllyEnemy() {
  if (calf.enableAllyOnlineList
    ...
    runDefault(import('./allyEnemy-af9dc9de.js'));
  }
}
...
function callBounties() {
  if (calf.enableWantedList
    ...
    runDefault(import('./activeWantedBounties-f04dc2cb.js'));
  }
}

function callGuildInfo() {
  if (calf.enableGuildInfoWidgets) {
    runDefault(import('./addGuildInfoWidgets-86846901.js'));
  }
}

function callAllies() {
  if (calf.enableOnlineAlliesWidgets) {
    runDefault(import('./addOnlineAlliesWidgets-b63a13c8.js'));
  }
}

function callTemple() {
  if (calf.enableTempleAlert) {
    runDefault(import('./injectTempleAlert-6c2c7c19.js'));
  }
}

function callUpgrade() {
  if (calf.enableUpgradeAlert) {
    runDefault(import('./injectUpgradeAlert-7063237f.js'));
  }
}

function callComposing() {
  if (calf.enableComposingAlert) {
    runDefault(import('./injectComposeAlert-27ddc0a3.js'));
  }
}

function statbar() {
  if (getValue('statBarLinks')) {
    runDefault(import('./statBar-102752f6.js'));
  }
}

function staminaCalc() {
  if (getValue('staminaCalculator')) {
    runDefault(import('./injectStaminaCalculator-b3b4f0ad.js'));
  }
}

function levelCalc() {
  if (getValue('levelUpCalculator')) {
    runDefault(import('./injectLevelupCalculator-8abc35e4.js'));
  }
}

function fsBoxLog() {
  if (getValue('fsboxlog')) {
    runDefault(import('./injectFSBoxLog-ba294d65.js'));
  }
}

function expandQb() {
  if (getValue('resizeQuickBuff')) {
    runDefault(import('./interceptQuickBuff-aa8bf08d.js'));
  }
}

function joinAll() {
  if (getValue('joinAllLink')) {
    runDefault(import('./injectJoinAllLink-70e2f87a.js'));
  }
}

function guildLogHref() {
  if (getValue('useNewGuildLog')) {
    runDefault(import('./changeGuildLogHREF-999c271a.js'));
  }
}

function gameStats() {
  if (getValue('addServerNode')) {
    runDefault(import('./injectServerNode-d70eec7e.js'));
  }
}

function scoutTower() {
  if (getValue('addScoutTowerLink')) {
    runDefault(import('./scoutTowerLink-0ee3be2a.js'));
  }
}

function guildActivityTracker() {
  if (jQueryPresent() && getValue(defEnableGuildActivityTracker)) {
    runDefault(import('./guildActivity-ea068236.js'));
  }
}

function seTracker() {
  if (jQueryPresent() && calf.enableSeTracker && calf.cmd !== 'superelite') {
    import('./seLog-52627d06.js').then((m) => m.seLog());
  }
}
...
const injectArena = () => { runDefault(import('./arena-e151aa57.js').then(function (n) { return n.a; })); };
const arenaDoJoin = () => { runDefault(import('./arenaDoJoin-9c74e67d.js')); };
const arenaJoin = () => {
  runDefault(import('./arenaJoin-072269fc.js'));
};
const completedArenas = () => {
  runDefault(import('./completedArenas-35b70428.js'));
};
const setupMoves = () => {
  runDefault(import('./setup-f17a8f45.js'));
};
const storeMoves = () => { runDefault(import('./store-240fbb1e.js')); };
const results = () => { runDefault(import('./results-f35444a1.js')); };
...
const injectAuctionHouse = () => {
  runDefault(import('./injectAuctionHouse-174f2f03.js'));
};
const quickCreate = () => {
  runDefault(import('./quickCreate-d485df59.js'));
};
...
const composingBreakdown = () => { runDefault(import('./breakdown-18af50b5.js')); };
const composingCreate = () => { runDefault(import('./composingCreate-7fa39ae4.js')); };
const injectComposing = () => { runDefault(import('./composing-29a809a2.js')); };
...
const injectAdvisor = () => {
  runDefault(import('./guildAdvisor-44e9a73c.js'));
};
...
const injectGroups = () => {
  runDefault(import('./groups-e98651a8.js'));
};
const injectGroupStats = () => {
  runDefault(import('./injectGroupStats-27062795.js'));
};
...
const guildHall = () => { runDefault(import('./hall-3edc89b6.js')); };
...
const injectGuildAddTagsWidgets = () => {
  runDefault(import('./injectGuildAddTagsWidgets-9e699057.js'));
};
const injectReportPaint = () => {
  runDefault(import('./guildReport-06812a5c.js'));
};
...
const guildChat = () => { runDefault(import('./guildChat-9f93a22f.js')); };
const guildLog = () => { runDefault(import('./guildLog-14ac79e4.js')); };
const guildMailbox = () => {
  runDefault(import('./guildMailbox-144cccfa.js'));
};
const injectGuildBank = () => {
  runDefault(import('./injectGuildBank-e50a73f7.js'));
};
const injectGuildRanks = () => {
  runDefault(import('./rank-5d42dbe2.js'));
};
const injectRPUpgrades = () => {
  runDefault(import('./injectRPUpgrades-93036d4b.js'));
};
const injectScouttower = () => {
  runDefault(import('./injectScouttower-25d9afc9.js'));
};
...
function injectWorld() {
  if (isNewMap()) {
    runDefault(import('./newMap-27db3cde.js'));
  }
}

const itemsView = () => { runDefault(import('./itemsView-79f60cb5.js')); };
...
const playerLog = () => { runDefault(import('./playerLog-7ef1b1bb.js')); };
const outbox = () => { runDefault(import('./outbox-4477eb5d.js')); };
...
const newsFsbox = () => { runDefault(import('./newsFsbox-4189bb0e.js')); };
const newsShoutbox = () => { runDefault(import('./newsShoutbox-6ccea22d.js')); };
...
const unknownPage = () => { runDefault(import('./unknownPage-04abf0c4.js')); };
...
const injectInventoryManagerNew = () => {
  runDefault(import('./inventory-1118e19c.js'));
};
const injectNewGuildLog = () => {
  runDefault(import('./newGuildLog-430404b4.js'));
};
const injectNotepad = () => {
  runDefault(import('./injectNotepad-66c7ef9a.js'));
};
const injectSaveSettings = () => { runDefault(import('./load-a6ffcb85.js')); };
const reliclist = () => {
  runDefault(import('./reliclist-5bf893fc.js'));
};
const advisor$1 = () => { runDefault(import('./advisor-2eeb1492.js')); };
const crawler = () => {
  runDefault(import('./crawler-af3ea801.js'));
};
const newGuildLog5 = () => {
  runDefault(import('./newGuildLog5-3cd1c3d6.js'));
};
const whosGotWhat = () => {
  runDefault(import('./whosGotWhat-6962b157.js'));
};
...
const injectQuestTracker = () => {
  runDefault(import('./injectQuestTracker-6c95b62e.js'));
};
...
const showAllQuestSteps = () => {
  runDefault(import('./showAllQuestSteps-9f4d8c60.js'));
};
...
const injectScavenging = () => {
  runDefault(import('./scavenging-8e92f7fa.js'));
};
...
const globalQuest = () => { runDefault(import('./globalQuest-5898492b.js')); };
const injectTopRated = () => { runDefault(import('./toprated-5a3ed959.js')); };
...
const injectTrade = () => { runDefault(import('./trade-465531f5.js')); };
...
const craftForge = () => { runDefault(import('./craftForge-091cf3a5.js')); };
const injectBank = () => { runDefault(import('./injectBank-dacca57f.js')); };
const injectBazaar = () => { runDefault(import('./bazaar-243749d5.js')); };
const injectFindPlayer = () => {
  runDefault(import('./injectFindPlayer-08fcf1ca.js'));
};
const injectMailbox = () => { runDefault(import('./mailbox-4c4af78e.js')); };
const injectQuickBuff = () => {
  runDefault(import('./quickBuff-5889f4bb.js'));
};
const injectTitan = () => { runDefault(import('./injectTitan-c4921e82.js')); };
const injectSettings = () => {
  runDefault(import('./injectSettings-6a7fae3c.js'));
};
const ladder = () => { runDefault(import('./ladder-258da399.js')); };
const marketplace = () => { runDefault(import('./marketplace-cd4cb221.js')); };
const points = () => { runDefault(import('./points-bf53aa09.js')); };
const superelite = () => { runDefault(import('./superelite-c2f2e173.js')); };
...
export { escapeHtml as $, setInnerHtml as A, getText as B, searchPlayerUrl as C, querySelector as D, querySelectorArray as E, playerLinkSelector as F, getValue as G, defCharacterVirtualLevel as H, getElementsByClassName as I, defStatLevel as J, getTextTrim as K, quickbuffUrl as L, arrayFrom as M, indexPhp as N, isArray as O, once as P, getUrlParameter as Q, clickThis as R, insertHtml as S, nowSecs as T, scouttowerUrl as U, setValue as V, sendEvent as W, jQueryDialog as X, injectNotepadShowLogs as Y, injectMonsterLog as Z, getCalfPrefs as _, add as a, infoBox as a$, theLinks as a0, playerIdUrl as a1, notepadBlankUrl as a2, fallback as a3, contains as a4, insertHtmlAfterBegin as a5, now as a6, defLastLadderReset as a7, server as a8, cmdUrl as a9, sendGoldonWorld$1 as aA, retryAjax as aB, defStatAttack as aC, defStatDefense as aD, defStatArmor as aE, defStatDamage as aF, defStatHp as aG, cdn as aH, months as aI, defRefreshActionList as aJ, defStairway as aK, defShopPrompt as aL, defViewCreature as aM, jsonParse as aN, executeAll as aO, defFetchPlayerBackpackCount as aP, defControlsKeydown as aQ, places as aR, mercRE as aS, handleEvent as aT, fromEntries as aU, isObject as aV, defaults as aW, time as aX, timeEnd as aY, loadCss as aZ, defTr as a_, pointsUrl as aa, querySelectorAll as ab, sendException as ac, parseError as ad, defFetchPlayerBuffs as ae, defPlayerBuffs as af, defPlayerUpdate as ag, defTeleport as ah, defPvE as ai, isUndefined as aj, isFunction as ak, defAfterUpdateActionlist as al, defFetchWorldRealmDynamic as am, defFetchWorldRealmActions as an, hideQTip as ao, worldUrl as ap, defSubcmd as aq, guideUrl as ar, defRealmUpdate as as, defPlayerLevel as at, keys as au, defenderMultiplier as av, defRelicView as aw, doSendGold as ax, defPlayerGold as ay, initSendGoldOnWorld as az, createDiv as b, injectFsBoxContent as b$, profile as b0, off as b1, attribType as b2, itemType as b3, arenaUrl as b4, oldActionSpinner as b5, defTd as b6, playerId as b7, showPlayerUrl as b8, infoBoxFrom as b9, fshBuffLog as bA, getCustomUrlParameter as bB, composingFragmentType as bC, auctionSearchUrl as bD, getValueJSON as bE, setValueJSON as bF, profileUrl as bG, defCmd as bH, composingUrl as bI, defNeedToCompose as bJ, defLastComposeCheck as bK, screenview as bL, news as bM, injectQuestBookFull as bN, inventing as bO, injectGuild as bP, classHandler as bQ, classPair as bR, defJoinallgroupsundersize as bS, pCR as bT, pCL as bU, bountyUrl as bV, parseTemplePage as bW, displayDisconnectedFromGodsMessage as bX, blacksmithUrl as bY, dropItemsUrl as bZ, defStatbarLevel as b_, containsText as ba, attackplayerUrl as bb, chatSelector as bc, doAddIgnore as bd, combatSelector as be, noteSelector as bf, playerIDRE as bg, tradeUrl as bh, secureUrl as bi, ahSearchUrl as bj, rarity as bk, isString as bl, guildLogUrl as bm, GMSTORAGE_PATH as bn, guildRE as bo, enhancementType as bp, guildViewUrl as bq, daViewProfile as br, lastActivityRE as bs, defEnableGuildActivityTracker as bt, draggable as bu, recallUserUrl as bv, defStatVl as bw, runDefault as bx, updateArchiveUrl as by, archiveUrl as bz, calf as c, joinallUrl as c0, joinUnderUrl as c1, newGuildLogLoc as c2, newGuildLogUrl as c3, injectAuctionSearch as c4, injectOnlinePlayers as c5, injectFindOther as c6, injectFindBuffs as c7, injectRecipeManager as c8, injectBuffLog as c9, injectQuickLinkManager as ca, auctionhouseUrl as cb, insertQuickExtract as cc, insertQuickWear as cd, dispatch as ce, defTable as d, insertHtmlBeforeEnd as e, on as f, getElementsByTagName as g, hasClass as h, insertElement as i, jQueryPresent as j, itemRE as k, getArrayByTagName as l, entries as m, cElement as n, onclick as o, pCC as p, extend as q, indexAjax as r, partial as s, createDocument as t, indexAjaxData as u, guildSubcmdUrl as v, callApp as w, jQueryNotPresent as x, getElementById as y, setText as z };
//# sourceMappingURL=calfSystem-c0288c6c.js.map
