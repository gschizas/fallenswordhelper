...
const injectBioWidgets = () => { runDefault(import('./bioWidgets-2e7e5e8b.js')); };
const injectGuild = () => { runDefault(import('./guild-d550ac51.js')); };
const injectProfile = () => { runDefault(import('./profile-3eb89f48.js').then(function (n) { return n.p; })); };
const injectProfileDropItems = () => { runDefault(import('./injectProfileDropItems-18b4f427.js')); };
const injectQuestBookFull = () => { runDefault(import('./injectQuestBookFull-2e104fe0.js')); };
const inventing = () => { runDefault(import('./inventing-e944595b.js')); };
const news = () => { runDefault(import('./news-6ba6900c.js')); };
const ufsgAllowBack = () => { runDefault(import('./ufsgAllowBack-dd0295a8.js')); };
const viewArchive = () => { runDefault(import('./viewArchive-4c460a95.js')); };

const injectBuffLog = (i) => { import('./injectBuffLog-5f9db321.js').then((m) => m.default(i)); };
const injectFsBoxContent = (i) => { import('./injectFsBoxContent-f3d5fcd1.js').then((m) => m.default(i)); };
const injectMonsterLog = (i) => { import('./monstorLog-08a984ab.js').then((m) => m.default(i)); };
const injectNotepadShowLogs = (i) => { import('./combatLog-b71e0d58.js').then((m) => m.default(i)); };
const injectOnlinePlayers = (i) => { import('./injectOnlinePlayers-41742a26.js').then((m) => m.default(i)); };
const injectRecipeManager = (i) => { import('./recipeMgr-d54bded8.js').then((m) => m.default(i)); };
const insertQuickExtract = (i) => { import('./quickExtract-71c034af.js').then((m) => m.default(i)); };
const insertQuickWear = (i) => { import('./quickWear-72683150.js').then((m) => m.default(i)); };

const injectAuctionSearch = (i) => { import('./lists-1ec9c2de.js').then((m) => m.injectAuctionSearch(i)); };
const injectQuickLinkManager = (i) => { import('./lists-1ec9c2de.js').then((m) => m.injectQuickLinkManager(i)); };
const injectFindBuffs = (i) => { import('./findBuffs-a645d6bf.js').then((m) => m.injectFindBuffs(i)); };
const injectFindOther = (i) => { import('./findBuffs-a645d6bf.js').then((m) => m.injectFindOther(i)); };
...
function getLinkConfig(theNav, myNav) {
  ...
  if (linkConfig.some(([, b]) => b)) {
    import('./injectItems-e4f45f58.js')
...
function moveUp(title) {
  import('./moveRHSBoxUpOnRHS-66fed59f.js').then((m) => m.default(title));
}

function moveLeft(title) {
  import('./moveRHSBoxToLHS-8f0fd3c7.js').then((m) => m.default(title));
}
...
function callAllyEnemy() {
  if (calf.enableAllyOnlineList
    ...
    runDefault(import('./allyEnemy-a8f75453.js'));
  }
}
...
function callBounties() {
  if (calf.enableWantedList
    ...
    runDefault(import('./activeWantedBounties-6ba0b6a8.js'));
  }
}

function callGuildInfo() {
  if (calf.enableGuildInfoWidgets) {
    runDefault(import('./addGuildInfoWidgets-dca56530.js'));
  }
}

function callAllies() {
  if (calf.enableOnlineAlliesWidgets) {
    runDefault(import('./addOnlineAlliesWidgets-2281fc14.js'));
  }
}

function callTemple() {
  if (calf.enableTempleAlert) {
    runDefault(import('./injectTempleAlert-5f321018.js'));
  }
}

function callUpgrade() {
  if (calf.enableUpgradeAlert) {
    runDefault(import('./injectUpgradeAlert-02183c96.js'));
  }
}

function callComposing() {
  if (calf.enableComposingAlert) {
    runDefault(import('./injectComposeAlert-6e7b69e9.js'));
  }
}

function statbar() {
  if (getValue('statBarLinks')) {
    runDefault(import('./statBar-afd8fbe1.js'));
  }
}

function staminaCalc() {
  if (getValue('staminaCalculator')) {
    runDefault(import('./injectStaminaCalculator-7d3581cc.js'));
  }
}

function levelCalc() {
  if (getValue('levelUpCalculator')) {
    runDefault(import('./injectLevelupCalculator-12bfc409.js'));
  }
}

function fsBoxLog() {
  if (getValue('fsboxlog')) {
    runDefault(import('./injectFSBoxLog-5ae179a9.js'));
  }
}

function expandQb() {
  if (getValue('resizeQuickBuff')) {
    runDefault(import('./interceptQuickBuff-51d144d0.js'));
  }
}

function joinAll() {
  if (getValue('joinAllLink')) {
    runDefault(import('./injectJoinAllLink-d59a47f0.js'));
  }
}

function guildLogHref() {
  if (getValue('useNewGuildLog')) {
    runDefault(import('./changeGuildLogHREF-20b1466e.js'));
  }
}

function gameStats() {
  if (getValue('addServerNode')) {
    runDefault(import('./injectServerNode-e4ebee93.js'));
  }
}

function scoutTower() {
  if (getValue('addScoutTowerLink')) {
    runDefault(import('./scoutTowerLink-a04bc453.js'));
  }
}

function guildActivityTracker() {
  if (jQueryPresent() && getValue(defEnableGuildActivityTracker)) {
    runDefault(import('./guildActivity-906c4ecb.js'));
  }
}

function seTracker() {
  if (jQueryPresent() && calf.enableSeTracker && calf.cmd !== 'superelite') {
    import('./seLog-c3cb47cc.js').then((m) => m.seLog());
  }
}
...
const injectArena = () => { runDefault(import('./arena-42a8ba5b.js').then(function (n) { return n.b; })); };
const arenaDoJoin = () => { runDefault(import('./arenaDoJoin-b37de617.js')); };
const arenaJoin = () => {
  runDefault(import('./arenaJoin-b7b7ba1d.js'));
};
const completedArenas = () => {
  runDefault(import('./completedArenas-96b2b90f.js'));
};
const setupMoves = () => {
  runDefault(import('./setup-4d0e8e26.js'));
};
const storeMoves = () => { runDefault(import('./store-41008a93.js')); };
const results = () => { runDefault(import('./results-ead7b46a.js')); };
...
const injectAuctionHouse = () => {
  runDefault(import('./injectAuctionHouse-94d8b893.js'));
};
const quickCreate = () => {
  runDefault(import('./quickCreate-1044b2b9.js'));
};
...
const composingBreakdown = () => { runDefault(import('./breakdown-1883c516.js')); };
const composingCreate = () => { runDefault(import('./composingCreate-a68407b4.js')); };
const injectComposing = () => { runDefault(import('./composing-5b50946a.js')); };
...
const injectAdvisor = () => {
  runDefault(import('./guildAdvisor-f634d542.js'));
};
...
const injectGroups = () => {
  runDefault(import('./groups-2f8d93cb.js'));
};
const injectGroupStats = () => {
  runDefault(import('./injectGroupStats-14d23068.js'));
};
...
const guildHall = () => { runDefault(import('./hall-55e2f7d1.js')); };
...
const injectReportPaint = () => {
  runDefault(import('./guildReport-1d02d4ab.js'));
};
const injectGuildAddTagsWidgets = () => {
  runDefault(import('./injectGuildAddTagsWidgets-d4467b4e.js'));
};
const storeitems = () => {
  runDefault(import('./storeitems-f8dbbaf3.js'));
};
...
const guildChat = () => { runDefault(import('./guildChat-cc29084e.js')); };
const guildLog = () => { runDefault(import('./guildLog-1fb704cf.js')); };
const guildMailbox = () => {
  runDefault(import('./guildMailbox-519df0d0.js'));
};
const injectGuildBank = () => {
  runDefault(import('./injectGuildBank-dbf063e4.js'));
};
const injectGuildRanks = () => {
  runDefault(import('./rank-5d579fb1.js'));
};
const injectRPUpgrades = () => {
  runDefault(import('./injectRPUpgrades-84138454.js'));
};
const injectScouttower = () => {
  runDefault(import('./injectScouttower-dac8df74.js'));
};
...
function injectWorld() {
  if (isNewMap()) {
    runDefault(import('./newMap-5e524410.js'));
  }
}

const itemsView = () => { runDefault(import('./itemsView-b41c830d.js')); };
...
const playerLog = () => { runDefault(import('./playerLog-b12354db.js')); };
const outbox = () => { runDefault(import('./outbox-113431a1.js')); };
...
const newsFsbox = () => { runDefault(import('./newsFsbox-aa48bacd.js')); };
const newsShoutbox = () => { runDefault(import('./newsShoutbox-35a2f412.js')); };
...
const unknownPage = () => { runDefault(import('./unknownPage-6acde7de.js')); };
...
const injectInventoryManagerNew = () => {
  runDefault(import('./inventory-3d0865e3.js'));
};
const injectNewGuildLog = () => {
  runDefault(import('./newGuildLog-72505611.js'));
};
const injectNotepad = () => {
  runDefault(import('./injectNotepad-59a70d4e.js'));
};
const injectSaveSettings = () => { runDefault(import('./load-87a6c736.js')); };
const reliclist = () => {
  runDefault(import('./reliclist-23581b25.js'));
};
const whosGotWhat = () => {
  runDefault(import('./whosGotWhat-bbe8c9cd.js'));
};
...
const injectQuestTracker = () => {
  runDefault(import('./injectQuestTracker-c69b9662.js'));
};
...
const showAllQuestSteps = () => {
  runDefault(import('./showAllQuestSteps-c68e4581.js'));
};
...
const injectScavenging = () => {
  runDefault(import('./scavenging-740b5024.js'));
};
...
const globalQuest = () => { runDefault(import('./globalQuest-3ff1afba.js')); };
const injectTopRated = () => { runDefault(import('./toprated-1369f64e.js')); };
...
const injectTrade = () => { runDefault(import('./trade-133496b7.js')); };
...
const craftForge = () => { runDefault(import('./craftForge-41f628f2.js')); };
const injectBank = () => { runDefault(import('./injectBank-869f912c.js')); };
const injectBazaar = () => { runDefault(import('./bazaar-204a563d.js')); };
const injectFindPlayer = () => {
  runDefault(import('./injectFindPlayer-e8d9c3a5.js'));
};
const injectMailbox = () => { runDefault(import('./mailbox-8241f5d1.js')); };
const injectQuickBuff = () => {
  runDefault(import('./quickBuff-50f31026.js'));
};
const injectTitan = () => { runDefault(import('./injectTitan-dbf44e91.js')); };
const injectSettings = () => {
  runDefault(import('./injectSettings-6bdc9831.js'));
};
const ladder = () => { runDefault(import('./ladder-9296daad.js')); };
const marketplace = () => { runDefault(import('./marketplace-2016d9b6.js')); };
const points = () => { runDefault(import('./points-6fd32f93.js')); };
const superelite = () => { runDefault(import('./superelite-b402701c.js')); };
...
export { escapeHtml as $, setInnerHtml as A, getText as B, searchPlayerUrl as C, querySelector as D, querySelectorArray as E, playerLinkSelector as F, getTextTrim as G, getValue as H, defCharacterVirtualLevel as I, getElementsByClassName as J, defStatLevel as K, quickbuffUrl as L, arrayFrom as M, indexPhp as N, isArray as O, once as P, clickThis as Q, getUrlParameter as R, insertHtml as S, nowSecs as T, scouttowerUrl as U, setValue as V, sendEvent as W, jQueryDialog as X, injectNotepadShowLogs as Y, injectMonsterLog as Z, getCalfPrefs as _, add as a, defStatAttack as a$, theLinks as a0, playerIdUrl as a1, notepadBlankUrl as a2, fallback as a3, now as a4, defLastLadderReset as a5, server as a6, cmdUrl as a7, pointsUrl as a8, insertHtmlAfterBegin as a9, playerId as aA, showPlayerUrl as aB, infoBoxFrom as aC, retryAjax as aD, isFunction as aE, containsText as aF, guideUrl as aG, defFetchPlayerBuffs as aH, defPlayerBuffs as aI, defPlayerUpdate as aJ, defTeleport as aK, defPvE as aL, isUndefined as aM, defAfterUpdateActionlist as aN, defFetchWorldRealmDynamic as aO, defFetchWorldRealmActions as aP, hideQTip as aQ, worldUrl as aR, defRealmUpdate as aS, defPlayerLevel as aT, keys as aU, defenderMultiplier as aV, defRelicView as aW, doSendGold as aX, defPlayerGold as aY, initSendGoldOnWorld as aZ, sendGoldonWorld$1 as a_, querySelectorAll as aa, sendException as ab, parseError as ac, isObject as ad, defaults as ae, time as af, timeEnd as ag, loadCss as ah, defTr as ai, infoBox as aj, cdn as ak, profile as al, off as am, fromEntries as an, attribType as ao, itemType as ap, arenaUrl as aq, oldActionSpinner as ar, defTd as as, runDefault as at, composingUrl as au, defSubcmd as av, defNeedToCompose as aw, contains as ax, defLastComposeCheck as ay, months as az, createDiv as b, defJoinallgroupsundersize as b$, defStatDefense as b0, defStatArmor as b1, defStatDamage as b2, defStatHp as b3, defRefreshActionList as b4, defStairway as b5, defShopPrompt as b6, defViewCreature as b7, jsonParse as b8, defFetchPlayerBackpackCount as b9, draggable as bA, recallUserUrl as bB, defStatVl as bC, asyncPThree as bD, updateArchiveUrl as bE, archiveUrl as bF, composingFragmentType as bG, auctionSearchUrl as bH, getValueJSON as bI, setValueJSON as bJ, profileUrl as bK, pCR as bL, pCL as bM, secureUrl as bN, tradeUrl as bO, classHandler as bP, bountyUrl as bQ, parseTemplePage as bR, displayDisconnectedFromGodsMessage as bS, blacksmithUrl as bT, dropItemsUrl as bU, defStatbarLevel as bV, injectFsBoxContent as bW, joinallUrl as bX, joinUnderUrl as bY, newGuildLogLoc as bZ, newGuildLogUrl as b_, defControlsKeydown as ba, handleEvent as bb, places as bc, mercRE as bd, ahSearchUrl as be, getCustomUrlParameter as bf, attackplayerUrl as bg, doAddIgnore as bh, combatSelector as bi, chatSelector as bj, noteSelector as bk, fshBuffLog as bl, screenview as bm, news as bn, injectQuestBookFull as bo, inventing as bp, rarity as bq, isString as br, guildLogUrl as bs, GMSTORAGE_PATH as bt, guildViewUrl as bu, defCmd as bv, guildRE as bw, daViewProfile as bx, lastActivityRE as by, defEnableGuildActivityTracker as bz, calf as c, playerIDRE as c0, classPair as c1, injectGuild as c2, injectAuctionSearch as c3, injectOnlinePlayers as c4, injectFindOther as c5, injectFindBuffs as c6, injectRecipeManager as c7, injectBuffLog as c8, injectQuickLinkManager as c9, auctionhouseUrl as ca, insertQuickExtract as cb, insertQuickWear as cc, dispatch as cd, defTable as d, entries as e, insertHtmlBeforeEnd as f, getElementsByTagName as g, hasClass as h, insertElement as i, jQueryPresent as j, on as k, itemRE as l, getArrayByTagName as m, cElement as n, onclick as o, pCC as p, extend as q, indexAjax as r, partial as s, createDocument as t, indexAjaxData as u, guildSubcmdUrl as v, callApp as w, jQueryNotPresent as x, getElementById as y, setText as z };
//# sourceMappingURL=calfSystem-91adbec8.js.map
