...
const allowBack = () => { runDefault(import('./allowBack-e28e91a9.js')); };
const injectBioWidgets = () => { runDefault(import('./bioWidgets-ce188f5d.js')); };
const injectGuild = () => { runDefault(import('./guild-61dc589c.js')); };
const injectProfile = () => { runDefault(import('./profile-1a4373cf.js')); };
const injectProfileDropItems = () => { runDefault(import('./injectProfileDropItems-3117fded.js')); };
const injectQuestBookFull = () => { runDefault(import('./injectQuestBookFull-5020a0fd.js')); };
const injectStoreItems = () => { runDefault(import('./injectStoreItems-640543cc.js')); };
const inventing = () => { runDefault(import('./inventing-3cba3769.js')); };
const viewArchive = () => { runDefault(import('./viewArchive-f0ee81b6.js')); };

const injectBuffLog = (i) => { import('./injectBuffLog-b85ad550.js').then((m) => m.default(i)); };
const injectFsBoxContent = (i) => { import('./injectFsBoxContent-1ddcaff8.js').then((m) => m.default(i)); };
const injectMonsterLog = (i) => { import('./monstorLog-9423745e.js').then((m) => m.default(i)); };
const injectNotepadShowLogs = (i) => { import('./combatLog-9a73dc78.js').then((m) => m.default(i)); };
const injectOnlinePlayers = (i) => { import('./injectOnlinePlayers-f7c47151.js').then((m) => m.default(i)); };
const injectRecipeManager = (i) => { import('./recipeMgr-2aa21698.js').then((m) => m.default(i)); };
const insertQuickExtract = (i) => { import('./quickExtract-70495d3e.js').then((m) => m.default(i)); };
const insertQuickWear = (i) => { import('./quickWear-bf34a7e2.js').then((m) => m.default(i)); };

const injectAuctionSearch = (i) => { import('./lists-2d1cc744.js').then((m) => m.injectAuctionSearch(i)); };
const injectQuickLinkManager = (i) => { import('./lists-2d1cc744.js').then((m) => m.injectQuickLinkManager(i)); };
const injectFindBuffs = (i) => { import('./findBuffs-7cb1faca.js').then((m) => m.injectFindBuffs(i)); };
const injectFindOther = (i) => { import('./findBuffs-7cb1faca.js').then((m) => m.injectFindOther(i)); };
...
const injectArena = () => { runDefault(import('./arena-41d48396.js').then(function (n) { return n.a; })); };
const arenaDoJoin = () => { runDefault(import('./arenaDoJoin-51df4cc5.js')); };
const arenaJoin = () => {
  runDefault(import('./arenaJoin-853dee8c.js'));
};
const completedArenas = () => {
  runDefault(import('./completedArenas-11c7ef48.js'));
};
const setupMoves = () => {
  runDefault(import('./setup-5e16f870.js'));
};
const storeMoves = () => { runDefault(import('./store-4d46f3ac.js')); };
const results = () => { runDefault(import('./results-c8cc6144.js')); };
...
const injectAuctionHouse = () => {
  runDefault(import('./injectAuctionHouse-888625bb.js'));
};
const quickCreate = () => {
  runDefault(import('./quickCreate-2b155c35.js'));
};
...
const composingBreakdown = () => { runDefault(import('./breakdown-8317369c.js')); };
const composingCreate = () => { runDefault(import('./composingCreate-53d33bcf.js')); };
const injectComposing = () => { runDefault(import('./composing-3784e97c.js')); };
...
const injectAdvisor = () => {
  runDefault(import('./guildAdvisor-eb69d805.js'));
};
...
const injectGroups = () => {
  runDefault(import('./groups-a1a3bb7f.js'));
};
const injectGroupStats = () => {
  runDefault(import('./injectGroupStats-370ad60f.js'));
};
...
const guildHall = () => { runDefault(import('./hall-8b96fe15.js')); };
...
const injectGuildAddTagsWidgets = () => {
  runDefault(import('./injectGuildAddTagsWidgets-e9f5acff.js'));
};
const injectReportPaint = () => {
  runDefault(import('./guildReport-854d4d31.js'));
};
...
const guildChat = () => { runDefault(import('./guildChat-2643b99b.js')); };
const guildLog = () => { runDefault(import('./guildLog-6c792b8d.js')); };
const guildMailbox = () => {
  runDefault(import('./guildMailbox-dc6442d5.js'));
};
const injectGuildBank = () => {
  runDefault(import('./injectGuildBank-50936dd9.js'));
};
const injectGuildRanks = () => {
  runDefault(import('./rank-409e2150.js'));
};
const injectRPUpgrades = () => {
  runDefault(import('./injectRPUpgrades-91c80e6b.js'));
};
const injectScouttower = () => {
  runDefault(import('./injectScouttower-6a1a8fa1.js'));
};
...
const itemsView = () => { runDefault(import('./itemsView-b56bfdac.js')); };
...
const playerLog = () => { runDefault(import('./playerLog-58a0e0b7.js')); };
const outbox = () => { runDefault(import('./outbox-ac5bfcfc.js')); };
...
const newsFsbox = () => { runDefault(import('./newsFsbox-65c3618e.js')); };
const newsShoutbox = () => { runDefault(import('./newsShoutbox-9a477604.js')); };
...
const unknownPage = () => { runDefault(import('./unknownPage-b596315d.js')); };
...
const injectInventoryManagerNew = () => {
  runDefault(import('./inventory-f0d7415d.js'));
};
const injectNewGuildLog = () => {
  runDefault(import('./newGuildLog-f8f69803.js'));
};
const injectNotepad = () => {
  runDefault(import('./injectNotepad-bccafca8.js'));
};
const injectSaveSettings = () => { runDefault(import('./load-55cb22bb.js')); };
const reliclist = () => {
  runDefault(import('./reliclist-b27d7902.js'));
};
const advisor$1 = () => { runDefault(import('./advisor-a1b4ae34.js')); };
const crawler = () => {
  runDefault(import('./crawler-f2164086.js'));
};
const newGuildLog5 = () => {
  runDefault(import('./newGuildLog5-ee45d0d0.js'));
};
const whosGotWhat = () => {
  runDefault(import('./whosGotWhat-87594a81.js'));
};
...
const injectQuestTracker = () => {
  runDefault(import('./injectQuestTracker-c1bfe709.js'));
};
...
const showAllQuestSteps = () => {
  runDefault(import('./showAllQuestSteps-9a230577.js'));
};
...
const injectScavenging = () => {
  runDefault(import('./scavenging-74ad0e42.js'));
};
...
const globalQuest = () => { runDefault(import('./globalQuest-12c3675a.js')); };
const injectTopRated = () => { runDefault(import('./toprated-79a92ba0.js')); };
...
const injectTrade = () => { runDefault(import('./trade-d4ac4e5b.js')); };
...
const craftForge = () => { runDefault(import('./craftForge-4f4f75b1.js')); };
const injectBank = () => { runDefault(import('./injectBank-b7fa5bbd.js')); };
const injectBazaar = () => { runDefault(import('./bazaar-4dfe353d.js')); };
const injectFindPlayer = () => {
  runDefault(import('./injectFindPlayer-f442a5b1.js'));
};
const injectMailbox = () => { runDefault(import('./mailbox-42df4f56.js')); };
const injectQuickBuff = () => {
  runDefault(import('./quickBuff-6796c680.js'));
};
const injectTitan = () => { runDefault(import('./injectTitan-4419d0b0.js')); };
const injectSettings = () => {
  runDefault(import('./injectSettings-8783c8d7.js'));
};
const injectWorld = () => { runDefault(import('./injectWorld-8d0f4dcd.js')); };
const ladder = () => { runDefault(import('./ladder-e33b79ce.js')); };
const marketplace = () => { runDefault(import('./marketplace-1f5b1554.js')); };
const points = () => { runDefault(import('./points-c25cbf2b.js')); };
const superelite$1 = () => { runDefault(import('./superelite-9fb3d08a.js')); };
...
//# sourceMappingURL=calfSystem-43606e5e.js.map
