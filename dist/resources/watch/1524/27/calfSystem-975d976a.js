...
const injectBioWidgets = () => { runDefault(import('./bioWidgets-457ab033.js')); };
const injectGuild = () => { runDefault(import('./guild-05a5d309.js')); };
const injectProfile = () => { runDefault(import('./profile-bdb5ca79.js').then(function (n) { return n.p; })); };
const injectProfileDropItems = () => { runDefault(import('./injectProfileDropItems-741ff261.js')); };
const injectQuestBookFull = () => { runDefault(import('./injectQuestBookFull-a36638fa.js')); };
const inventing = () => { runDefault(import('./inventing-7624dba0.js')); };
const news = () => { runDefault(import('./news-234ee36e.js')); };
const ufsgAllowBack = () => { runDefault(import('./ufsgAllowBack-c54e024c.js')); };
const viewArchive = () => { runDefault(import('./viewArchive-b99dbda9.js')); };

const injectBuffLog = (i) => { import('./injectBuffLog-03aaebfe.js').then((m) => m.default(i)); };
const injectFsBoxContent = (i) => { import('./injectFsBoxContent-2c5c475c.js').then((m) => m.default(i)); };
const injectMonsterLog = (i) => { import('./monstorLog-13d1b0df.js').then((m) => m.default(i)); };
const injectNotepadShowLogs = (i) => { import('./combatLog-d5b2d6fd.js').then((m) => m.default(i)); };
const injectOnlinePlayers = (i) => { import('./injectOnlinePlayers-3aa2a92a.js').then((m) => m.default(i)); };
const injectRecipeManager = (i) => { import('./recipeMgr-b9290fd3.js').then((m) => m.default(i)); };
const insertQuickExtract = (i) => { import('./quickExtract-35532cad.js').then((m) => m.default(i)); };
const insertQuickWear = (i) => { import('./quickWear-de5637e3.js').then((m) => m.default(i)); };

const injectAuctionSearch = (i) => { import('./lists-5987f89d.js').then((m) => m.injectAuctionSearch(i)); };
const injectQuickLinkManager = (i) => { import('./lists-5987f89d.js').then((m) => m.injectQuickLinkManager(i)); };
const injectFindBuffs = (i) => { import('./findBuffs-bed7924e.js').then((m) => m.injectFindBuffs(i)); };
const injectFindOther = (i) => { import('./findBuffs-bed7924e.js').then((m) => m.injectFindOther(i)); };
...
function getLinkConfig(theNav, myNav) {
  ...
  if (linkConfig.some(([, b]) => b)) {
    import('./injectItems-84ce2cd2.js')
...
function moveUp(title) {
  import('./moveRHSBoxUpOnRHS-0d84fee1.js').then((m) => m.default(title));
}

function moveLeft(title) {
  import('./moveRHSBoxToLHS-fd2fa2f1.js').then((m) => m.default(title));
}
...
function callAllyEnemy() {
  if (calf.enableAllyOnlineList
    ...
    runDefault(import('./allyEnemy-eecf63f7.js'));
  }
}
...
function callBounties() {
  if (calf.enableWantedList
    ...
    runDefault(import('./activeWantedBounties-80d3ed78.js'));
  }
}

function callGuildInfo() {
  if (calf.enableGuildInfoWidgets) {
    runDefault(import('./addGuildInfoWidgets-b4dcab08.js'));
  }
}

function callAllies() {
  if (calf.enableOnlineAlliesWidgets) {
    runDefault(import('./addOnlineAlliesWidgets-63bd2af7.js'));
  }
}

function callTemple() {
  if (calf.enableTempleAlert) {
    runDefault(import('./injectTempleAlert-35718252.js'));
  }
}

function callUpgrade() {
  if (calf.enableUpgradeAlert) {
    runDefault(import('./injectUpgradeAlert-c2e5f2f6.js'));
  }
}

function callComposing() {
  if (calf.enableComposingAlert) {
    runDefault(import('./injectComposeAlert-bd9e40d2.js'));
  }
}

function statbar() {
  if (getValue('statBarLinks')) {
    runDefault(import('./statBar-dfbf149d.js'));
  }
}

function staminaCalc() {
  if (getValue('staminaCalculator')) {
    runDefault(import('./injectStaminaCalculator-53fae7f2.js'));
  }
}

function levelCalc() {
  if (getValue('levelUpCalculator')) {
    runDefault(import('./injectLevelupCalculator-20168309.js'));
  }
}

function fsBoxLog() {
  if (getValue('fsboxlog')) {
    runDefault(import('./injectFSBoxLog-79f1e064.js'));
  }
}

function expandQb() {
  if (getValue('resizeQuickBuff')) {
    runDefault(import('./interceptQuickBuff-ceaaa0dc.js'));
  }
}

function joinAll() {
  if (getValue('joinAllLink')) {
    runDefault(import('./injectJoinAllLink-2a146982.js'));
  }
}

function guildLogHref() {
  if (getValue('useNewGuildLog')) {
    runDefault(import('./changeGuildLogHREF-dbbeba7b.js'));
  }
}

function gameStats() {
  if (getValue('addServerNode')) {
    runDefault(import('./injectServerNode-f4b89154.js'));
  }
}

function scoutTower() {
  if (getValue('addScoutTowerLink')) {
    runDefault(import('./scoutTowerLink-5fdf2de7.js'));
  }
}

function guildActivityTracker() {
  if (jQueryPresent() && getValue(defEnableGuildActivityTracker)) {
    runDefault(import('./guildActivity-ee408255.js'));
  }
}

function seTracker() {
  if (jQueryPresent() && calf.enableSeTracker && calf.cmd !== 'superelite') {
    import('./seLog-574f5d02.js').then((m) => m.seLog());
  }
}
...
const injectArena = () => { runDefault(import('./arena-6a908b3b.js').then(function (n) { return n.a; })); };
const arenaDoJoin = () => { runDefault(import('./arenaDoJoin-6b75c616.js')); };
const arenaJoin = () => {
  runDefault(import('./arenaJoin-58f22190.js'));
};
const completedArenas = () => {
  runDefault(import('./completedArenas-ff425892.js'));
};
const setupMoves = () => {
  runDefault(import('./setup-a6e5a3ce.js'));
};
const storeMoves = () => { runDefault(import('./store-7f2b77a3.js')); };
const results = () => { runDefault(import('./results-e2a1e828.js')); };
...
const injectAuctionHouse = () => {
  runDefault(import('./injectAuctionHouse-88c2bd2b.js'));
};
const quickCreate = () => {
  runDefault(import('./quickCreate-9a0fc857.js'));
};
...
const composingBreakdown = () => { runDefault(import('./breakdown-7d06db59.js')); };
const composingCreate = () => { runDefault(import('./composingCreate-ca2839c2.js')); };
const injectComposing = () => { runDefault(import('./composing-ce6f3085.js')); };
...
const injectAdvisor = () => {
  runDefault(import('./guildAdvisor-20474e87.js'));
};
...
const injectGroups = () => {
  runDefault(import('./groups-83e95d77.js'));
};
const injectGroupStats = () => {
  runDefault(import('./injectGroupStats-4c9b3cdc.js'));
};
...
const guildHall = () => { runDefault(import('./hall-e31f9d82.js')); };
...
const injectReportPaint = () => {
  runDefault(import('./guildReport-3188991d.js'));
};
const injectGuildAddTagsWidgets = () => {
  runDefault(import('./injectGuildAddTagsWidgets-10d1a697.js'));
};
const storeitems = () => {
  runDefault(import('./storeitems-5f550962.js'));
};
...
const guildChat = () => { runDefault(import('./guildChat-3ba7e153.js')); };
const guildLog = () => { runDefault(import('./guildLog-f3194261.js')); };
const guildMailbox = () => {
  runDefault(import('./guildMailbox-b102df4a.js'));
};
const injectGuildBank = () => {
  runDefault(import('./injectGuildBank-d7fe5ed3.js'));
};
const injectGuildRanks = () => {
  runDefault(import('./rank-cdaed730.js'));
};
const injectRPUpgrades = () => {
  runDefault(import('./injectRPUpgrades-684365cb.js'));
};
const injectScouttower = () => {
  runDefault(import('./injectScouttower-0094bdb9.js'));
};
...
function injectWorld() {
  if (isNewMap()) {
    runDefault(import('./newMap-82e93907.js'));
  }
}

const itemsView = () => { runDefault(import('./itemsView-e0956a73.js')); };
...
const playerLog = () => { runDefault(import('./playerLog-4e824f11.js')); };
const outbox = () => { runDefault(import('./outbox-6be382e6.js')); };
...
const newsFsbox = () => { runDefault(import('./newsFsbox-613a541d.js')); };
const newsShoutbox = () => { runDefault(import('./newsShoutbox-d88a1342.js')); };
...
const unknownPage = () => { runDefault(import('./unknownPage-f68680ae.js')); };
...
const injectInventoryManagerNew = () => {
  runDefault(import('./inventory-f6867cc1.js'));
};
const injectNewGuildLog = () => {
  runDefault(import('./newGuildLog-689d022b.js'));
};
const injectNotepad = () => {
  runDefault(import('./injectNotepad-3c021764.js'));
};
const injectSaveSettings = () => { runDefault(import('./load-a66dc5b7.js')); };
const reliclist = () => {
  runDefault(import('./reliclist-74545cf9.js'));
};
const advisor$1 = () => { runDefault(import('./advisor-f630852e.js')); };
const crawler = () => {
  runDefault(import('./crawler-9a6c6dc4.js'));
};
const newGuildLog5 = () => {
  runDefault(import('./newGuildLog5-0d3bd99f.js'));
};
const whosGotWhat = () => {
  runDefault(import('./whosGotWhat-7469deb0.js'));
};
...
const injectQuestTracker = () => {
  runDefault(import('./injectQuestTracker-994da7cc.js'));
};
...
const showAllQuestSteps = () => {
  runDefault(import('./showAllQuestSteps-2266f3b0.js'));
};
...
const injectScavenging = () => {
  runDefault(import('./scavenging-27a08bc2.js'));
};
...
const globalQuest = () => { runDefault(import('./globalQuest-3e12efe5.js')); };
const injectTopRated = () => { runDefault(import('./toprated-b735e9a7.js')); };
...
const injectTrade = () => { runDefault(import('./trade-0907826c.js')); };
...
const craftForge = () => { runDefault(import('./craftForge-1f4ef1bc.js')); };
const injectBank = () => { runDefault(import('./injectBank-81fa9139.js')); };
const injectBazaar = () => { runDefault(import('./bazaar-8683a51f.js')); };
const injectFindPlayer = () => {
  runDefault(import('./injectFindPlayer-f9f4f020.js'));
};
const injectMailbox = () => { runDefault(import('./mailbox-cb8401fe.js')); };
const injectQuickBuff = () => {
  runDefault(import('./quickBuff-bf775767.js'));
};
const injectTitan = () => { runDefault(import('./injectTitan-290723c2.js')); };
const injectSettings = () => {
  runDefault(import('./injectSettings-08c00446.js'));
};
const ladder = () => { runDefault(import('./ladder-d5a35f11.js')); };
const marketplace = () => { runDefault(import('./marketplace-8e48f9c5.js')); };
const points = () => { runDefault(import('./points-364d2af6.js')); };
const superelite = () => { runDefault(import('./superelite-97eb4f16.js')); };
...
export { getCalfPrefs as $, setInnerHtml as A, getText as B, searchPlayerUrl as C, querySelector as D, querySelectorArray as E, playerLinkSelector as F, getValue as G, defCharacterVirtualLevel as H, getElementsByClassName as I, defStatLevel as J, getTextTrim as K, quickbuffUrl as L, arrayFrom as M, indexPhp as N, isArray as O, once as P, clickThis as Q, getUrlParameter as R, executeAll as S, insertHtml as T, nowSecs as U, scouttowerUrl as V, setValue as W, sendEvent as X, jQueryDialog as Y, injectNotepadShowLogs as Z, injectMonsterLog as _, add as a, infoBox as a$, escapeHtml as a0, theLinks as a1, playerIdUrl as a2, notepadBlankUrl as a3, fallback as a4, contains as a5, insertHtmlAfterBegin as a6, now as a7, defLastLadderReset as a8, server as a9, initSendGoldOnWorld as aA, sendGoldonWorld$1 as aB, retryAjax as aC, defStatAttack as aD, defStatDefense as aE, defStatArmor as aF, defStatDamage as aG, defStatHp as aH, cdn as aI, months as aJ, defRefreshActionList as aK, defStairway as aL, defShopPrompt as aM, defViewCreature as aN, jsonParse as aO, defFetchPlayerBackpackCount as aP, defControlsKeydown as aQ, places as aR, mercRE as aS, handleEvent as aT, fromEntries as aU, isObject as aV, defaults as aW, time as aX, timeEnd as aY, loadCss as aZ, defTr as a_, cmdUrl as aa, pointsUrl as ab, querySelectorAll as ac, sendException as ad, parseError as ae, defFetchPlayerBuffs as af, defPlayerBuffs as ag, defPlayerUpdate as ah, defTeleport as ai, defPvE as aj, isUndefined as ak, isFunction as al, defAfterUpdateActionlist as am, defFetchWorldRealmDynamic as an, defFetchWorldRealmActions as ao, hideQTip as ap, worldUrl as aq, defSubcmd as ar, guideUrl as as, defRealmUpdate as at, defPlayerLevel as au, keys as av, defenderMultiplier as aw, defRelicView as ax, doSendGold as ay, defPlayerGold as az, createDiv as b, defStatbarLevel as b$, profile as b0, off as b1, attribType as b2, itemType as b3, arenaUrl as b4, oldActionSpinner as b5, defTd as b6, playerId as b7, showPlayerUrl as b8, infoBoxFrom as b9, composingFragmentType as bA, auctionSearchUrl as bB, getValueJSON as bC, setValueJSON as bD, profileUrl as bE, defCmd as bF, composingUrl as bG, defNeedToCompose as bH, defLastComposeCheck as bI, screenview as bJ, news as bK, injectQuestBookFull as bL, inventing as bM, classHandler as bN, playerIDRE as bO, classPair as bP, injectGuild as bQ, defJoinallgroupsundersize as bR, pCR as bS, pCL as bT, secureUrl as bU, tradeUrl as bV, bountyUrl as bW, parseTemplePage as bX, displayDisconnectedFromGodsMessage as bY, blacksmithUrl as bZ, dropItemsUrl as b_, containsText as ba, getCustomUrlParameter as bb, attackplayerUrl as bc, doAddIgnore as bd, combatSelector as be, chatSelector as bf, noteSelector as bg, ahSearchUrl as bh, rarity as bi, isString as bj, guildLogUrl as bk, GMSTORAGE_PATH as bl, guildRE as bm, enhancementType as bn, guildViewUrl as bo, daViewProfile as bp, lastActivityRE as bq, defEnableGuildActivityTracker as br, draggable as bs, recallUserUrl as bt, defStatVl as bu, runDefault as bv, asyncPThree as bw, updateArchiveUrl as bx, archiveUrl as by, fshBuffLog as bz, calf as c, injectFsBoxContent as c0, joinallUrl as c1, joinUnderUrl as c2, newGuildLogLoc as c3, newGuildLogUrl as c4, injectAuctionSearch as c5, injectOnlinePlayers as c6, injectFindOther as c7, injectFindBuffs as c8, injectRecipeManager as c9, injectBuffLog as ca, injectQuickLinkManager as cb, auctionhouseUrl as cc, insertQuickExtract as cd, insertQuickWear as ce, dispatch as cf, defTable as d, entries as e, insertHtmlBeforeEnd as f, getElementsByTagName as g, hasClass as h, insertElement as i, jQueryPresent as j, on as k, itemRE as l, getArrayByTagName as m, cElement as n, onclick as o, pCC as p, extend as q, indexAjax as r, partial as s, createDocument as t, indexAjaxData as u, guildSubcmdUrl as v, callApp as w, jQueryNotPresent as x, getElementById as y, setText as z };
//# sourceMappingURL=calfSystem-975d976a.js.map
