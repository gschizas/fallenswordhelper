import{w as t,x as n,g as e,p as i,O as s,t as c,k as a,m as o,h as r,o as f,e as u,l as m,A as d,y as l}from"./calfSystem-89b939c8.js"
import{i as p}from"./isArray-75e85160.js"
import{c as h}from"./createInput-efc68c10.js"
import{c as k}from"./createLabel-e0d7a850.js"
import{i as g}from"./insertElementBefore-08d48547.js"
import{c as b}from"./createUl-f8d9693f.js"
import{c as v}from"./chunk-cc2730f2.js"
import{j as T,o as j}from"./jsonFail-6c5ec74f.js"
...
return g(i,e),i}function E(t,n){const e=n.children[0],{tipped:i}=e.dataset,s=a.exec(i)
if(!s)return t
const c=s[1],o=s[2]
...
!function(t,n){u(n).forEach(c(I,t))}(i,t),r(n,i),f(i,c(B,t,e))}function A(t){const n=o({id:"quickTake",innerHTML:'<div class="fshCenter"><br><font size="3"><b>Quick Take</b></font><br><br>Select which item to take all similar items from your Mailbox.</div><div></div>'}),e=function(t){const n=o(),e=b()
...
g(e,n),s(e,"change",c(C,t,n))}(t,a),y("qtOff","Quick Take",a)}
//# sourceMappingURL=mailbox-912cd117.js.map
