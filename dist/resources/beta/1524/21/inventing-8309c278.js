import{n,w as t,p as e,h as i,o as s,C as o,A as r,D as c,ap as a,ao as u,j as f}from"./calfSystem-89b939c8.js"
import{c as m}from"./createInput-efc68c10.js"
import{i as l}from"./insertTextBeforeEnd-e624bdeb.js"
import{i as p}from"./insertElementBefore-08d48547.js"
import{c as v}from"./createSpan-716fba1d.js"
import{j as d,o as h}from"./jsonFail-6c5ec74f.js"
import{c as b}from"./createAnchor-7c7744ca.js"
import{x as j}from"./xPath-e4727349.js"
...
i(n,t),s(t,$)}(x(n)),S(x(n))}function k(n){return`${a}items${u}view&item_id=${n}`}function A(n,t){const e=function(n){if(!n)return
...
A(o("#pCC b"),n)}(),c('#pCC img[src*="/items/"]').forEach(B)}export default function(){f()&&(R(),_(e.lastElementChild))}
//# sourceMappingURL=inventing-8309c278.js.map
