import{c as t,bh as n,U as e,l as o,B as s,M as r,D as i,Y as c,a,t as u,bf as l,ap as f,ao as d,be as m,x as p,G as h,o as k,p as g}from"./calfSystem-89b939c8.js"
import{b}from"./batch-e839e453.js"
import{d as $}from"./doStatTotal-a01a19ff.js"
import{c as w}from"./closestTr-e9bb4ace.js"
import{d as L}from"./daAjaxSendItemsToRecipient-b1414fc9.js"
import{e as x}from"./errorDialog-28ee21dd.js"
import{g as y}from"./getInventoryById-a70f1bcf.js"
let E,S,_
function v(){if(!S){const n="dropitems"===t.subcmd?"removeIndex[]":"storeIndex[]"
E=document.forms[0].elements[n],S=!0}return E}function D(){}function Q(t){return t()}function A(){return Object.create(null)}function j(t){t.forEach(Q)}function C(t){return"function"==typeof t}function T(t,n){return t!=t?n==n:t!==n||t&&"object"==typeof t||"function"==typeof t}function N(t,n){t.appendChild(n)}function I(t,n,e){t.insertBefore(n,e||null)}function O(t){t.parentNode.removeChild(t)}function B(t,n){for(let e=0;e<t.length;e+=1)t[e]&&t[e].d(n)}function H(t){return document.createElement(t)}function U(t){return document.createTextNode(t)}function R(){return U(" ")}function G(t,n,e,o){return t.addEventListener(n,e,o),()=>t.removeEventListener(n,e,o)}function F(t,n,e){null==e?t.removeAttribute(n):t.getAttribute(n)!==e&&t.setAttribute(n,e)}function M(t,n){n=""+n,t.data!==n&&(t.data=n)}function q(t,n){for(let e=0;e<t.options.length;e+=1){const o=t.options[e]
...
if(!v())return
const t=$t.map(t=>h(t))
$(),vt(t),t.some(t=>t)&&_t(t),k(g,ht)}export{at as S,I as a,N as b,M as c,O as d,H as e,R as f,F as g,q as h,ct as i,B as j,z as k,G as l,tt as m,D as n,P as o,v as p,ut as q,j as r,T as s,U as t,Dt as u,ft as v}
//# sourceMappingURL=injectStoreItems-d4cac765.js.map
