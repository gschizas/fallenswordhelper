import{f as n,i as t,n as e,aK as s,aG as o,o as a,bq as r,aq as c,C as l,y as i,ag as f,b as u,p as d,d as h,ai as m,u as b,br as p,bl as T,bs as g,at as w,B as C}from"./calfSystem-371c414c.js"
import"./numberIsNaN-987e3021.js"
import{a as $}from"./roundToString-a82a9cde.js"
import{d as N}from"./dataRows-e367647c.js"
import{c as j}from"./createTBody-51b8edc4.js"
import{c as S}from"./createTable-ad174066.js"
import{g as x,a as B}from"./getTitanString-448cd691.js"
function E(n){return[n[0],n[1].cooldownText,n[1].coolTime,n[1].seen]}function _(n){return n[2]>s}function y(n,t){return n[2]-t[2]}function k(n){return`<tr><td class="fshCenter">${n[0]}</td><td class="fshBold fshCenter fshCooldown">${n[1]}</td><td class="fshCenter">${n[3]}</td></tr>`}function v(s){const o=S({className:"fshTTracker"}),a=j({innerHTML:'<tr><td class="header fshCenter">Titan</td><td class="header fshCenter">Cooldown</td><td class="header fshCenter">Visible</td></tr>'})
...
H(s)
const o={}
!function(n,t){N(n.rows,4,0).forEach(b(U,t))}(s[1],o),function(n,t){n&&e(n).forEach(b(M,t))}(t,o),function(t,e){if(t.rows.length>5){const s=v(e),o=t.insertRow(5).insertCell(-1)
o.colSpan=3,n(o,s)}}(s[0],o),m("fsh_titans",o)}export default function(){i()||f("fsh_titans").then(V)}
//# sourceMappingURL=injectScouttower-0e36a31c.js.map
