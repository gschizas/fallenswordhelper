import{u as e,B as t,C as n,bC as s,H as r,S as a,Y as i,y as o,q as c,G as l,c as u,m as d,bO as b,bE as f,A as p,bR as h,h as m,i as y,v as L,x as g,o as v}from"./calfSystem-019a589c.js"
import"./insertElementBefore-2ad05963.js"
import{i as $}from"./insertElementAfterBegin-712445fc.js"
import{c as w}from"./createSpan-2b647177.js"
...
B.bounty.push(n)}}(e)}function M(){return B&&a-B.lastUpdate>S||T&&a-T.lastUpdate>S}function P(e){const t=e[6]
...
function _(e,t){B=s("bountyList"),T=s("wantedList"),S=r("bountyListRefreshTime"),C=r("bwNeedsRefresh"),C||M()&&(C=!0),Z.some(N)?(T={},T.bounty=[],T.isRefreshed=!0,T.lastUpdate=a,j=!1,W=x("wantedNames"),i("bwNeedsRefresh",!1),R(1).then(V)):function(e,t){t&&(T.isRefreshed=!1,I()),e&&(B.isRefreshed=!1,F())}(e,t)}function ee(e){e.target===X&&(f("bountyList",null),_(u.enableActiveBountyList,u.enableWantedList)),e.target===K&&(f("wantedList",null),_(u.enableActiveBountyList,u.enableWantedList))}function te(){g()||(u.enableWantedList&&(q=D(),$(b,q)),u.enableActiveBountyList&&(G=D(),$(b,G)),G&&v(G,ee),q&&v(q,ee),_(u.enableActiveBountyList,u.enableWantedList))}export default te
//# sourceMappingURL=activeWantedBounties-fb897957.js.map
