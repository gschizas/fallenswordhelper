import{r as e,A as t,t as n,aD as s,a9 as o,Y as a,bE as i,C as c,m as r,O as l,U as m,i as p,b0 as u,D as d,h as f,o as g,p as b,z as h,c as v,bF as C,B as S,a4 as E,j,H as k,y as N,J as x}from"./calfSystem-964f4fc9.js"
import{c as y}from"./createInput-cbbea5aa.js"
import{i as A}from"./insertElementBefore-eada6f05.js"
import{c as B}from"./createTable-30815142.js"
import{p as L,a as q}from"./pubsub-b3a7d9ad.js"
import{g as F}from"./getArrayByClassName-022b52a0.js"
import{i as I}from"./insertHtmlAfterEnd-17c23200.js"
import{i as $}from"./insertElementAfter-33e5bbda.js"
...
return 0===s&&h(e[1],t.insertCell(-1)),f(t.insertCell(-1),(o=(s+1).toString(),a=e[0],y({className:"awesome orange",dataset:{templateId:a},type:"button",value:o}))),t}function R(e,t,s,o){return e.reduce(n(O,o),s.insertRow(-1)),s}function U(e){return[e.value,e.text]}function Y(e,t,s){const o=function(e,t,s){const o=B({id:"fshFastCompose"})
return z(o,s),e.reduce(n(R,t,s),o)}(d("#composing-template-multi option").map(U),t,s)
f(e,o),g(b,M),q("quickcreate",n(J,o))}function G(e){m("composing","FastCompose"),p(e,"<br>")
...
//# sourceMappingURL=composing-ad554d80.js.map
