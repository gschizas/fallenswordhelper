import{u as t,t as e,bf as s,bg as i,x as n,A as o,p as a,o as c,g as d,z as r,y as h,H as l,v as f,C as u,B as p,J as m,i as g,G as b}from"./calfSystem-964f4fc9.js"
...
import{g as k,s as y}from"./idb-be8b4ca8.js"
import{c as w}from"./createTable-30815142.js"
import{h as j}from"./hideElement-c14a94c9.js"
import{p as L}from"./parseDateAsTimestamp-ea0c4118.js"
import{t as R}from"./toggleForce-10d35470.js"
import{a as N}from"./all-7e2b4bf6.js"
import{e as G}from"./eventHandler5-831e4d3a.js"
import{s as v}from"./selfIdIs-1fbbac57.js"
import{f as x}from"./functionPasses-fa3457f1.js"
import"./doBuffLinkClick-3a4eb704.js"
import{a as H}from"./addLogColoring-f25ca54e.js"
import"./searchPlayerHref-ebb19b78.js"
import{a as T}from"./addGuildLogWidgets-7b8afc02.js"
...
s.className="divider",s.colSpan=3}(t)}function nt(t){t.checked=J.checks[t.getAttribute("item")]}function ot(){d("input",D).forEach(nt),Z()}function at(t,e){return t[0]-e[0]}function ct(){V&&Q.sort(at),r("Loading complete.",M),J.log=Q.filter(e(tt,(new Date).setSeconds(0,0))).map(et),Z(),function(){q=w({id:"fshInjectHere",className:"width_full"}),g(q,'<tbody><tr><td class="header" width="16">&nbsp;</td><td class="header" width="20%">Date</td><td class="header" width="80%">Message</td></tr></tbody>'),Q.forEach(it)
const t=h("fshInjectHere")
a.replaceChild(q,t),H("myGuildLog",1),T()}()}function dt(t){K(t),function(){const t=[]
if(V)for(let e=2;e<=$;e+=1)t.push(P(e).then(K))
else J.log.forEach(X)
return N(t)}().then(ct)}function rt(t,e,s){s[4]===t&&(R(s[5],e),R(s[6],e))}function ht(t){const s=Number(t.getAttribute("item"))
J.checks[s]=!J.checks[s],Z(),Q.forEach(e(rt,s,!J.checks[s]))}function lt(t){t&&t.classList&&t.classList.remove("fshHide")}function ft(t){lt(t[5]),lt(t[6])}function ut(){J.checks=O.slice(0),ot(),Q.forEach(ft)}function pt(t){j(t[5]),j(t[6])}function mt(){J.checks=B.slice(0),ot(),Q.forEach(pt)}function gt(){J.log=!1,Z(),r("Loading Page 1 ...",M),Q=[],V=!0,o("",h("fshInjectHere")),P(1).then(dt)}function bt(t){!function(t){J=t||J,J.checks=J.checks||O.slice(0)}(t),o(E,a),D=h("fshNewGuildLog"),M=h("fshOutput"),c(D,G([[t=>"INPUT"===t.tagName,ht],[v("fshAll"),ut],[v("fshNone"),mt],[v("rfsh"),gt]])),ot(),F=Number(l("newGuildLogHistoryPages")),$=F,P(1).then(dt)}function kt(){n()||k("fsh_guildLog").then(bt)}export default kt
//# sourceMappingURL=newGuildLog-8e5e0261.js.map
