import{M as o,t as n,o as t,a2 as e,y as c,f as r,Y as a,ah as f}from"./calfSystem-964f4fc9.js"
...
u[c]=e(u[c],{})
const r=u[c]
r.rows=r.rows||[],N(n,t,r,o)}function L(o){o.header.classList.toggle("fshPoint")}function b(o){h=!h,a(o,h),h?l():u.forEach(x),u.forEach(L)}function y(e){d=e.headInd,function(o){const t=c(o)
h=t.checked,r(c(o),"change",n(b,o))}(e.prefName),o(e.theTable.rows).forEach(n(j,e)),t(e.theTable,T)}export{y as c}
//# sourceMappingURL=collapse-dbebd3ad.js.map
