import{aq as n,t as e,H as t,bi as a,a4 as s,a2 as l,Y as i,aT as r,x as o,o as f,f as c,v as u}from"./calfSystem-964f4fc9.js"
import{n as h}from"./numberIsNaN-91041dcf.js"
import{c as d}from"./currentGuildId-26c6bca8.js"
import{i as p}from"./intValue-f4d85578.js"
import"./valueText-9fa15adc.js"
import{a as v,g as m}from"./levelHighlight-1826a720.js"
import{g,s as y}from"./idb-be8b4ca8.js"
import{l as M,p as L}from"./lvlTests-761b273d.js"
import"./all-7e2b4bf6.js"
import{l as b}from"./loadDataTables-85b3dcec.js"
import{o as x}from"./onlinePlayersPage-cc75751c.js"
...
for(let e=2;e<=z;e+=1)x(e).then(n)}function V(n){$("#fshOutput",_).append(n)}function W(n){V(" "+(H+1))
const t=u(n),a=$("#pCC input.custominput",t).first()
!function(n,t){const a=t.attr("value")
$('#pCC img[src$="/world/icon_action_view.png',n).parent().parent().parent().each(e(S,a))}(t,a),H+=1,1===H&&A(W,a),H===z&&(y("fsh_onlinePlayers",D),G(D))}function Y(n){"fshRefresh"===n.target.id&&($("#fshRefresh",_).hide(),H=0,D={},x(1).then(W),i("lastOnlineCheck",s),V("Parsing online players...")),"fshReset"===n.target.id&&function(n){i("onlinePlayerMinLvl",r.onlinePlayerMinLvl),i("onlinePlayerMaxLvl",r.onlinePlayerMaxLvl),$("#fshMinLvl",n).val(r.onlinePlayerMinLvl),$("#fshMaxLvl",n).val(r.onlinePlayerMaxLvl),w()}(_)}function B(){_.html(`<span><b>Online Players</b></span>${function(){const n=t("lastOnlineCheck")
return s-n>3e5?'<span> (takes a while to refresh so only do it if you really need to) </span><span id="fshRefresh" class="fshLink">[Refresh]</span>':`<span>[ Wait ${Math.round(300-(s-n)/1e3)}s ]</span>`}()}<div id="fshOutput"></div>`),g("fsh_onlinePlayers").then(G),f(_[0],Y),c(_[0],"keyup",O)}function E(n){o()||(_=n?$(n):$("#pCC"),b().then(B))}export default E
//# sourceMappingURL=injectOnlinePlayers-a2b5c81e.js.map
