import{aS as n,D as t,e,t as a,aT as s,d as r,w as o,q as c,x as i,U as f,aU as l,aV as d}from"./calfSystem-964f4fc9.js"
import{i as u}from"./isArray-40d05c68.js"
import{s as m}from"./setTipped-e5305fe4.js"
import{c as p}from"./currentGuildId-26c6bca8.js"
import{i as v}from"./intValue-f4d85578.js"
import{s as h,g as b}from"./idb-be8b4ca8.js"
import{i as g}from"./interceptSubmit-ddb18ec3.js"
import{c as x}from"./closestTr-e4403fab.js"
import{l as y,p as L}from"./lvlTests-761b273d.js"
import{l as M}from"./loadDataTables-85b3dcec.js"
import{a as T}from"./allthen-7191069a.js"
import{c as j}from"./changeMinMax-9ec858ae.js"
import{f as _,a as k,m as w,t as q}from"./assets-48002450.js"
...
3!==t?a.order([3,"asc"],[t,e]).draw():a.order([3,e]).draw()}(t,t.index(),e)}function en(n){return o(c({cmd:"arena"},n))}function an(){return en({subcmd:"view"})}function sn(n,t){const e=$("tr",t).first()
$("a",e).contents().unwrap(),$(t).prepend($("<thead/>").append(e))}function rn(){U(),S(),$.fn.dataTable.ext.search.push(R)}function on(s,[r,o,c]){const i=$('table[width="635"]',s)
...
h("fsh_arenaFull",o)}(o),Z(c),rn(),i.DataTable(q),function(n){$(nn,n).off("click"),n.on("click",nn,tn)}(s)}function cn(n,e){l("arena.process"),t('#arenaTypeTabs tr[style="display: none;"]').forEach(n=>n.remove()),on(n,e),g(),d("arena.process")}function fn(){if(i())return
...
//# sourceMappingURL=arena-ea228694.js.map
