import{u as e,B as t,C as n,bz as s,H as r,T as a,Z as i,y as o,q as c,G as l,c as u,m as d,bL as f,bB as b,A as p,bQ as h,h as m,i as y,v as L,x as g,o as v}from"./calfSystem-70c7a660.js"
import"./insertElementBefore-543d9ef0.js"
import{i as $}from"./insertElementAfterBegin-8a7c1149.js"
import{c as w}from"./createSpan-fc68466d.js"
import"./csvSplit-c9226810.js"
import{s as x}from"./shouldBeArray-e5283ce6.js"
...
J(t),u.enableWantedList&&(I(t),K<Q?R(K+1).then(V):F())}const Y=[()=>!A,()=>!T,()=>W]
function _(e,t){A=s("bountyList"),T=s("wantedList"),S=r("bountyListRefreshTime"),W=r("bwNeedsRefresh"),W||P()&&(W=!0),Y.some(N)?(T={},T.bounty=[],T.isRefreshed=!0,T.lastUpdate=a,j=!1,C=x("wantedNames"),i("bwNeedsRefresh",!1),R(1).then(V)):function(e,t){t&&(T.isRefreshed=!1,F()),e&&(A.isRefreshed=!1,D())}(e,t)}function ee(e){e.target===X&&(b("bountyList",null),_(u.enableActiveBountyList,u.enableWantedList)),e.target===z&&(b("wantedList",null),_(u.enableActiveBountyList,u.enableWantedList))}function te(){g()||(u.enableWantedList&&(q=Z(),$(f,q)),u.enableActiveBountyList&&(O=Z(),$(f,O)),O&&v(O,ee),q&&v(q,ee),_(u.enableActiveBountyList,u.enableWantedList))}export default te
//# sourceMappingURL=activeWantedBounties-6393f583.js.map
