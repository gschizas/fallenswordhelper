import{t,s as e,bi as s,bj as i,w as n,z as a,p as o,o as d,g as c,y as r,x as h,D as l,u as f,M as u,A as p,F as m,i as g,a8 as b}from"./calfSystem-02ae8657.js"
import"./playerName-9873e3df.js"
import"./fshOpen-3e86a886.js"
import"./openQuickBuffByName-0219802a.js"
import"./dataRows-1cf551f5.js"
import{g as k,s as y}from"./idb-ac1635f3.js"
import{c as w}from"./createTable-c905097e.js"
import"./createStyle-1589fe31.js"
import{h as j}from"./hideElement-2791bd8d.js"
import{a as L}from"./all-5d0e9d43.js"
import{e as R}from"./eventHandler5-5a3d9dd4.js"
import{t as N}from"./toggleForce-f1ceaa74.js"
import{s as G}from"./selfIdIs-e390a6cb.js"
import{p as v}from"./parseDateAsTimestamp-3e99b4b4.js"
import{f as x}from"./functionPasses-a776a47a.js"
import{a as T}from"./addLogColoring-4ce52d22.js"
import"./searchPlayerHref-c36d40ac.js"
import{a as H}from"./addGuildLogWidgets-0c634808.js"
...
for(let t=1;t<s;t+=2){const s=e.rows[t],i=b(s.cells[1]),n=v(i),a=s.cells[2].innerHTML
if(Y(n,a)){W=!1
break}V.push([100*z+t,n,i,a,E(a)])}}(t)}function K(t){!function(t){B=f(t)
...
s.className="divider",s.colSpan=3}(t)}function nt(t){t.checked=Q.checks[t.getAttribute("item")]}function at(){c("input",C).forEach(nt),Z()}function ot(t,e){return t[0]-e[0]}function dt(){W&&V.sort(ot),r("Loading complete.",F),Q.log=V.filter(e(tt,(new Date).setSeconds(0,0))).map(et),Z(),function(){q=w({id:"fshInjectHere",className:"width_full"}),g(q,'<tbody><tr><td class="header" width="16">&nbsp;</td><td class="header" width="20%">Date</td><td class="header" width="80%">Message</td></tr></tbody>'),V.forEach(it)
...
Q.checks[s]=!Q.checks[s],Z(),V.forEach(e(rt,s,!Q.checks[s]))}function lt(t){t&&t.classList&&t.classList.remove("fshHide")}function ft(t){lt(t[5]),lt(t[6])}function ut(){Q.checks=M.slice(0),at(),V.forEach(ft)}function pt(t){j(t[5]),j(t[6])}function mt(){Q.checks=O.slice(0),at(),V.forEach(pt)}function gt(){Q.log=!1,Z(),r("Loading Page 1 ...",F),V=[],W=!0,a("",h("fshInjectHere")),P(1).then(ct)}function bt(t){!function(t){Q=t||Q,Q.checks=Q.checks||M.slice(0)}(t),a(D,o),C=h("fshNewGuildLog"),F=h("fshOutput"),d(C,R([[t=>"INPUT"===t.tagName,ht],[G("fshAll"),ut],[G("fshNone"),mt],[G("rfsh"),gt]])),at(),$=Number(l("newGuildLogHistoryPages")),_=$,P(1).then(ct)}export default function(){n()||k("fsh_guildLog").then(bt)}
//# sourceMappingURL=newGuildLog-bb304a01.js.map
