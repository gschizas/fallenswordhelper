import{aD as o,s as n,o as t,a0 as e,x as a,e as c,W as r,ag as s}from"./calfSystem-02ae8657.js"
import{h as f}from"./hideElement-2791bd8d.js"
import{t as i}from"./toggleForce-f1ceaa74.js"
const u=[]
let h,d
...
!1===e.open?(l(),E(e)):p(e)}(o)}function N(o,n,t,a){0===n&&(t.header=o,function(o){h&&o.classList.add("fshPoint")}(o),function(o,n){s(o)&&o(n)}(a.extraFn,o)),a.articleTest(n)&&(t.rows[n]=e(t[n],{}),t.rows[n].row=o,function(o,n){h?(f(o),n.open=!1):n.open=!0}(o,t))}function b(o,n){const t=n.rowIndex%d,a=(n.rowIndex-t)/d
u[a]=e(u[a],{})
const c=u[a]
...
h=t.checked,c(a(o),"change",n(L,o))}(e.prefName),o(e.theTable.rows).forEach(n(b,e)),t(e.theTable,T)}export{F as c}
//# sourceMappingURL=collapse-1042304c.js.map
