import{m as t,t as n,h as e,A as r,O as a,b2 as s,c as o,aD as i,bC as c,i as f,bD as d,e as m,be as u,j as l,G as h,p,o as b,l as j,Y as k,U as $,z as g}from"./calfSystem-34fcd691.js"
import{i as L}from"./isArray-de90de98.js"
import"./toLowerCase-dda30e6b.js"
import{c as y}from"./createInput-160fd5a0.js"
import{c as w}from"./createLabel-08dbc484.js"
import{c as E}from"./createUl-215dc001.js"
import"./isChecked-8ee9db43.js"
import{b as A}from"./simpleCheckbox-86567985.js"
import"./alpha-ec0cb412.js"
import{c as C}from"./createTBody-491c483b.js"
import{c as x}from"./createTable-615fb65e.js"
import"./dialogMsg-16e7e1c1.js"
import{p as I,s as S}from"./pubsub-24f21e78.js"
import{c as H}from"./createLi-6977e253.js"
import"./errorDialog-7f431a39.js"
import"./indexAjaxJson-951ebca2.js"
import{t as N}from"./toggleForce-7d757ba6.js"
import{a as v}from"./stringSort-5f5b36f0.js"
import{j as Q}from"./jConfirm-c7c3eb96.js"
import"./daUseItem-36e8cc2b.js"
import{e as U}from"./eventHandler5-38ce9acc.js"
import{s as W}from"./selfIdIs-4e4543fe.js"
import{m as q}from"./makeFolderSpan-b87628a5.js"
import{d as P}from"./daLoadInventory-0316f36a.js"
import"./dialog-2e17f157.js"
import{u as M,e as T}from"./useItem-d9ed8fb3.js"
import{h as O}from"./hasClasses-e8f1263e.js"
const D=(t,n)=>t+String(n)
function F(t,n,e){return y({checked:0===e,id:D(t,e),name:t,type:"radio"})}function B(t,n,r,s){const o=H({className:"ui-state-default ui-corner-top"})
return e(o,w({htmlFor:D(t,s),innerHTML:r})),0!==s&&a(o,"click",()=>{I(D(t,s),n[s])}),o}const _=()=>t({className:"ui-tabs-panel ui-corner-bottom"})
...
return t.map(n(B,r,a)).forEach(n(e,s)),s}(s,o,f)
return I(o+"-header",d),e(i,d),f.forEach(c),r("",a),e(a,i),0}function z(t,n,e){const a=t.insertRow(-1)
e.dom=a
...
return 13699===t.b?n+=`composing/${t.extra.design}_${t.extra.color}.png`:n+=`items/${t.b}.gif`,n}(e)}" class="tip-dynamic" data-tipped="fetchitem.php?item_id=${e.b}&amp;inv_id=${e.a}&amp;t=1&amp;p=${n}&amp;currentPlayerId=${n}" width="30" height="30" border="0"></td><td width="90%">&nbsp;${e.n}</td>`,a)}function J(t){return q(String(t.id),t.name)}function R(t){return q("0","All")+t.r.map(J).join("")}function Y(t,e,r){r.items.sort(v).forEach(n(z,t,e))}function Z(t){const r=x({width:"100%",innerHTML:`<thead><tr><th class="fshCenter" colspan="3">${R(t)}</th></tr><tr class="fshHeader"><th class="fshCenter" width="20%">Actions</th><th colspan="2">Items</th></tr></thead>`}),a=C()
