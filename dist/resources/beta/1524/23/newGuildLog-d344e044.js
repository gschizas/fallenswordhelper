import{u as t,t as e,bi as s,bj as i,x as n,A as a,p as o,o as d,g as c,z as r,y as h,G as l,v as f,C as u,B as p,I as m,i as g,K as b}from"./calfSystem-34fcd691.js"
import"./playerName-d0ea3aa5.js"
import"./fshOpen-ee221b8b.js"
import"./openQuickBuffByName-f52e13a3.js"
import"./dataRows-abf5aa16.js"
import{g as k,s as y}from"./idb-62d2605f.js"
import{c as w}from"./createTable-615fb65e.js"
import"./createStyle-44d1ad05.js"
import{h as j}from"./hideElement-48576eeb.js"
import{p as L}from"./parseDateAsTimestamp-56d08ae7.js"
import{t as R}from"./toggleForce-7d757ba6.js"
import{a as N}from"./all-9da52a21.js"
import{e as G}from"./eventHandler5-38ce9acc.js"
import{s as v}from"./selfIdIs-4e4543fe.js"
import{f as x}from"./functionPasses-7aa0d8e8.js"
import"./doBuffLinkClick-6b8b0e16.js"
import{a as T}from"./addLogColoring-7b71ad67.js"
import"./searchPlayerHref-683ef8df.js"
import{a as H}from"./addGuildLogWidgets-a3f07405.js"
...
for(let t=1;t<s;t+=2){const s=e.rows[t],i=b(s.cells[1]),n=L(i),a=s.cells[2].innerHTML
if(W(n,a)){V=!1
break}Q.push([100*z+t,n,i,a,C(a)])}}(t)}function J(t){!function(t){_=f(t)
...
a(e,s),s.className="row"}function it(t){!function(t){const e=q.insertRow(-1)
...
s.className="divider",s.colSpan=3}(t)}function nt(t){t.checked=K.checks[t.getAttribute("item")]}function at(){c("input",D).forEach(nt),Z()}function ot(t,e){return t[0]-e[0]}function dt(){V&&Q.sort(ot),r("Loading complete.",M),K.log=Q.filter(e(tt,(new Date).setSeconds(0,0))).map(et),Z(),function(){q=w({id:"fshInjectHere",className:"width_full"}),g(q,'<tbody><tr><td class="header" width="16">&nbsp;</td><td class="header" width="20%">Date</td><td class="header" width="80%">Message</td></tr></tbody>'),Q.forEach(it)
const t=h("fshInjectHere")
o.replaceChild(q,t),T("myGuildLog",1),H()}()}function ct(t){J(t),function(){const t=[]
...
K.checks[s]=!K.checks[s],Z(),Q.forEach(e(rt,s,!K.checks[s]))}function lt(t){t&&t.classList&&t.classList.remove("fshHide")}function ft(t){lt(t[5]),lt(t[6])}function ut(){K.checks=O.slice(0),at(),Q.forEach(ft)}function pt(t){j(t[5]),j(t[6])}function mt(){K.checks=B.slice(0),at(),Q.forEach(pt)}function gt(){K.log=!1,Z(),r("Loading Page 1 ...",M),Q=[],V=!0,a("",h("fshInjectHere")),I(1).then(ct)}function bt(t){!function(t){K=t||K,K.checks=K.checks||O.slice(0)}(t),a(E,o),D=h("fshNewGuildLog"),M=h("fshOutput"),d(D,G([[t=>"INPUT"===t.tagName,ht],[v("fshAll"),ut],[v("fshNone"),mt],[v("rfsh"),gt]])),at(),F=Number(l("newGuildLogHistoryPages")),$=F,I(1).then(ct)}export default function(){n()||k("fsh_guildLog").then(bt)}
//# sourceMappingURL=newGuildLog-d344e044.js.map
