import{u as t,v as e,C as n,M as i,K as r,ai as a,bl as s,m as l,bm as c,bn as o,A as d,p as u,t as m,ap as f,ao as h,bo as p}from"./calfSystem-34fcd691.js"
import{d as b}from"./dataRows-abf5aa16.js"
import{p as $}from"./padZ-ce2146a0.js"
import"./closest-5107b89a.js"
import{c as v}from"./closestTable-26bc0e79.js"
import"./all-9da52a21.js"
import{s as N}from"./splitTime-3bc21465.js"
import{a as j}from"./allthen-f8a5c187.js"
import{t as g}from"./textNodes-5ca3a193.js"
...
return{id:e.href.match(s)[1],name:r(e)}}(t.cells[2])),e}function w(t){const e=n(".header",t),i=v(e)
return b(i.rows,4,0).map(_)}function C(t){const n=t.map(e).map(w)
return[].concat(...n)}function G(t){const r=e(t),a=n('#pCC select[name="page"]',r),s=i(a.children).map(t=>Number(t.value)).filter(t=>0!==t)
return j([t].concat(s.map(y)),C)}function T(t,e){return e.id===t}function L(t){return t.attributes&&t.attributes.find(m(T,6))}function S(t,e){if(t){const n=t.find(m(T,e))
...
var e,n}function A(t){t.sort((t,e)=>t.min_level-e.min_level),d(function(t){return`<style>#pCC .reliclist {\n        border-collapse: collapse;\n        border-spacing: 0;\n        table-layout: fixed;\n      }\n      .reliclist, .reliclist th, .reliclist td {\n        border: 1px solid black;\n      }\n      .reliclist th, .reliclist td {\n        padding: 5px;\n      }\n      .reliclist th:nth-of-type(10), .reliclist td:nth-of-type(10) {\n        width: 100px;\n      }</style><table class="reliclist"><thead><tr><th>Level</th><th>Name</th><th>Guild</th><th>Stam<br>Gain</th><th>Atk</th><th>Dmg</th><th>Stam</th><th>Gold<br>Gain</th><th>XP<br>Gain</th><th>Time</th></tr></thead><tbody>${t.filter(L).map(k).join("")}</tbody></table>`}(t),u)}export default function(){d("Loading...",u),y(0).then(G).then(A)}
//# sourceMappingURL=reliclist-a3352156.js.map
