import{u as e,B as t,C as n,bC as s,G as a,S as r,Y as i,y as o,q as c,K as l,c as u,m as d,bO as b,bE as f,A as p,bR as h,h as m,i as y,v as L,x as g,o as v}from"./calfSystem-34fcd691.js"
import"./insertElementBefore-f1fdb06b.js"
import{i as $}from"./insertElementAfterBegin-e1b4401b.js"
import{c as w}from"./createSpan-4ec18ffd.js"
import"./csvSplit-4ba7a6af.js"
import{s as x}from"./shouldBeArray-ceec48b8.js"
import{f as N}from"./functionPasses-7aa0d8e8.js"
...
B.bounty.push(n)}}(e)}function P(){return B&&r-B.lastUpdate>S||T&&r-T.lastUpdate>S}function H(e){const t=e[6]
...
function _(e,t){B=s("bountyList"),T=s("wantedList"),S=a("bountyListRefreshTime"),C=a("bwNeedsRefresh"),C||P()&&(C=!0),Z.some(N)?(T={},T.bounty=[],T.isRefreshed=!0,T.lastUpdate=r,j=!1,W=x("wantedNames"),i("bwNeedsRefresh",!1),R(1).then(V)):function(e,t){t&&(T.isRefreshed=!1,I()),e&&(B.isRefreshed=!1,F())}(e,t)}function ee(e){e.target===K&&(f("bountyList",null),_(u.enableActiveBountyList,u.enableWantedList)),e.target===X&&(f("wantedList",null),_(u.enableActiveBountyList,u.enableWantedList))}export default function(){g()||(u.enableWantedList&&(q=D(),$(b,q)),u.enableActiveBountyList&&(G=D(),$(b,G)),G&&v(G,ee),q&&v(q,ee),_(u.enableActiveBountyList,u.enableWantedList))}
//# sourceMappingURL=activeWantedBounties-89dd4982.js.map
