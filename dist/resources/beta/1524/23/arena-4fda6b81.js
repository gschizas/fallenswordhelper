import{aT as n,D as t,e as a,t as e,aU as s,d as r,w as o,q as i,x as c,U as d,aV as f,aW as l}from"./calfSystem-34fcd691.js"
import{i as u}from"./isArray-de90de98.js"
import{s as m}from"./setTipped-d4d554a0.js"
import{c as p}from"./currentGuildId-fa7da475.js"
import{i as v}from"./intValue-0e84cdad.js"
import{s as h,g as b}from"./idb-62d2605f.js"
import{i as g}from"./interceptSubmit-492af249.js"
import{c as x}from"./closestTr-dbc0d607.js"
import{l as y,p as L}from"./lvlTests-1d6480c4.js"
import{l as M}from"./loadDataTables-407075e4.js"
import{a as T}from"./allthen-f8a5c187.js"
import{c as j}from"./changeMinMax-29622459.js"
import{f as _,a as k,m as w,t as q}from"./assets-06ec229a.js"
...
s.forEach(e(Y,p())),s.forEach(e(P,a))}(i),sn(),c.DataTable(q),function(n){$(Z,n).off("click"),n.on("click",Z,nn)}(s)}function on(n,a){f("arena.process"),t('#arenaTypeTabs tr[style="display: none;"]').forEach(n=>n.remove()),rn(n,a),g(),l("arena.process")}function cn(){if(c())return
const n=$("#arenaTypeTabs")
1===n.length?T([b(_),b("fsh_arenaFull"),an().catch(()=>({})),M()],e(on,n)):d("arena","Join error screen ?")}var dn=Object.freeze({__proto__:null,default:cn})
export{tn as a,dn as b,cn as i,an as v}
//# sourceMappingURL=arena-4fda6b81.js.map
