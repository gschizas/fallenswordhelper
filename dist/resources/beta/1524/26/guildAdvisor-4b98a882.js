import{n as t,m as s,h as a,a as e,t as n,a1 as r,aV as i,A as c,aW as l,i as o,x as d,b as u,p as f,c as m,M as p,J as v,a6 as h,G as b,B as g}from"./calfSystem-cf4d22a7.js"
import{a as j}from"./addCommas-b567f740.js"
import"./currentGuildId-5763962b.js"
import"./idb-4798970d.js"
import{c as y}from"./createTable-a63e2578.js"
import"./indexAjaxJson-451a313a.js"
import"./cmdExport-b7dc8f76.js"
import{i as A}from"./insertHtmlAfterEnd-a7b25c39.js"
import"./all-646b32fa.js"
import{l as B}from"./loadDataTables-c2f9706f.js"
import{g as C}from"./guild-740bccac.js"
import{a as D}from"./allthen-18c82be8.js"
import{g as S}from"./getMembrList-5556413d.js"
...
0!==t.length&&A(t[0],`<span> <a href="${h}guild&subcmd=advisor&subcmd2=weekly">7-Day Summary</a></span>`)}(),l("guildAdvisor.injectAdvisorDaily")}function Q(t){"weekly"===m.subcmd2?function(t){i("guildAdvisor.injectAdvisorWeekly"),c('<span class="fshCurveContainer fshFlex"><span class="fshCurveEle fshCurveLbl fshOldSpinner"></span><span class="fshSpinnerMsg">&nbsp;Retrieving daily data ...</span></span>',t)
const s=[S(!1)].concat([1,2,3,4,5,6,7].map(n(J,t)))
D(s,n(V,t)),l("guildAdvisor.injectAdvisorWeekly")}(t):S(!1).then(n(K,t))}function U(){if(d())return
const t=u("table",f)[1]
t&&B().then(()=>Q(t))}export default U
//# sourceMappingURL=guildAdvisor-4b98a882.js.map
