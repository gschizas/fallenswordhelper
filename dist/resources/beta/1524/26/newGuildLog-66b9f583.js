import{u as t,t as e,bg as s,bh as i,x as n,A as a,p as o,o as d,g as c,z as r,y as h,H as l,v as f,C as u,B as p,J as m,i as g,G as b}from"./calfSystem-cf4d22a7.js"
...
import{g as k,s as y}from"./idb-4798970d.js"
import{c as w}from"./createTable-a63e2578.js"
import{h as j}from"./hideElement-891c9603.js"
import{p as L}from"./parseDateAsTimestamp-21fc8baa.js"
import{t as R}from"./toggleForce-a095aa43.js"
import{a as N}from"./all-646b32fa.js"
import{e as G}from"./eventHandler5-7cb92943.js"
import{s as v}from"./selfIdIs-e0a8096b.js"
import{f as x}from"./functionPasses-f51a6282.js"
import"./doBuffLinkClick-8560d233.js"
import{a as H}from"./addLogColoring-c8983eab.js"
import"./searchPlayerHref-fece30ec.js"
import{a as T}from"./addGuildLogWidgets-042a9474.js"
...
if(W(n,a)){V=!1
break}Q.push([100*z+t,n,i,a,C(a)])}}(t)}function K(t){!function(t){_=f(t)
...
s.className="divider",s.colSpan=3}(t)}function nt(t){t.checked=J.checks[t.getAttribute("item")]}function at(){c("input",D).forEach(nt),Z()}function ot(t,e){return t[0]-e[0]}function dt(){V&&Q.sort(ot),r("Loading complete.",M),J.log=Q.filter(e(tt,(new Date).setSeconds(0,0))).map(et),Z(),function(){q=w({id:"fshInjectHere",className:"width_full"}),g(q,'<tbody><tr><td class="header" width="16">&nbsp;</td><td class="header" width="20%">Date</td><td class="header" width="80%">Message</td></tr></tbody>'),Q.forEach(it)
const t=h("fshInjectHere")
o.replaceChild(q,t),H("myGuildLog",1),T()}()}function ct(t){K(t),function(){const t=[]
...
J.checks[s]=!J.checks[s],Z(),Q.forEach(e(rt,s,!J.checks[s]))}function lt(t){t&&t.classList&&t.classList.remove("fshHide")}function ft(t){lt(t[5]),lt(t[6])}function ut(){J.checks=O.slice(0),at(),Q.forEach(ft)}function pt(t){j(t[5]),j(t[6])}function mt(){J.checks=B.slice(0),at(),Q.forEach(pt)}function gt(){J.log=!1,Z(),r("Loading Page 1 ...",M),Q=[],V=!0,a("",h("fshInjectHere")),P(1).then(ct)}function bt(t){!function(t){J=t||J,J.checks=J.checks||O.slice(0)}(t),a(E,o),D=h("fshNewGuildLog"),M=h("fshOutput"),d(D,G([[t=>"INPUT"===t.tagName,ht],[v("fshAll"),ut],[v("fshNone"),mt],[v("rfsh"),gt]])),at(),F=Number(l("newGuildLogHistoryPages")),$=F,P(1).then(ct)}function kt(){n()||k("fsh_guildLog").then(bt)}export default kt
//# sourceMappingURL=newGuildLog-66b9f583.js.map
