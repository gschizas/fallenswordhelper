import{w as t,g as n,p as e,d as r,G as s,t as i,bj as a,H as o,i as c,ai as l,S as f,am as u,U as d,bn as m,b as p,o as h,j as v,aT as b}from"./calfSystem-cf4d22a7.js"
import{i as g}from"./isArray-fd538fb3.js"
import{p as j}from"./playerName-b9ef36e6.js"
import{c as y}from"./createInput-6dbf94aa.js"
import{o as _}from"./onlineDot-d0dbf176.js"
import"./insertElementBefore-47c09359.js"
import{c as w}from"./currentGuildId-5763962b.js"
import"./intValue-e4cdd281.js"
import"./valueText-5ba89d31.js"
import{a as N,g as L}from"./levelHighlight-65fdb4c8.js"
import{i as S}from"./insertElementAfterBegin-5b4956e9.js"
import{c as C}from"./createSpan-7e967fbf.js"
import{h as E}from"./hideElement-891c9603.js"
import"./all-646b32fa.js"
import{f as P}from"./functionPasses-f51a6282.js"
import{g as T}from"./guild-740bccac.js"
...
e&&q(n,e)}function K(t,n){n.s&&g(n.r)&&q(t,n.r[0])}function Q(t,n){n.s&&q(t,{last_activity:f-n.r.last_activity,vl:n.r.virtual_level})}function R(t){return-1!==t[0]}function X(t,n){return t.concat(n.members)}function Y(t,n){const e=(r=n.r.ranks,s="id",r.filter(i(I,s,{}))).reduce(X,[])
var r,s
t[1].forEach(i(J,e))}function Z(t,n){n.s&&Y(t,n)}function tt(t){return O(t[0]).then(i(Z,t))}function nt(t){return-1===t[0]}function et(t){return t[1]!==j()?H(t[1]).then(i(K,t)):m().then(i(Q,t))}function rt(){const t=n(r,e).slice(4).map(x).reduce(A,[]).reduce(G,[])
let s=t.filter(R).map(tt)
t.find(nt)&&(s=s.concat(t.find(nt)[1].map(et))),F(s,$)}function st(t){var n
d("toprated","FindOnlinePlayers"),n=t.target,u(n),V=C({className:"fshCurveContainer fshTopListSpinner",innerHTML:'<div class="fshCurveEle fshCurveLbl fshOldSpinner"></div>'}),n.parentNode.replaceChild(V,n),M=o("highlightPlayersNearMyLvl"),M&&(U=w()),rt()}const it=[()=>v(),()=>b(e),()=>b(e.children[0]),()=>b(e.children[0].rows),()=>e.children[0].rows.length>2,()=>s(e.children[0].rows[1]).startsWith("Last Updated")]
...
//# sourceMappingURL=toprated-58280e4f.js.map
