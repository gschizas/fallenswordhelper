import{r as e,A as t,t as n,aD as s,a9 as o,Y as a,bI as i,C as c,m as r,O as l,U as m,i as p,b1 as u,D as f,h as d,o as g,p as h,z as b,c as v,bJ as C,B as S,a4 as E,j,G as k,y as N,I as x}from"./calfSystem-1b876afa.js"
import{c as y}from"./createInput-2c55af64.js"
import{i as A}from"./insertElementBefore-f07a50c4.js"
import{c as I}from"./createTable-ba51d4af.js"
import{p as B,a as L}from"./pubsub-4fd95126.js"
import{g as q}from"./getArrayByClassName-ef7e9871.js"
import{i as $}from"./insertHtmlAfterEnd-dd9b917d.js"
import{i as F}from"./insertElementAfter-15b302d6.js"
import{r as T,g as P}from"./rnd-df0ee2c5.js"
...
return 0===s&&b(e[1],t.insertCell(-1)),d(t.insertCell(-1),(o=(s+1).toString(),a=e[0],y({className:"awesome orange",dataset:{templateId:a},type:"button",value:o}))),t}function O(e,t,s,o){return e.reduce(n(M,o),s.insertRow(-1)),s}function R(e){return[e.value,e.text]}function U(e,t,s){const o=function(e,t,s){const o=I({id:"fshFastCompose"})
return G(o,s),e.reduce(n(O,t,s),o)}(f("#composing-template-multi option").map(R),t,s)
d(e,o),g(h,J),L("quickcreate",n(H,o))}function Y(e){m("composing","FastCompose"),p(e,"<br>")
...
F(s,e),l(s,"change",n(Y,t))}()}export default function(){j()&&h&&ee()}
//# sourceMappingURL=composing-69bde5ae.js.map
