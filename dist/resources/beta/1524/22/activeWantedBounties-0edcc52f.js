import{u as e,B as t,C as n,bC as s,G as r,S as a,Y as i,y as o,q as c,K as l,c as u,m as b,bO as d,bE as f,A as p,bR as h,h as m,i as y,v as L,x as g,o as v}from"./calfSystem-1b876afa.js"
import"./insertElementBefore-f07a50c4.js"
import{i as $}from"./insertElementAfterBegin-476f3d65.js"
import{c as w}from"./createSpan-bd67d773.js"
import"./csvSplit-e0564c5b.js"
import{s as x}from"./shouldBeArray-c3bb627f.js"
import{f as N}from"./functionPasses-b377e5ec.js"
...
B.bounty.push(n)}}(e)}function P(){return B&&a-B.lastUpdate>S||T&&a-T.lastUpdate>S}function H(e){const t=e[6]
...
function D(){return b({className:"minibox"})}function F(){f("bountyList",B),p("",G)
...
B={},B.bounty=[],B.isRefreshed=!0,B.lastUpdate=a,n&&M(n),j=!0}(e),F())}function V(e){const t=L(e)
Q(t),u.enableWantedList&&(J(t),Y<z?R(Y+1).then(V):I())}const Z=[()=>!B,()=>!T,()=>C]
function _(e,t){B=s("bountyList"),T=s("wantedList"),S=r("bountyListRefreshTime"),C=r("bwNeedsRefresh"),C||P()&&(C=!0),Z.some(N)?(T={},T.bounty=[],T.isRefreshed=!0,T.lastUpdate=a,j=!1,W=x("wantedNames"),i("bwNeedsRefresh",!1),R(1).then(V)):function(e,t){t&&(T.isRefreshed=!1,I()),e&&(B.isRefreshed=!1,F())}(e,t)}function ee(e){e.target===K&&(f("bountyList",null),_(u.enableActiveBountyList,u.enableWantedList)),e.target===X&&(f("wantedList",null),_(u.enableActiveBountyList,u.enableWantedList))}export default function(){g()||(u.enableWantedList&&(q=D(),$(d,q)),u.enableActiveBountyList&&(G=D(),$(d,G)),G&&v(G,ee),q&&v(q,ee),_(u.enableActiveBountyList,u.enableWantedList))}
//# sourceMappingURL=activeWantedBounties-0edcc52f.js.map
