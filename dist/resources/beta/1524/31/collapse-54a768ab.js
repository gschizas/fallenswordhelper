import{M as o,t as n,o as t,a2 as e,y as c,f as r,Y as a,ay as f}from"./calfSystem-47fc08ae.js"
...
u[c]=e(u[c],{})
const r=u[c]
r.rows=r.rows||[],N(n,t,r,o)}function j(o){o.header.classList.toggle("fshPoint")}function y(o){h=!h,a(o,h),h?l():u.forEach(x),u.forEach(j)}function L(e){d=e.headInd,function(o){const t=c(o)
h=t.checked,r(c(o),"change",n(y,o))}(e.prefName),o(e.theTable.rows).forEach(n(b,e)),t(e.theTable,T)}export{L as c}
//# sourceMappingURL=collapse-54a768ab.js.map
