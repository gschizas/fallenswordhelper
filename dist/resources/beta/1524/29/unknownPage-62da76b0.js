import{D as e,G as n,H as t,bw as s,t as a,x as o,C as r,bG as i,bH as f,y as c,bI as u,a9 as m,bJ as l}from"./calfSystem-f9a27018.js"
import"./numberIsNaN-d1ebf732.js"
import{g as p,s as b}from"./idb-5c501cd3.js"
import"./isDate-14b56c12.js"
import"./padZ-a3ed1fe1.js"
import{f as w}from"./formatLocalDateTime-c07c341a.js"
import{x as d}from"./xPath-57483fc0.js"
...
b(s,t.reverse().join("")+e)}const B=[[()=>r(".news_left_column"),()=>{i("unknown.news"),f()}],[()=>c("quickbuff-report"),()=>{i("unknown.buffLog.updateBuffLog"),t("keepBuffLog")&&p(s).then(y)}],[()=>d('//td[.="Quest Name"]'),()=>{i("unknown.questBook.injectQuestBookFull"),u()}],[()=>m('#pCC img[title="Inventing"]').length>0,()=>{i("unknown.recipes.inventing"),l()}]]
function D(){if(o())return
const e=B.find(e=>e[0]())
e&&e[1]()}export default D
//# sourceMappingURL=unknownPage-62da76b0.js.map
