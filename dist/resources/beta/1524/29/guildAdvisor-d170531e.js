import{n as t,m as s,h as a,a as e,t as n,a1 as r,aU as i,A as c,aV as l,i as o,x as d,b as u,p as f,c as m,M as p,J as v,a6 as h,G as b,B as g}from"./calfSystem-f9a27018.js"
import{a as j}from"./addCommas-0aacc5f1.js"
import"./currentGuildId-a542fdb9.js"
import"./idb-5c501cd3.js"
import{c as y}from"./createTable-1203d2c6.js"
import"./indexAjaxJson-e32f2264.js"
import"./cmdExport-c40c0dde.js"
import{i as A}from"./insertHtmlAfterEnd-18e893ae.js"
import"./all-01203f8c.js"
import{l as B}from"./loadDataTables-343ff96f.js"
import{g as C}from"./guild-03def43b.js"
import{a as D}from"./allthen-ca11bf0c.js"
import{g as S}from"./getMembrList-2275ea18.js"
...
0!==t.length&&A(t[0],`<span> <a href="${h}guild&subcmd=advisor&subcmd2=weekly">7-Day Summary</a></span>`)}(),l("guildAdvisor.injectAdvisorDaily")}function K(t){"weekly"===m.subcmd2?function(t){i("guildAdvisor.injectAdvisorWeekly"),c('<span class="fshCurveContainer fshFlex"><span class="fshCurveEle fshCurveLbl fshOldSpinner"></span><span class="fshSpinnerMsg">&nbsp;Retrieving daily data ...</span></span>',t)
const s=[S(!1)].concat([1,2,3,4,5,6,7].map(n(N,t)))
D(s,n(U,t)),l("guildAdvisor.injectAdvisorWeekly")}(t):S(!1).then(n(z,t))}function Q(){if(d())return
const t=u("table",f)[1]
t&&B().then(()=>K(t))}export default Q
//# sourceMappingURL=guildAdvisor-d170531e.js.map
