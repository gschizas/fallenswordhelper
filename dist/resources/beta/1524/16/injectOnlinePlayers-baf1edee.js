import{ap as e,s as n,D as t,a2 as a,a0 as s,W as l,aV as i,w as r,o,e as f,u}from"./calfSystem-9554b525.js"
import{n as c}from"./numberIsNaN-f35fe828.js"
import{c as h}from"./currentGuildId-7c7a6b86.js"
import{i as d}from"./intValue-bb872327.js"
import"./valueText-350043d0.js"
import{b as p,p as v,c as m}from"./levelHighlight-5971fae0.js"
import{g,s as y}from"./idb-e27acc21.js"
import"./all-e75535ec.js"
import{l as M,p as L}from"./lvlTests-848165a9.js"
import{l as b}from"./loadDataTables-993c57a0.js"
import{o as P}from"./onlinePlayersPage-ec96bf35.js"
...
for(let n=2;n<=G;n+=1)P(n).then(e)}function W(e){$("#fshOutput",_).append(e)}function A(e){W(" "+(z+1))
const t=u(e),a=$("#pCC input.custominput",t).first()
!function(e,t){const a=t.attr("value")
$('#pCC img[src$="/world/icon_action_view.png',e).parent().parent().parent().each(n(S,a))}(t,a),z+=1,1===z&&V(A,a),z===G&&(y("fsh_onlinePlayers",D),H(D))}function B(e){"fshRefresh"===e.target.id&&($("#fshRefresh",_).hide(),z=0,D={},P(1).then(A),l("lastOnlineCheck",a),W("Parsing online players...")),"fshReset"===e.target.id&&function(e){l("onlinePlayerMinLvl",i.onlinePlayerMinLvl),l("onlinePlayerMaxLvl",i.onlinePlayerMaxLvl),$("#fshMinLvl",e).val(i.onlinePlayerMinLvl),$("#fshMaxLvl",e).val(i.onlinePlayerMaxLvl),O()}(_)}function E(){_.html(`<span><b>Online Players</b></span>${function(){const e=t("lastOnlineCheck")
return a-e>3e5?'<span> (takes a while to refresh so only do it if you really need to) </span><span id="fshRefresh" class="fshLink">[Refresh]</span>':`<span>[ Wait ${Math.round(300-(a-e)/1e3)}s ]</span>`}()}<div id="fshOutput"></div>`),g("fsh_onlinePlayers").then(H),o(_[0],B),f(_[0],"keyup",k)}export default function(e){r()||(_=e?$(e):$("#pCC"),b().then(E))}
//# sourceMappingURL=injectOnlinePlayers-baf1edee.js.map
