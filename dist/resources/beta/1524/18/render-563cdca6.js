import{s as t,D as n,ap as s,c as e,S as o,b as f,p as a,A as c,z as u,x as r,l as i}from"./calfSystem-4197cc22.js"
import{a as l}from"./roundToString-e698aa13.js"
import{p}from"./playerName-8ec525d6.js"
import{t as b}from"./toLowerCase-1fa49c12.js"
...
function h(t,n){return n[0](t)}function k(u){"-"===e.subcmd&&o("profile","formatBuffsToBuy")
const r=function(){let t=f("h1",a)
return t=0!==t.length?c(t[0]):p(),t}()
let i=n("buyBuffsGreeting").trim()
i=i.replace(/{playername}/g,r),i=function(n,e){return g.find(t(h,n))[1](n,s(e.buffs).join(", "),e)}(i,u),window.openQuickMsgDialog(r,i,"")}const $=/[^a-zA-Z0-9.,+\- ]/g,w=/([+-]{0,1}[.\d]+ *k)|([+-]{0,1}[.\d]+ *fsp)|([+-]{0,1}[.\d]+ *stam)/
...
function L(t){return`<tr><td>${t[0]}</td><td>: ${t[1][0]}${t[1][1]}</td></tr>`}function j(t,n){return t[n[1][1]]+=n[1][0],t}function x(){const n=i(C.buffs),s=(e=n.reduce(j,{k:0,fsp:0,stam:0,unknown:0}),d.map(t(m,e)).join(""))
var e
u(`<span class="tip-static" data-tipped="This is an estimated cost based on how the script finds the cost associated with buffs from viewing bio. It can be incorrect, please use with discretion.<br><hr><table border=0>${n.map(L).join("")}</table><b>Total: ${s}</b>">Estimated Cost: <b>${s}</b></span>`,r("buffCost")),C.buffCostTotalText=s}function y(t){const n=t.classList.contains("fshBlue")
t.classList.toggle("fshBlue"),t.classList.toggle("fshYellow")
const s=c(t)
n?function(t){const n=T(t)
let s,e
n?(s=function(t){return t[0].includes("k")?"k":t[0].includes("f")?"fsp":"stam"}(n),[e]=n[0].match(/([+-]?[.\d]+)/)):(s="unknown",e="1"),C.buffs[c(t)]=[parseFloat(e),s],C.count+=1}(t):(C.count-=1,delete C.buffs[s]),C.count>0?x():(u("&nbsp;",r("buffCost")),C.buffCostTotalText="")}function N(t){if("fshSendBuffMsg"===t.target.id)return void function(t){t.count>0&&k(t)}(C)
...
//# sourceMappingURL=render-563cdca6.js.map
