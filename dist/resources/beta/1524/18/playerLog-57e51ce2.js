import{l as t,aU as e,I as a,b7 as s,a8 as n,M as o,b8 as r,y as i,b9 as c,v as f,Q as l,s as u,aT as p,ba as d,a5 as m,f as h,k as g,bb as b,i as y,o as j,D as w,aD as $,bc as v,bd as k,be as C,a1 as P,A as _,W as L,w as T}from"./calfSystem-4197cc22.js"
import"./playerName-8ec525d6.js"
import{t as x}from"./toLowerCase-1fa49c12.js"
import{a as B}from"./addCommas-519d90bf.js"
import{c as E}from"./currentGuildId-2aaee988.js"
import"./fshOpen-e5d8c136.js"
import{o as R}from"./openQuickBuffByName-d8a01295.js"
import"./dataRows-635afab2.js"
import{g as S,s as A}from"./idb-f3252f63.js"
import{c as I}from"./createStyle-6687f7ad.js"
import"./closest-5218baf6.js"
import"./indexAjaxJson-914501b6.js"
import{c as G}from"./csvSplit-9e107db2.js"
import{i as M}from"./insertHtmlAfterEnd-33a3ae32.js"
import"./cmdExport-ccb93370.js"
import{c as D}from"./closestTr-3be0023c.js"
import{p as Y}from"./parseDateAsTimestamp-11233d2d.js"
import{b as N}from"./buffObj-cd641098.js"
import"./getProfile-92484501.js"
import{m as Q}from"./myStats-1e0221a4.js"
import{c as q}from"./closestTd-f6cb169c.js"
import{g as H}from"./getMembrList-3a22203c.js"
import{a as W}from"./addLogColoring-106de169.js"
let z
...
t.cells[2].firstChild.remove(),m(t.cells[2],n),h(t.cells[2],g({innerHTML:o}))}const ft=t=>t.username
let lt
...
return s?e="guild":o?e="ally":r&&(e="enemy"),[`.fshPlayerColoring tr:nth-of-type(${D(t).rowIndex+1}) td:nth-of-type(3) > a:first-of-type`,e]}function ht(t,[e,a]){return t[a]?t[a].push(e):t[a]=[e],t}const gt={guild:"green",ally:"blue",enemy:"red"}
function bt([t,e]){return`${e.join(", ")} { color: ${gt[t]}; }`}async function yt(e){const s=a(b,e)
if(0===s.length)return
const n=(await Promise.all(s.map(mt))).filter(([,t])=>""!==t),o=t(n.reduce(ht,{})).map(bt)
...
const n=e.map(D).map(t=>[t,J(t)]);(await Promise.all(n.map(U))).filter(([,,t])=>!t).forEach(X)}(t),w("notificationWidgets")&&function(t,e,s){const o=a(b,t)
...
t&&Bt(t)}()}
//# sourceMappingURL=playerLog-57e51ce2.js.map
