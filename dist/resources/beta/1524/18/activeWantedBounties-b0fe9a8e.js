import{t as e,A as t,M as n,bH as s,D as a,Q as r,W as i,x as o,n as c,a8 as l,c as u,k as d,bT as f,bJ as b,z as p,bV as h,f as m,i as y,u as L,w as g,o as v}from"./calfSystem-4197cc22.js"
import"./insertElementBefore-fe70cd72.js"
import{i as w}from"./insertElementAfterBegin-aa3c6e65.js"
import{c as $}from"./createSpan-537a8929.js"
import"./csvSplit-9e107db2.js"
import{s as x}from"./shouldBeArray-3f4492ec.js"
...
function K(){return d({className:"minibox"})}function Q(){b("bountyList",T),p("",G)
...
var n
y(G,t)}function V(){b("wantedList",B),p("",X)
...
function _(e,t){T=s("bountyList"),B=s("wantedList"),W=a("bountyListRefreshTime"),M=a("bwNeedsRefresh"),M||C()&&(M=!0),Z.some(N)?(B={},B.bounty=[],B.isRefreshed=!0,B.lastUpdate=r,j=!1,S=x("wantedNames"),i("bwNeedsRefresh",!1),R(1).then(Y)):function(e,t){t&&(B.isRefreshed=!1,V()),e&&(T.isRefreshed=!1,Q())}(e,t)}function ee(e){e.target===q&&(b("bountyList",null),_(u.enableActiveBountyList,u.enableWantedList)),e.target===z&&(b("wantedList",null),_(u.enableActiveBountyList,u.enableWantedList))}export default function(){g()||(u.enableWantedList&&(X=K(),w(f,X)),u.enableActiveBountyList&&(G=K(),w(f,G)),G&&v(G,ee),X&&v(X,ee),_(u.enableActiveBountyList,u.enableWantedList))}
//# sourceMappingURL=activeWantedBounties-b0fe9a8e.js.map
