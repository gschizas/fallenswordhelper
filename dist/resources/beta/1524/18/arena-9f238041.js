import{aU as n,I as t,l as a,s as e,aV as s,d as r,v as o,n as c,w as i,S as f,aW as l,aX as d}from"./calfSystem-4197cc22.js"
import{i as u}from"./isArray-32682e84.js"
import{s as m}from"./setTipped-c0d7f504.js"
import{c as p}from"./currentGuildId-2aaee988.js"
import{i as v}from"./intValue-202eff7d.js"
import{s as h,g as b}from"./idb-f3252f63.js"
import{a as g}from"./allthen-634cf4ca.js"
import{c as y}from"./closestTr-3be0023c.js"
import{l as x,p as L}from"./lvlTests-ef15725a.js"
import{l as M}from"./loadDataTables-cad389d5.js"
import{c as T}from"./changeMinMax-75b72872.js"
import{f as j,a as _,m as k,t as w}from"./assets-fe42a5fe.js"
...
s.forEach(e(Y,p())),s.forEach(e(K,a))}(c),sn(),i.DataTable(w),function(n){$(Z,n).off("click"),n.on("click",Z,nn)}(s),s.on("click",'input.custombutton[type="submit"]',F)}function on(n,a){l("arena.process"),t('#arenaTypeTabs tr[style="display: none;"]').forEach(n=>n.remove()),rn(n,a),d("arena.process")}function cn(){if(i())return
const n=$("#arenaTypeTabs")
1===n.length?g([b(j),b("fsh_arenaFull"),an().catch(()=>({})),M()],e(on,n)):f("arena","Join error screen ?")}var fn=Object.freeze({__proto__:null,default:cn})
export{tn as a,fn as b,cn as i,an as v}
//# sourceMappingURL=arena-9f238041.js.map
