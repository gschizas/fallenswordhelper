import{t,s as e,bj as s,bk as i,w as n,z as o,p as a,o as d,g as c,y as r,x as h,D as l,u as f,M as u,A as p,F as m,i as b,a8 as g}from"./calfSystem-57340987.js"
import"./playerName-8027bacf.js"
import"./fshOpen-5a3828f4.js"
import"./openQuickBuffByName-69b6986b.js"
import"./dataRows-bbabdd56.js"
import{g as k,s as y}from"./idb-c55e2904.js"
import{c as w}from"./createTable-f10ae272.js"
import"./createStyle-1094727e.js"
import{h as j}from"./hideElement-5296bb8b.js"
import{a as L}from"./all-82b4870b.js"
import{e as R}from"./eventHandler5-4b6e79d6.js"
import{t as N}from"./toggleForce-1813ed31.js"
import{s as G}from"./selfIdIs-b8c2cc2a.js"
import{p as v}from"./parseDateAsTimestamp-c9ded138.js"
import{f as x}from"./functionPasses-bc7accc9.js"
import{a as T}from"./addLogColoring-3f6be2ab.js"
import"./searchPlayerHref-0176090b.js"
import{a as H}from"./addGuildLogWidgets-3355c7a7.js"
...
for(let t=1;t<s;t+=2){const s=e.rows[t],i=g(s.cells[1]),n=v(i),o=s.cells[2].innerHTML
if(Y(n,o)){W=!1
...
s.className="divider",s.colSpan=3}(t)}function nt(t){t.checked=Q.checks[t.getAttribute("item")]}function ot(){c("input",C).forEach(nt),Z()}function at(t,e){return t[0]-e[0]}function dt(){W&&V.sort(at),r("Loading complete.",F),Q.log=V.filter(e(tt,(new Date).setSeconds(0,0))).map(et),Z(),function(){q=w({id:"fshInjectHere",className:"width_full"}),b(q,'<tbody><tr><td class="header" width="16">&nbsp;</td><td class="header" width="20%">Date</td><td class="header" width="80%">Message</td></tr></tbody>'),V.forEach(it)
...
Q.checks[s]=!Q.checks[s],Z(),V.forEach(e(rt,s,!Q.checks[s]))}function lt(t){t&&t.classList&&t.classList.remove("fshHide")}function ft(t){lt(t[5]),lt(t[6])}function ut(){Q.checks=M.slice(0),ot(),V.forEach(ft)}function pt(t){j(t[5]),j(t[6])}function mt(){Q.checks=O.slice(0),ot(),V.forEach(pt)}function bt(){Q.log=!1,Z(),r("Loading Page 1 ...",F),V=[],W=!0,o("",h("fshInjectHere")),P(1).then(ct)}function gt(t){!function(t){Q=t||Q,Q.checks=Q.checks||M.slice(0)}(t),o(D,a),C=h("fshNewGuildLog"),F=h("fshOutput"),d(C,R([[t=>"INPUT"===t.tagName,ht],[G("fshAll"),ut],[G("fshNone"),mt],[G("rfsh"),bt]])),ot(),$=Number(l("newGuildLogHistoryPages")),_=$,P(1).then(ct)}export default function(){n()||k("fsh_guildLog").then(gt)}
//# sourceMappingURL=newGuildLog-60d1ee8c.js.map
