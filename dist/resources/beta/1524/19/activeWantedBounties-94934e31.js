import{t as e,A as t,M as n,bH as s,D as a,Q as r,W as i,x as o,n as c,a8 as l,c as u,k as d,bT as b,bJ as f,z as p,bV as h,f as m,i as y,u as L,w as g,o as v}from"./calfSystem-57340987.js"
import"./insertElementBefore-69bb0e1f.js"
import{i as w}from"./insertElementAfterBegin-d5ad26ea.js"
import{c as $}from"./createSpan-14d38ba8.js"
import"./csvSplit-356d0548.js"
import{s as x}from"./shouldBeArray-2512cd9c.js"
import{f as N}from"./functionPasses-bc7accc9.js"
...
function K(){return d({className:"minibox"})}function Q(){f("bountyList",T),p("",G)
...
var n
y(G,t)}function V(){f("wantedList",B),p("",X)
...
function _(e,t){T=s("bountyList"),B=s("wantedList"),W=a("bountyListRefreshTime"),M=a("bwNeedsRefresh"),M||C()&&(M=!0),Z.some(N)?(B={},B.bounty=[],B.isRefreshed=!0,B.lastUpdate=r,j=!1,S=x("wantedNames"),i("bwNeedsRefresh",!1),R(1).then(Y)):function(e,t){t&&(B.isRefreshed=!1,V()),e&&(T.isRefreshed=!1,Q())}(e,t)}function ee(e){e.target===q&&(f("bountyList",null),_(u.enableActiveBountyList,u.enableWantedList)),e.target===z&&(f("wantedList",null),_(u.enableActiveBountyList,u.enableWantedList))}export default function(){g()||(u.enableWantedList&&(X=K(),w(b,X)),u.enableActiveBountyList&&(G=K(),w(b,G)),G&&v(G,ee),X&&v(X,ee),_(u.enableActiveBountyList,u.enableWantedList))}
//# sourceMappingURL=activeWantedBounties-94934e31.js.map
