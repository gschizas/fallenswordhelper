import{u as t,v as e,C as n,M as i,G as r,ai as a,bl as s,m as l,bm as c,bn as d,A as o,p as u,t as m,ap as h,ao as f,bo as p}from"./calfSystem-d3aab5a8.js"
import{d as b}from"./dataRows-87814179.js"
import{p as $}from"./padZ-0c2f5370.js"
import"./closest-8d8d60b3.js"
import{c as v}from"./closestTable-303539be.js"
import"./all-3791b7d5.js"
import{s as N}from"./splitTime-10e4bfd4.js"
import{a as j}from"./allthen-ad810e11.js"
import{t as g}from"./textNodes-512be06d.js"
...
if(n)return n.value}return""}function k(t){return`<tr><td>${t.min_level}</td><td>${function(t){return`<a href="${h}relics${f}view&relic_id=${t.id}">`+t.name+"</a>"}(t)}</td><td>${n=t.guild,n?`<a href="${p}${n.id}">${n.name}</a>`:""}</td><td>${e=t.attributes,[6,0,4,5,7,8].map(m(S,e)).join("</td><td>")}</td><td>${function(t){if(!t)return""
const e=N(t)
return`${$(e[0])}d ${$(e[1])}h ${$(e[2])}m ${$(e[3])}s`}(t.time)}</td></tr>`
var e,n}function A(t){t.sort((t,e)=>t.min_level-e.min_level),o(function(t){return`<style>#pCC .reliclist {\n        border-collapse: collapse;\n        border-spacing: 0;\n        table-layout: fixed;\n      }\n      .reliclist, .reliclist th, .reliclist td {\n        border: 1px solid black;\n      }\n      .reliclist th, .reliclist td {\n        padding: 5px;\n      }\n      .reliclist th:nth-of-type(10), .reliclist td:nth-of-type(10) {\n        width: 100px;\n      }</style><table class="reliclist"><thead><tr><th>Level</th><th>Name</th><th>Guild</th><th>Stam<br>Gain</th><th>Atk</th><th>Dmg</th><th>Stam</th><th>Gold<br>Gain</th><th>XP<br>Gain</th><th>Time</th></tr></thead><tbody>${t.filter(L).map(k).join("")}</tbody></table>`}(t),u)}function M(){o("Loading...",u),y(0).then(C).then(A)}export default M
//# sourceMappingURL=reliclist-7d2b6e87.js.map
