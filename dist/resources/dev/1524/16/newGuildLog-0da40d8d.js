import{t,s as e,bm as s,bn as n,w as i,z as a,p as o,o as d,g as c,y as r,x as h,D as l,u as f,N as u,A as p,F as m,i as g,a4 as b}from"./calfSystem-d49dbbd3.js"
import"./playerName-7c21a13e.js"
import"./fshOpen-61afeb3b.js"
import"./openQuickBuffByName-b2ea945d.js"
import"./dataRows-9b520c39.js"
import{g as k,s as y}from"./idb-a6d1a1ba.js"
import{c as w}from"./createTable-86f16c48.js"
import"./createStyle-83a7b946.js"
import{h as j}from"./hideElement-a25240d4.js"
import{a as L}from"./all-042a202c.js"
import{e as R}from"./eventHandler5-53fd70b2.js"
import{t as N}from"./toggleForce-c06db9a6.js"
import{s as G}from"./selfIdIs-5871022d.js"
import{p as v}from"./parseDateAsTimestamp-526fc279.js"
import{f as x}from"./functionPasses-4019d9f5.js"
import{a as T}from"./addLogColoring-271cf857.js"
import"./searchPlayerHref-a9b861f6.js"
import{a as H}from"./addGuildLogWidgets-59626bd7.js"
...
for(let t=1;t<s;t+=2){const s=e.rows[t],n=b(s.cells[1]),i=v(n),a=s.cells[2].innerHTML
if(Y(i,a)){W=!1
break}V.push([100*z+t,i,n,a,E(a)])}}(t)}function K(t){!function(t){B=f(t)
...
s.className="divider",s.colSpan=3}(t)}function it(t){t.checked=Q.checks[t.getAttribute("item")]}function at(){c("input",F).forEach(it),Z()}function ot(t,e){return t[0]-e[0]}function dt(){W&&V.sort(ot),r("Loading complete.",M),Q.log=V.filter(e(tt,(new Date).setSeconds(0,0))).map(et),Z(),function(){q=w({id:"fshInjectHere",className:"width_full"}),g(q,'<tbody><tr><td class="header" width="16">&nbsp;</td><td class="header" width="20%">Date</td><td class="header" width="80%">Message</td></tr></tbody>'),V.forEach(nt)
const t=h("fshInjectHere")
o.replaceChild(q,t),T("myGuildLog",1),H()}()}function ct(t){K(t),function(){const t=[]
...
Q.checks[s]=!Q.checks[s],Z(),V.forEach(e(rt,s,!Q.checks[s]))}function lt(t){t&&t.classList&&t.classList.remove("fshHide")}function ft(t){lt(t[5]),lt(t[6])}function ut(){Q.checks=O.slice(0),at(),V.forEach(ft)}function pt(t){j(t[5]),j(t[6])}function mt(){Q.checks=C.slice(0),at(),V.forEach(pt)}function gt(){Q.log=!1,Z(),r("Loading Page 1 ...",M),V=[],W=!0,a("",h("fshInjectHere")),P(1).then(ct)}function bt(t){!function(t){Q=t||Q,Q.checks=Q.checks||O.slice(0)}(t),a(D,o),F=h("fshNewGuildLog"),M=h("fshOutput"),d(F,R([[t=>"INPUT"===t.tagName,ht],[G("fshAll"),ut],[G("fshNone"),mt],[G("rfsh"),gt]])),at(),$=Number(l("newGuildLogHistoryPages")),_=$,P(1).then(ct)}export default function(){i()||k("fsh_guildLog").then(bt)}
//# sourceMappingURL=newGuildLog-0da40d8d.js.map
