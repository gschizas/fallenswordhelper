import{t as e,A as t,N as n,bJ as s,D as r,R as i,X as a,x as o,n as c,a4 as l,c as u,k as d,bV as b,bL as f,z as p,bX as h,f as m,i as y,u as L,w as g,o as v}from"./calfSystem-d49dbbd3.js"
import"./insertElementBefore-5eb6d41d.js"
import{i as w}from"./insertElementAfterBegin-cc62b549.js"
import{c as $}from"./createSpan-d12a564e.js"
import"./csvSplit-0254185d.js"
import{s as N}from"./shouldBeArray-b6d52cfc.js"
...
function _(e,t){B=s("bountyList"),T=s("wantedList"),S=r("bountyListRefreshTime"),W=r("bwNeedsRefresh"),W||E()&&(W=!0),Z.some(x)?(T={},T.bounty=[],T.isRefreshed=!0,T.lastUpdate=i,j=!1,M=N("wantedNames"),a("bwNeedsRefresh",!1),R(1).then(Y)):function(e,t){t&&(T.isRefreshed=!1,F()),e&&(B.isRefreshed=!1,V())}(e,t)}function ee(e){e.target===q&&(f("bountyList",null),_(u.enableActiveBountyList,u.enableWantedList)),e.target===z&&(f("wantedList",null),_(u.enableActiveBountyList,u.enableWantedList))}export default function(){g()||(u.enableWantedList&&(G=K(),w(b,G)),u.enableActiveBountyList&&(O=K(),w(b,O)),O&&v(O,ee),G&&v(G,ee),_(u.enableActiveBountyList,u.enableWantedList))}
//# sourceMappingURL=activeWantedBounties-d93e5bd5.js.map
