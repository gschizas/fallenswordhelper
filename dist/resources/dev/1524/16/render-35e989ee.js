import{s as t,D as n,au as s,c as e,T as o,b as a,p as f,A as u,z as c,x as r,l as i}from"./calfSystem-d49dbbd3.js"
import{r as l}from"./roundToString-263aa927.js"
import{p}from"./playerName-7c21a13e.js"
import{t as b}from"./toLowerCase-e686322a.js"
...
function B(t){return t&&"BR"!==t.nodeName}function T(t){return b(t.replace($,"")).match(w)}function S(t){let n=function(t){let n="",s=t
for(;B(s);){const t=u(s)
s=s.nextSibling,n+=t}return T(n)}(t)
return n||(n=function(t){let n="",s=t
for(;B(s);){const t=u(s)
s=s.previousSibling,n=t+n}return T(n)}(t)),n}const C={count:0,buffs:{}}
...
//# sourceMappingURL=render-35e989ee.js.map
