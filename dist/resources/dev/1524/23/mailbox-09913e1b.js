import{w as t,x as n,g as e,p as i,O as s,t as a,k as c,m as o,h as r,o as f,e as d,l as u,A as m,P as l,y as p}from"./calfSystem-9901ad27.js"
import{c as h}from"./createInput-49d3d974.js"
import{c as k}from"./createLabel-f12268f8.js"
import{i as b}from"./insertElementBefore-f1fdb06b.js"
import{c as g}from"./createUl-850a409c.js"
import{c as v}from"./chunk-3dd35605.js"
import{j as T,o as j}from"./jsonFail-0213f3b5.js"
...
n&&m("",n)}function M(t,n){T(n,t)||l(n.r)&&function(t,n){n.r.forEach(L),j(n.r.length.toString()+" item(s) taken.",t)}(t,n)}function q(t,n){x(n).then(a(M,t))}function B(t,n,e){u("fshBls",e.target)&&function(t,n,e){const i=e.dataset.id,{invIds:s}=t[i]
...
!function(t,n){d(n).forEach(a(I,t))}(i,t),r(n,i),f(i,a(B,t,e))}function C(t){const n=o({id:"quickTake",innerHTML:'<div class="fshCenter"><br><font size="3"><b>Quick Take</b></font><br><br>Select which item to take all similar items from your Mailbox.</div><div></div>'}),e=function(t){const n=o(),e=g()
...
b(e,n),s(e,"change",a(H,t,n))}(t,c),y("qtOff","Quick Take",c)}
//# sourceMappingURL=mailbox-09913e1b.js.map
