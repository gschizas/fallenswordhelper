import{o as t,bS as n,b as e,p as o,t as a,c2 as r,A as i,aH as s,V as c,bg as u,b7 as p,m as l,au as f,O as d,h as m,n as b,f as g,a as h,e as y,z as M,i as j,q as L,a3 as x,ab as C,B as v,c as I,a2 as $,Q as H,D as N,a4 as S,ba as T,x as R}from"./calfSystem-9901ad27.js"
import"./numberIsNaN-cb2409eb.js"
import"./toLowerCase-dda30e6b.js"
import{c as k}from"./createInput-49d3d974.js"
import{t as w}from"./testRange-6fc07a5c.js"
import{o as E}from"./onlineDot-b29de868.js"
import{b as A}from"./batch-e74a5e93.js"
import"./currentGuildId-86da8be9.js"
import{g as B,s as D}from"./idb-efff97cf.js"
import{i as G}from"./isChecked-8ee9db43.js"
import{a as F}from"./alpha-ec0cb412.js"
import{c as W}from"./createTable-cf4fb3e8.js"
...
import{e as P}from"./eventHandler5-58472375.js"
import{s as _}from"./selfIdIs-3f743d27.js"
import"./dialog-2e17f157.js"
import{e as q}from"./useItem-7736a870.js"
import"./guild-1d87405d.js"
import{c as J}from"./createSelect-11d681f4.js"
import{g as Q}from"./getMembrList-42ade563.js"
import{a as z}from"./queue-6f9fbf9c.js"
import"./guildInventory-14f039c1.js"
import{c as O}from"./createTr-6759a4ff.js"
...
return Ht(n,"fshIgnoreAll","Ignore All"),j(n.cells[1],"&nbsp;"),Ht(n,"fshReset","Reset"),m(t.tBodies[0],n),0}function St(t,n){if("SELECT"===n.target.tagName){const e=n.target,{value:o}=e
i("",e),m(e,Ct("Ignore")),y(t).forEach(a(vt,e)),e.value=o}}function Tt(t){c("potReport","drawMapping")
const n=W({innerHTML:"<tbody></tbody>"})
ht.replaceChild(n,ht.children[0]),g(ht,"mousedown",a(St,t.myMap)),h(3,A,[[5,3,y(t.myMap),0,a($t,n),a(Nt,n)]])}const Rt="fsh_potMap",kt={pottab1:!1,pottab2:!1,pottab3:!1,myMap:{},minpoint:12,maxpoint:20}
function wt(t,n){t.myMap[n]||(t.myMap[n]=n)}function Et(t,n,e){"SELECT"===e.target.tagName&&(t.myMap[e.target.name]=e.target.value,D(Rt,t),Lt(t,n))}function At(t,n,e){return n[e]=t?"Ignore":e,n}function Bt(t,n,e){!function(t,n,e){t.myMap=f(n).reduce(a(At,e),{})}(t,n,e),D(Rt,t),Tt(t),Lt(t,n)}function Dt(t){return/^pottab\d$/.test(t.id)}function Gt(t,n){t[n.id]=n.checked,D(Rt,t)}function Ft(t,n,e){const o=e.target.id,a=w(e.target.value,0,999)
a&&(t[o]=a,D(Rt,t),Lt(t,n))}function Wt(n,e,o){g(o,"change",a(Et,n,e)),t(o,P(function(t,n){return[[_("fshIgnoreAll"),a(Bt,t,n,!0)],[_("fshReset"),a(Bt,t,n,null)],[Dt,a(Gt,t)]]}(n,e))),g(o,"input",a(Ft,n,e))}function Pt(t,n){const e=function(t){return l({id:"potReport",innerHTML:`<input id="pottab1" type="checkbox"${G(t.pottab1)}><label for="pottab1">Composed Potion Inventory</label><input id="pottab2" type="checkbox"${G(t.pottab2)}><label for="pottab2">Mapping</label><input id="pottab3" type="checkbox"${G(t.pottab3)}><label for="pottab3">Thresholds</label>`})}(t),r=l({id:"panels"})
...
L(e,x(n,{})),e.myMap=function(t,n){return f(n).forEach(a(wt,t)),bt(t.myMap)}(e,t),D(Rt,e),Pt(e,t)}function qt(t){B(Rt).then(a(_t,t))}let Jt,Qt,zt,Ot,Ut
...
if(!N('#pCC table table td[bgcolor="#DAA534"] b').some(S(Ot)))return
const t=C("#pCC table table tr")
A([5,2,t,0,nn])}function on(){h(3,tn)}export default function(){R()||(Q(!1).then(on),h(2,en),h(3,Xt),t(e("table",o)[1],n(et)))}
//# sourceMappingURL=guildReport-4aec0cd8.js.map
