import{u as e,B as t,C as n,bE as s,G as a,T as r,Z as i,y as o,q as c,K as l,c as u,m as d,bQ as b,bG as f,A as p,bT as h,h as m,i as y,v as L,x as g,o as v}from"./calfSystem-9901ad27.js"
import"./insertElementBefore-f1fdb06b.js"
import{i as $}from"./insertElementAfterBegin-52f072be.js"
import{c as w}from"./createSpan-b27bc4d5.js"
import"./csvSplit-4ba7a6af.js"
import{s as x}from"./shouldBeArray-8c69684a.js"
...
function _(e,t){A=s("bountyList"),B=s("wantedList"),S=a("bountyListRefreshTime"),W=a("bwNeedsRefresh"),W||P()&&(W=!0),Y.some(N)?(B={},B.bounty=[],B.isRefreshed=!0,B.lastUpdate=r,j=!1,C=x("wantedNames"),i("bwNeedsRefresh",!1),R(1).then(V)):function(e,t){t&&(B.isRefreshed=!1,F()),e&&(A.isRefreshed=!1,D())}(e,t)}function ee(e){e.target===K&&(f("bountyList",null),_(u.enableActiveBountyList,u.enableWantedList)),e.target===X&&(f("wantedList",null),_(u.enableActiveBountyList,u.enableWantedList))}export default function(){g()||(u.enableWantedList&&(q=z(),$(b,q)),u.enableActiveBountyList&&(O=z(),$(b,O)),O&&v(O,ee),q&&v(q,ee),_(u.enableActiveBountyList,u.enableWantedList))}
//# sourceMappingURL=activeWantedBounties-ba6246f3.js.map
