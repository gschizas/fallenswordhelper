import{au as e,t as n,H as t,bm as a,a7 as s,a3 as l,Z as i,aW as r,x as o,o as f,f as u,v as c}from"./calfSystem-4991bf5b.js"
import{n as h}from"./numberIsNaN-a6bcb044.js"
import{c as d}from"./currentGuildId-56c2c861.js"
import{i as p}from"./intValue-e4cdd281.js"
import"./valueText-4b5d9d8a.js"
import{a as v,g as m}from"./levelHighlight-37db953e.js"
import{g,s as b}from"./idb-ee31c042.js"
import{l as y,p as M}from"./lvlTests-72fd69e8.js"
import"./all-646b32fa.js"
import{l as L}from"./loadDataTables-1b111eb0.js"
import{o as x}from"./onlinePlayersPage-fb7ebead.js"
...
$('#pCC img[src$="/world/icon_action_view.png',e).parent().parent().parent().each(n(S,a))}(t,a),H+=1,1===H&&W(V,a),H===z&&(b("fsh_onlinePlayers",D),G(D))}function Z(e){"fshRefresh"===e.target.id&&($("#fshRefresh",_).hide(),H=0,D={},x(1).then(V),i("lastOnlineCheck",s),A("Parsing online players...")),"fshReset"===e.target.id&&function(e){i("onlinePlayerMinLvl",r.onlinePlayerMinLvl),i("onlinePlayerMaxLvl",r.onlinePlayerMaxLvl),$("#fshMinLvl",e).val(r.onlinePlayerMinLvl),$("#fshMaxLvl",e).val(r.onlinePlayerMaxLvl),O()}(_)}function B(){_.html(`<span><b>Online Players</b></span>${function(){const e=t("lastOnlineCheck")
return s-e>3e5?'<span> (takes a while to refresh so only do it if you really need to) </span><span id="fshRefresh" class="fshLink">[Refresh]</span>':`<span>[ Wait ${Math.round(300-(s-e)/1e3)}s ]</span>`}()}<div id="fshOutput"></div>`),g("fsh_onlinePlayers").then(G),f(_[0],Z),u(_[0],"keyup",k)}function E(e){o()||(_=e?$(e):$("#pCC"),L().then(B))}export default E
//# sourceMappingURL=injectOnlinePlayers-52c71b66.js.map
