...
o.slice().forEach(n=>{n.call(t,s)})}}}const K=[],X=[],Z=[],tt=[],nt=Promise.resolve()
let et=!1
function ot(t){Z.push(t)}let st=!1
const it=new Set
function rt(){if(!st){st=!0
do{for(let t=0;t<K.length;t+=1){const n=K[t]
Y(n),ct(n.$$)}for(Y(null),K.length=0;X.length;)X.pop()()
for(let t=0;t<Z.length;t+=1){const n=Z[t]
it.has(n)||(it.add(n),n())}Z.length=0}while(K.length)
...
return{c(){e=F("["),o=G("button"),s=F(h),i=F(" AH and UFSG Links"),r=F("] \n["),c=G("button"),a=F(p),u=F(" Quick Drop links"),l=F("] \n"),k&&k.c(),f=F(""),P(o,"class","svelte-hnk7js"),P(c,"class","svelte-hnk7js")},m(t,h){B(t,e,h),B(t,o,h),O(o,s),O(o,i),B(t,r,h),B(t,c,h),O(c,a),O(c,u),B(t,l,h),k&&k.m(t,h),B(t,f,h),d||(m=[q(o,"click",n[3]),q(c,"click",n[4])],d=!0)},p(n,[e]){1&e&&h!==(h=n[2](n[0])+"")&&z(s,h),2&e&&p!==(p=n[2](n[1])+"")&&z(a,p),"storeitems"===t.subcmd2&&k.p(n,e)},i:N,o:N,d(t){t&&R(e),t&&R(o),t&&R(r),t&&R(c),t&&R(l),k&&k.d(t),t&&R(f),d=!1,C(m)}}}function xt(t,n,e){const o=J()
...
if(!A())return
const t=Et.map(t=>$(t))
x(),Ht(t),t.some(t=>t)&&It(t),b(w,wt)}export{ft as S,B as a,O as b,z as c,R as d,G as e,M as f,P as g,V as h,lt as i,U as j,J as k,q as l,ot as m,N as n,W as o,mt as p,dt as q,C as r,H as s,F as t,A as u,Ot as v,kt as w,ht as x}
//# sourceMappingURL=injectStoreItems-6e6389c8.js.map
