import{e,aV as t,D as n,bb as s,bc as a,E as o,C as r,z as i,bd as c,G as f,i as l,w as u,U as m,t as p,aU as d,be as h,a6 as g,h as b,m as y,B as j,o as w,bf as C,H as _,M as P,a7 as v,bg as k,_ as $,x as L}from"./calfSystem-ec5e5725.js"
import"./playerName-6b140f29.js"
import{t as T}from"./toLowerCase-33399b5a.js"
import{a as B}from"./addCommas-e12eda5f.js"
import{c as E}from"./createStyle-bbf14939.js"
import{c as x}from"./currentGuildId-4732beaa.js"
import"./fshOpen-da9a149e.js"
import{o as G}from"./openQuickBuffByName-9db0dd32.js"
import"./dataRows-fa0ec70c.js"
import{g as R,s as S}from"./idb-cecca562.js"
...
import{p as Y}from"./parseDateAsTimestamp-2287985e.js"
import{b as D}from"./buffObj-fc2481d9.js"
import"./getProfile-4986c8b9.js"
import{m as H}from"./myStats-4fed9202.js"
import{c as N}from"./closestTd-a8dbddf9.js"
import{g as z}from"./getMembrList-1882a728.js"
import"./doBuffLinkClick-9be045fd.js"
import{a as O}from"./addLogColoring-c76c33db.js"
let Q
async function U(n){return x()&&!Q&&(Q=async function(){return e(await z(!1)).filter(([,e])=>t(e)).map(([e])=>e)}()),(await Q).includes(n)}const J=e=>[e,s(e.href,"target_username")],V=async([e,t])=>[e,t,await U(t)]
function W([e,t]){M(e,` | <a href="${a}${t}">Attack</a>`)}function X(e){return`<a href="${c}${f(e)}" data-tooltip="Add to Ignore List">Ignore</a>`}function q([e,,t]){i("Report",t),M(t," | "+X(e))}function F([e,t]){l(t.cells[1].children[0],`<font size="1"><br>[ ${X(e)} ]</font>`)}function K(e){return function(e){return u({cmd:"combat",subcmd:"view",combat_id:e})}(e)}let Z,ee
...
const n=f(e),[s,a,o]=await Promise.all([U(n),de(n),he(n)])
...
t&&l(t,'&nbsp;&nbsp;<span class="fshWhite">(Guild mates show up in <span class="fshGreen">green</span>)</span>')}(t),t.classList.add("fshPlayerColoring"),b(document.body,E(s.join("\n"))))}const _e=e=>(e=>P(N(e).childNodes))(e).map(f)
function Pe(e,t){return(e=>r(C,A(e)))(e)&&("Buff"===t||"Reply"===t&&_("enableChatParsing"))}function ve(e){const t=D.find(t=>((e,t)=>I(t.nicks).includes(T(e)))(e,t))
...
if(!t.length)return
const s=t.map(J);(await Promise.all(s.map(V))).filter(([,,e])=>!e).forEach(W)}],["changeButtonLabels",function(e){n('a[href*="=trade&"]',e).forEach(e=>i("Trade",e)),n('a[href*="=createsecure&"]',e).forEach(e=>i("ST",e))}],["trackLadderReset",function(e){$e=_(v),n(k,e).map(A).filter(Te).forEach(Be)}],["showPvPSummaryInLog",async function(e){const t=n('a[href*="&combat_id="]',e)
...
function xe(e,t){_(t[0])&&t[1](e)}function Ge(e){!function(e){w(e,ke)}(e),Ee.forEach(p(xe,e))}function Re(){O("PlayerLog",1),function(){if(L())return
const e=r("#pCC > table:last-of-type")
e&&Ge(e)}()}export default Re
//# sourceMappingURL=playerLog-d96851b2.js.map
