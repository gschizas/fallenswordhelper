import{av as e,t as n,H as t,bm as a,a8 as s,a4 as l,_ as i,aW as r,x as o,o as f,f as c,v as u}from"./calfSystem-ec5e5725.js"
import{n as h}from"./numberIsNaN-871eca26.js"
import{c as d}from"./currentGuildId-4732beaa.js"
import{i as p}from"./intValue-ef353ded.js"
import"./valueText-f1c6f878.js"
import{a as v,g as m}from"./levelHighlight-ec2201dc.js"
import{g,s as y}from"./idb-cecca562.js"
import{l as M,p as L}from"./lvlTests-62ab81b3.js"
import"./all-e81516b4.js"
import{l as x}from"./loadDataTables-4279f9f3.js"
import{o as P}from"./onlinePlayersPage-71fc5e06.js"
...
for(let n=2;n<=z;n+=1)P(n).then(e)}function A(e){$("#fshOutput",_).append(e)}function V(e){A(" "+(H+1))
const t=u(e),a=$("#pCC input.custominput",t).first()
!function(e,t){const a=t.attr("value")
$('#pCC img[src$="/world/icon_action_view.png',e).parent().parent().parent().each(n(S,a))}(t,a),H+=1,1===H&&W(V,a),H===z&&(y("fsh_onlinePlayers",D),G(D))}function B(e){"fshRefresh"===e.target.id&&($("#fshRefresh",_).hide(),H=0,D={},P(1).then(V),i("lastOnlineCheck",s),A("Parsing online players...")),"fshReset"===e.target.id&&function(e){i("onlinePlayerMinLvl",r.onlinePlayerMinLvl),i("onlinePlayerMaxLvl",r.onlinePlayerMaxLvl),$("#fshMinLvl",e).val(r.onlinePlayerMinLvl),$("#fshMaxLvl",e).val(r.onlinePlayerMaxLvl),O()}(_)}function E(){_.html(`<span><b>Online Players</b></span>${function(){const e=t("lastOnlineCheck")
return s-e>3e5?'<span> (takes a while to refresh so only do it if you really need to) </span><span id="fshRefresh" class="fshLink">[Refresh]</span>':`<span>[ Wait ${Math.round(300-(s-e)/1e3)}s ]</span>`}()}<div id="fshOutput"></div>`),g("fsh_onlinePlayers").then(G),f(_[0],B),c(_[0],"keyup",k)}function F(e){o()||(_=e?$(e):$("#pCC"),x().then(E))}export default F
//# sourceMappingURL=injectOnlinePlayers-aeabed0e.js.map
