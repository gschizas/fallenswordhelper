import{M as o,t as n,o as t,a4 as e,y as c,f as r,_ as a,ak as f}from"./calfSystem-ec5e5725.js"
...
u[c]=e(u[c],{})
const r=u[c]
r.rows=r.rows||[],b(n,t,r,o)}function j(o){o.header.classList.toggle("fshPoint")}function L(o){h=!h,a(o,h),h?l():u.forEach(x),u.forEach(j)}function k(e){d=e.headInd,function(o){const t=c(o)
h=t.checked,r(c(o),"change",n(L,o))}(e.prefName),o(e.theTable.rows).forEach(n(N,e)),t(e.theTable,T)}export{k as c}
//# sourceMappingURL=collapse-bcde20c9.js.map
