import{t,s as e,bm as s,bn as n,w as i,z as o,p as a,o as d,g as c,y as r,x as h,D as l,u as f,N as u,A as p,F as m,i as g,a4 as b}from"./calfSystem-f7574730.js"
import"./playerName-b7a62fcc.js"
import"./fshOpen-da8138fa.js"
import"./openQuickBuffByName-811c9a22.js"
import"./dataRows-2e6b99d7.js"
import{g as k,s as y}from"./idb-14a57c5b.js"
import{c as w}from"./createTable-61b1bd32.js"
import"./createStyle-d4675aa6.js"
import{h as j}from"./hideElement-8a032490.js"
import{a as L}from"./all-d5952527.js"
import{e as R}from"./eventHandler5-76337fed.js"
import{t as N}from"./toggleForce-253de8c7.js"
import{s as G}from"./selfIdIs-c6f2e263.js"
import{p as v}from"./parseDateAsTimestamp-e4ec080f.js"
import{f as x}from"./functionPasses-cbddd5c3.js"
import{a as T}from"./addLogColoring-5f4631ad.js"
import"./searchPlayerHref-7131878b.js"
import{a as H}from"./addGuildLogWidgets-d6c1d407.js"
...
for(let t=1;t<s;t+=2){const s=e.rows[t],n=b(s.cells[1]),i=v(n),o=s.cells[2].innerHTML
if(Y(i,o)){W=!1
break}V.push([100*z+t,i,n,o,E(o)])}}(t)}function K(t){!function(t){B=f(t)
...
s.className="divider",s.colSpan=3}(t)}function it(t){t.checked=Q.checks[t.getAttribute("item")]}function ot(){c("input",F).forEach(it),Z()}function at(t,e){return t[0]-e[0]}function dt(){W&&V.sort(at),r("Loading complete.",M),Q.log=V.filter(e(tt,(new Date).setSeconds(0,0))).map(et),Z(),function(){q=w({id:"fshInjectHere",className:"width_full"}),g(q,'<tbody><tr><td class="header" width="16">&nbsp;</td><td class="header" width="20%">Date</td><td class="header" width="80%">Message</td></tr></tbody>'),V.forEach(nt)
...
Q.checks[s]=!Q.checks[s],Z(),V.forEach(e(rt,s,!Q.checks[s]))}function lt(t){t&&t.classList&&t.classList.remove("fshHide")}function ft(t){lt(t[5]),lt(t[6])}function ut(){Q.checks=O.slice(0),ot(),V.forEach(ft)}function pt(t){j(t[5]),j(t[6])}function mt(){Q.checks=C.slice(0),ot(),V.forEach(pt)}function gt(){Q.log=!1,Z(),r("Loading Page 1 ...",M),V=[],W=!0,o("",h("fshInjectHere")),P(1).then(ct)}function bt(t){!function(t){Q=t||Q,Q.checks=Q.checks||O.slice(0)}(t),o(D,a),F=h("fshNewGuildLog"),M=h("fshOutput"),d(F,R([[t=>"INPUT"===t.tagName,ht],[G("fshAll"),ut],[G("fshNone"),mt],[G("rfsh"),gt]])),ot(),$=Number(l("newGuildLogHistoryPages")),_=$,P(1).then(ct)}export default function(){i()||k("fsh_guildLog").then(bt)}
//# sourceMappingURL=newGuildLog-7a80e045.js.map
