import{q as e,z as t,s as n,aG as s,ab as o,X as a,bP as i,N as c,k as r,L as l,T as m,i as p,a2 as u,I as f,f as d,o as g,p as b,y as h,c as v,bQ as C,A as S,a7 as k,j as E,D as N,x as j,F as x}from"./calfSystem-f7574730.js"
import{c as y}from"./createInput-ca63b3fd.js"
import{i as A}from"./insertElementBefore-b5c9c232.js"
import{c as L}from"./createTable-61b1bd32.js"
import{p as q,a as I}from"./pubsub-b293c9c1.js"
import{g as B}from"./getArrayByClassName-6077b562.js"
import{r as F,g as T}from"./rnd-88e9f32d.js"
import{i as $}from"./insertHtmlAfterEnd-38a30874.js"
import{i as P}from"./insertElementAfter-3b34b5ac.js"
...
return 0===s&&h(e[1],t.insertCell(-1)),d(t.insertCell(-1),(o=(s+1).toString(),a=e[0],y({className:"awesome orange",dataset:{templateId:a},type:"button",value:o}))),t}function X(e,t,s,o){return e.reduce(n(R,o),s.insertRow(-1)),s}function J(e){return[e.value,e.text]}function K(e,t,s){const o=function(e,t,s){const o=L({id:"fshFastCompose"})
return G(o,s),e.reduce(n(X,t,s),o)}(f("#composing-template-multi option").map(J),t,s)
d(e,o),g(b,M),I("quickcreate",n(H,o))}function O(e){m("composing","FastCompose"),p(e,"<br>")
...
0===t?W(!0):(W(!1),a(C,t))}(),f("input[id^=create-]:not(#create-multi)",b).forEach(Y),g(b,Z),function(){if(N("moveComposingButtons")){const e=j("composing-error-dialog").previousElementSibling
...
//# sourceMappingURL=composing-52a7655d.js.map
