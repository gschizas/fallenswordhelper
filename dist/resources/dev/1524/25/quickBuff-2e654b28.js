import{C as t,A as n,b as e,B as s,D as a,t as i,y as f,Q as r,R as c,x as u,o}from"./calfSystem-69dd5601.js"
...
import{i as h}from"./insertElementAfter-85b48585.js"
import{o as p}from"./outputFormat-c14ae873.js"
import"./splitTime-10e4bfd4.js"
import{f as k}from"./formatLastActivity-9d747fef.js"
import{g as q}from"./getProfile-6a2bd83d.js"
import{d as y,q as E}from"./quickbuffSuccess-404521b3.js"
...
!function(t,n){return!t&&n}(n,t)?n&&r(n):setTimeout(H,100,t-1)}function L(){f("targetPlayers").value&&H(9)}function N(t){return`<span class="fshLime">On</span>&nbsp;<span class="fshBuffOn">(${function(t){const n=Math.floor(t/60),e=t%60
let s=p(n,"m")
...
function Q(){P.length?(window.addPlayer(P.shift()),setTimeout(Q,200)):L()}function I(t,e){E(e)&&(t.className="fshLime",n("On",t))}function J(t){const n=t.target
...
//# sourceMappingURL=quickBuff-2e654b28.js.map
