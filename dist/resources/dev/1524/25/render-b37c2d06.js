import{t,H as n,au as s,c as e,V as o,b as f,p as u,B as a,l as c,A as r,y as i,e as l}from"./calfSystem-69dd5601.js"
import{r as p}from"./roundToString-57efc303.js"
...
let s,e
n?(s=function(t){return t[0].includes("k")?"k":t[0].includes("f")?"fsp":"stam"}(n),[e]=n[0].match(/([+-]?[.\d]+)/)):(s="unknown",e="1"),j.buffs[a(t)]=[parseFloat(e),s],j.count+=1}(t):(j.count-=1,delete j.buffs[s]),j.count>0?L():(r("&nbsp;",i("buffCost")),j.buffCostTotalText="")}function v(t){return t.tagName&&"SPAN"!==t.tagName?v(t.parentNode):t}function A(t){if("fshSendBuffMsg"===t.target.id)return void function(t){t.count>0&&$(t)}(j)
...
//# sourceMappingURL=render-b37c2d06.js.map
