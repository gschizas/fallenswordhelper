import{q as t,aH as s,au as e,m as a,ak as n,c as r,j as o,p as i,A as c,y as f,o as h,t as l,k as d}from"./calfSystem-a2862afc.js"
import"./toLowerCase-2574a84c.js"
import{a as u}from"./addCommas-f02ec3aa.js"
import{g as m,s as p}from"./idb-911ff7c2.js"
import"./alpha-557396ad.js"
import{d as g}from"./doSortParams-f635a020.js"
import{p as y,s as C,a as b}from"./stringSort-a5841eee.js"
...
return s+=a(t).map(k).join("<br>"),s+"</span>"}return'<span class="fshGrey">**Missing**</span>'}function L(e,a){return t(e[a],{name:a,image:(n=e[a].image_id,`<img class="tip-static" src="${s}creatures/${n}.png" data-tipped="<img src='${s}creatures/${n}.png' width=200 height=200>" width=40 height=40>`),level:u(e[a].level),attack:$(e[a].attack),defense:$(e[a].defense),armor:$(e[a].armor),damage:$(e[a].damage),hp:$(e[a].hp),enhancements:j(e[a].enhancements)})
