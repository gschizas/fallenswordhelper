import{G as t,b7 as e,A as n,y as i,g as r,v as s,i as a,t as o,B as c,bB as d,aB as p,I as u,l as f,f as m,u as h,x as l,o as g,p as b}from"./calfSystem-a2862afc.js"
import"./toLowerCase-2574a84c.js"
import{s as $,g as v}from"./idb-911ff7c2.js"
import"./alpha-557396ad.js"
import"./csvSplit-f4c1f44b.js"
import{s as x}from"./shouldBeArray-8e5331f1.js"
import{d as _}from"./doSortParams-f635a020.js"
import{a as y}from"./stringSort-a5841eee.js"
import{a as N}from"./all-6bd68ac2.js"
let j,k=[]
function w(t){return`<div class="rmItem"><img class="tip-dynamic" data-tipped="fetchitem.php?item_id=${t.id}&inv_id=-1&t=2&p=${j}&vcode=${t.verify}" src="${t.img}" height="20px" width="20px"><p>${t.amountPresent}/${t.amountNeeded}</p></div>`}function C(t){return`<div class="rmItem"><img class="tip-dynamic" data-tipped="fetchitem.php?item_id=${t.id}&inv_id=-1&t=2&p=${j}&vcode=${t.verify}" src="${t.img}" height="20px" width="20px"><p>${t.amountPresent}/${t.amountNeeded}</p></div>`}function B(t){return!k.includes(t.name)}function S(t){return`<tr class="rmTr"><td class="rmTd"><a href="${t.link}"><img src="${t.img}" height="30px" width="30px"></a></td><td class="rmTd"><a href="${t.link}">${t.name}</a></td><td class="rmTd">${function(t){return t.items?t.items.map(w).join(""):""}(t)}</td><td class="rmTd">${function(t){return t.components?t.components.map(C).join(""):""}(t)}</td><td class="rmTd">${function(t){return t.target?` <img class="tip-dynamic" data-tipped="fetchitem.php?item_id=${t.target.id}&inv_id=-1&t=2&p=${j}&vcode=${t.target.verify}" src="${t.target.img}" height="30px" width="30px"><br/>`:""}(t)}</td></tr>`}function T(i,r){r&&(t("hideRecipes")&&(k=x("hideRecipeNames")),function(t,i){j=e()
...
r+=i.recipe.filter(B).map(S).join(""),r+="</table>",n(r,t),$("fsh_recipeBook",i)}(i,r))}function I(t){const e=i("pCC",t).children[0].rows[4].cells[0].children[0]
...
//# sourceMappingURL=recipeMgr-71a40ceb.js.map
