import{r as e,A as t,t as n,aH as s,ab as o,Z as a,bK as i,C as c,m as r,O as l,V as m,i as p,a4 as u,D as d,h as f,o as g,p as h,z as b,c as v,bL as C,B as S,a7 as E,j,G as k,y as N,I as x}from"./calfSystem-9c7241dc.js"
import{c as y}from"./createInput-6e753077.js"
import{i as A}from"./insertElementBefore-686b8559.js"
import{c as L}from"./createTable-711dc1b7.js"
import{p as B,a as I}from"./pubsub-cca21189.js"
import{g as q}from"./getArrayByClassName-5afbd411.js"
import{i as $}from"./insertHtmlAfterEnd-1e4cd611.js"
import{i as F}from"./insertElementAfter-a303fad5.js"
import{r as T,g as P}from"./rnd-805ad232.js"
...
return 0===s&&b(e[1],t.insertCell(-1)),f(t.insertCell(-1),(o=(s+1).toString(),a=e[0],y({className:"awesome orange",dataset:{templateId:a},type:"button",value:o}))),t}function O(e,t,s,o){return e.reduce(n(M,o),s.insertRow(-1)),s}function R(e){return[e.value,e.text]}function V(e,t,s){const o=function(e,t,s){const o=L({id:"fshFastCompose"})
return D(o,s),e.reduce(n(O,t,s),o)}(d("#composing-template-multi option").map(R),t,s)
f(e,o),g(h,K),I("quickcreate",n(G,o))}function Z(e){m("composing","FastCompose"),p(e,"<br>")
...
F(s,e),l(s,"change",n(Z,t))}()}export default function(){j()&&h&&ee()}
//# sourceMappingURL=composing-c1069f8f.js.map
