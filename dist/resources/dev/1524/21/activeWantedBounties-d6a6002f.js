import{u as e,B as t,C as n,bE as s,G as r,T as i,Z as a,y as o,q as c,K as l,c as u,m as d,bQ as b,bG as f,A as p,bT as h,h as m,i as y,v as L,x as g,o as v}from"./calfSystem-9c7241dc.js"
import"./insertElementBefore-686b8559.js"
import{i as $}from"./insertElementAfterBegin-2637f36b.js"
import{c as w}from"./createSpan-dd12772b.js"
import"./csvSplit-bf63d03b.js"
import{s as x}from"./shouldBeArray-0b1ce3ca.js"
import{f as N}from"./functionPasses-4d550982.js"
...
A.bounty.push(n)}}(e)}function P(){return A&&i-A.lastUpdate>S||B&&i-B.lastUpdate>S}function G(e){const t=e[6]
...
function z(){return d({className:"minibox"})}function D(){f("bountyList",A),p("",O)
...
var n
y(O,t)}function F(){f("wantedList",B),p("",q)
...
A={},A.bounty=[],A.isRefreshed=!0,A.lastUpdate=i,n&&M(n),j=!0}(e),D())}function V(e){const t=L(e)
J(t),u.enableWantedList&&(I(t),Q<Z?R(Q+1).then(V):F())}const Y=[()=>!A,()=>!B,()=>W]
function _(e,t){A=s("bountyList"),B=s("wantedList"),S=r("bountyListRefreshTime"),W=r("bwNeedsRefresh"),W||P()&&(W=!0),Y.some(N)?(B={},B.bounty=[],B.isRefreshed=!0,B.lastUpdate=i,j=!1,C=x("wantedNames"),a("bwNeedsRefresh",!1),R(1).then(V)):function(e,t){t&&(B.isRefreshed=!1,F()),e&&(A.isRefreshed=!1,D())}(e,t)}function ee(e){e.target===K&&(f("bountyList",null),_(u.enableActiveBountyList,u.enableWantedList)),e.target===X&&(f("wantedList",null),_(u.enableActiveBountyList,u.enableWantedList))}export default function(){g()||(u.enableWantedList&&(q=z(),$(b,q)),u.enableActiveBountyList&&(O=z(),$(b,O)),O&&v(O,ee),q&&v(q,ee),_(u.enableActiveBountyList,u.enableWantedList))}
//# sourceMappingURL=activeWantedBounties-d6a6002f.js.map
