import{G as s,g as e,p as a,a4 as n,b7 as r,M as o,B as i,A as c}from"./calfSystem-9c7241dc.js"
import{p as t}from"./playerName-ddecc25a.js"
import{d as l}from"./dataRows-e462b280.js"
import{s as d}from"./searchPlayerHref-19b61dd9.js"
...
a[1]=d(n),c(a.join("'"),s.cells[2]),function(s,e,a){e||a===t()||($(s).find("td").removeClass("row").css("font-size","xx-small"),s.style.color="gray")}(s,e,n)}function h(s){m(s),function(s){const e=i(s.cells[2]),a=e.includes("has invited the player");("'"===e.charAt(0)||a)&&u(s,a)}(s)}function y(){const s=e("td",a).find(n("Message"))
if(!s)return
...
//# sourceMappingURL=addGuildLogWidgets-eb666fa9.js.map
