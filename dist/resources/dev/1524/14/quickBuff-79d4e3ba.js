import{R as t,B as n,S as s,T as e,b as a,U as i,C as f,V as u,W as c,M as r,u as l,X as o,z as d,Y as b,Z as h,y as m,_ as p,o as k}from"./calfSystem-d96a3efd.js"
import{s as q}from"./setTipped-906b0642.js"
import{d as T,q as v}from"./quickbuffSuccess-420c9b18.js"
...
t&&b(t)}function _(t){return`<span class="fshLime">On</span>&nbsp;<span class="fshBuffOn">(${function(t){const n=Math.floor(t/60),s=t%60
let e=h(n,"m")
return n>0&&s>0&&(e+=" "),e+=h(s,"s"),e}(t)})</span>`}function C(n,s){const e=n[s]||0
...
F(n,"Guild Buffer",d("fshGB")),F(n,"Buff Master",d("fshBM")),F(n,"Extend",d("fshExt")),F(n,"Reinforce",d("fshRI"))}(t)}function I(t,s){v(s)&&(t.className="fshLime",n("On",t))}function P(t){const n=t.target
"quickbuffActivate"===n.className&&T([window.self],[n.dataset.buffid]).then(l(I,n))}export default function(){if(m())return
const t=d("quickbuff")
t&&(u(window.self).then(j),p(t.children[0],'<div id="helperQBheader"><table class="quickbuffTable"><thead><tr><th class="quickbuffTableHeader">Sustain</th><th class="quickbuffTableHeader">Fury Caster</th><th class="quickbuffTableHeader">Guild Buffer</th><th class="quickbuffTableHeader">Buff Master</th><th class="quickbuffTableHeader">Extend</th><th class="quickbuffTableHeader">Reinforce</th></tr></thead><tbody><tr><td id="fshSus" class="quickbuffTableDetail">&nbsp;</td><td id="fshFur" class="quickbuffTableDetail">&nbsp;</td><td id="fshGB"  class="quickbuffTableDetail">&nbsp;</td><td id="fshBM"  class="quickbuffTableDetail">&nbsp;</td><td id="fshExt" class="quickbuffTableDetail">&nbsp;</td><td id="fshRI"  class="quickbuffTableDetail">&nbsp;</td></tr></tbody></table></div>'),r('#buff-outer label[for^="skill-"]').forEach(A),H(),k(d("helperQBheader"),P),k(d("players"),x),d("targetPlayers").value&&M())}
//# sourceMappingURL=quickBuff-79d4e3ba.js.map
