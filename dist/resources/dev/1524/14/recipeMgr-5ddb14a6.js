import{F as t,aV as e,bs as n,B as i,aj as r,z as s,g as a,w as o,i as c,u as d,C as u,bY as p,a_ as f,J as m,k as h,f as l,v as g,y as $,ah as b,o as v,p as x}from"./calfSystem-d96a3efd.js"
import"./toLowerCase-a0540d2c.js"
import"./alpha-2978f86d.js"
import{a as _}from"./all-a5e007ad.js"
import{d as N}from"./doSortParams-15b258d9.js"
import{a as k}from"./stringSort-999874e6.js"
let w,y=[]
function C(t){return`<div class="rmItem"><img class="tip-dynamic" data-tipped="fetchitem.php?item_id=${t.id}&inv_id=-1&t=2&p=${w}&vcode=${t.verify}" src="${t.img}" height="20px" width="20px"><p>${t.amountPresent}/${t.amountNeeded}</p></div>`}function j(t){return`<div class="rmItem"><img class="tip-dynamic" data-tipped="fetchitem.php?item_id=${t.id}&inv_id=-1&t=2&p=${w}&vcode=${t.verify}" src="${t.img}" height="20px" width="20px"><p>${t.amountPresent}/${t.amountNeeded}</p></div>`}function S(t){return!y.includes(t.name)}function T(t){return`<tr class="rmTr"><td class="rmTd"><a href="${t.link}"><img src="${t.img}" height="30px" width="30px"></a></td><td class="rmTd"><a href="${t.link}">${t.name}</a></td><td class="rmTd">${function(t){return t.items?t.items.map(C).join(""):""}(t)}</td><td class="rmTd">${function(t){return t.components?t.components.map(j).join(""):""}(t)}</td><td class="rmTd">${function(t){return t.target?` <img class="tip-dynamic" data-tipped="fetchitem.php?item_id=${t.target.id}&inv_id=-1&t=2&p=${w}&vcode=${t.target.verify}" src="${t.target.img}" height="30px" width="30px"><br/>`:""}(t)}</td></tr>`}function B(s,a){a&&(t("hideRecipes")&&(y=e("hideRecipeNames")),function(t,e){w=n()
...
return _(i)}function z(t){return/\/folder_on\./.test(t.getAttribute("src"))}function J(t,e){return 0!==e}function M(t){return t.value}function V(t,e,n){return f(`${t}&page=${n}`).then(e)}function Y(t,e,n){return function(t){return a("option",m("customselect",s("pCC",t))[0]).filter(J).map(M)}(t).map(d(V,e,n))}function D(t,e,n){const i=o(n),r=function(t){return I(t).find(z).parentNode.href}(i),s=d(q,t,e),a=Y(i,r,s)
...
function W(){c(U,"Finished parsing ... formatting ..."),r("fsh_recipeBook",Q),B(U,Q)}function X(){Q={},Q.recipe=[],i("<br>Parsing inventing screen ...<br>",U),g({cmd:"inventing"}).then(d(O,U,Q)).then(W)}function Z(t,e){Q=e,i('<table class="fshInvFilter"><thead><tr><th width="90%"><b>&nbsp;Recipe Manager</b></th><th width="10%" class="fshBtnBox">[<span id="rfsh" class="fshLink">Refresh</span>]</th></tr></thead></table>',t),U=h(),l(t,U),Q?B(U,Q):X()}function tt(t){"rfsh"===t.target.id&&X(),"sortName"===t.target.id&&function(t){N(t.target),Q.recipe.sort(k),B(U,Q)}(t)}export default function(t){if($())return
const e=t||x
b("fsh_recipeBook").then(d(Z,e)),v(e,tt)}
//# sourceMappingURL=recipeMgr-5ddb14a6.js.map
