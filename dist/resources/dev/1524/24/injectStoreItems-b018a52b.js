import{c as t,b0 as n,M as e,l as o,V as s,B as i,D as r,Z as c,aU as a,e as u,G as l,a as f,t as d,bk as m,at as p,as as h,bj as k,x as g,H as $,o as b,p as w}from"./calfSystem-38898f3e.js"
import{b as _}from"./batch-21cc76f7.js"
import{d as x}from"./doStatTotal-19a42dfd.js"
import{c as L}from"./closestTr-4d04f2f4.js"
import{d as y}from"./daAjaxSendItemsToRecipient-e7f9f1c7.js"
import{e as v}from"./errorDialog-8d3200e2.js"
import{g as S}from"./getInventoryById-e93c5950.js"
let E,D,Q
function j(){if(!D){const n="dropitems"===t.subcmd?"removeIndex[]":"storeIndex[]"
E=document.forms[0].elements[n],D=!0}return E}function A(){}function N(t){return t()}function T(){return Object.create(null)}function C(t){t.forEach(N)}function I(t){return"function"==typeof t}function H(t,n){return t!=t?n==n:t!==n||t&&"object"==typeof t||"function"==typeof t}function O(t,n){t.appendChild(n)}function B(t,n,e){t.insertBefore(n,e||null)}function R(t){t.parentNode.removeChild(t)}function U(t,n){for(let e=0;e<t.length;e+=1)t[e]&&t[e].d(n)}function G(t){return document.createElement(t)}function F(t){return document.createTextNode(t)}function M(){return F(" ")}function q(t,n,e,o){return t.addEventListener(n,e,o),()=>t.removeEventListener(n,e,o)}function P(t,n,e){null==e?t.removeAttribute(n):t.getAttribute(n)!==e&&t.setAttribute(n,e)}function V(t,n){n=""+n,t.wholeText!==n&&(t.data=n)}function z(t,n){for(let e=0;e<t.options.length;e+=1){const o=t.options[e]
...
Z(t)
const a=n.props||{},u=t.$$={fragment:null,ctx:null,props:i,update:A,not_equal:s,bound:T(),on_mount:[],on_destroy:[],before_update:[],after_update:[],context:new Map(c?c.$$.context:[]),callbacks:T(),dirty:r,skip_bound:!1}
let l=!1
...
null!==e.fragment&&(C(e.on_destroy),e.fragment&&e.fragment.d(n),e.on_destroy=e.fragment=null,e.ctx=[])}(this,1),this.$destroy=A}$on(t,n){const e=this.$$.callbacks[t]||(this.$$.callbacks[t]=[])
return e.push(n),()=>{const t=e.indexOf(n);-1!==t&&e.splice(t,1)}}$set(t){var n
this.$$set&&(n=t,0!==Object.keys(n).length)&&(this.$$.skip_bound=!0,this.$$set(t),this.$$.skip_bound=!1)}}function dt(t){return function(t){return n({subcmd:"dodropitems",removeIndex:t})}(t)}function mt(){const t=j()
...
return{c(){n=F("["),e=G("button"),e.textContent="Select All Guild Locked",o=F("]"),P(e,"class","svelte-hnk7js")},m(r,c){B(r,n,c),B(r,e,c),B(r,o,c),s||(i=q(e,"click",t[5]),s=!0)},p:A,d(t){t&&R(n),t&&R(e),t&&R(o),s=!1,i()}}}(n)
return{c(){e=F("["),o=G("button"),s=F(p),i=F(" AH and UFSG Links"),r=F("] \n["),c=G("button"),a=F(h),u=F(" Quick Drop links"),l=F("] \n"),k&&k.c(),f=F(""),P(o,"class","svelte-hnk7js"),P(c,"class","svelte-hnk7js")},m(t,p){B(t,e,p),B(t,o,p),O(o,s),O(o,i),B(t,r,p),B(t,c,p),O(c,a),O(c,u),B(t,l,p),k&&k.m(t,p),B(t,f,p),d||(m=[q(o,"click",n[3]),q(c,"click",n[4])],d=!0)},p(n,[e]){1&e&&p!==(p=n[2](n[0])+"")&&V(s,p),2&e&&h!==(h=n[2](n[1])+"")&&V(a,h),"storeitems"===t.subcmd2&&k.p(n,e)},i:A,o:A,d(t){t&&R(e),t&&R(o),t&&R(r),t&&R(c),t&&R(l),k&&k.d(t),t&&R(f),d=!1,C(m)}}}function xt(t,n,e){const o=J()
...
function Dt(t,n){return t[n]=(t[n]||0)+1,t}const Qt=(t,n,e)=>`[<button class="fshStoreItemsButton ${t}"${n}>${e}</button>]`,jt=(t,n,e)=>" "+Qt(t+" actionButton tooltip-multiline",(t=>` data-tooltip="INSTANTLY ${t} THE ITEM. NO REFUNDS OR DO-OVERS! Use at own risk."`)(n),"Quick "+e),At=(t,n,e)=>`[<a href="${t}"${n}>${e}</a>]`
function Nt(t,n,[e,o]){const s=e
t[1]&&(s.className=m[o.rarity].clas)
let i=""
t[0]&&(i=`${function(t){return t.bound?'<span class="aHSpacer"></span>':At(`${k}${encodeURIComponent(t.item_name)}`,"","AH")}(o)} ${(t=>At(`${p}items${h}view&item_id=${t.item_id}`,' target="_blank"',"UFSG"))(o)}`),i+="&nbsp;"+o.item_name,((t,n,e)=>t[2]&&n[e.item_id]>1)(t,n,o)&&(i+=" "+Qt("fshBlack","","Check All")),((t,n)=>t[3]&&(!n.bound||-1!==n.guild_tag))(t,o)&&(i+=jt("fshBlue","SENDS","Send")),((t,n)=>t[4]&&-1===n.guild_tag)(t,o)&&(i+=jt("fshRed","DROP","Drop")),s.innerHTML!==i&&(s.innerHTML=i)}async function Tt(t){const n=await async function(){const t=mt()
if(!t.length)return[]
const n=await St(t)
return t.map(t=>[L(t).cells[2],n[t.value]]).filter(([,t])=>t)}(),e=t[2]?function(t){return{...t.map(([,t])=>t.item_id).reduce(Dt,{}),13699:1}}(n):[]
f(3,_,[[5,3,n,0,d(Nt,t,e)]])}function Ct(t){const n=function(t){const n=document.forms[0]
...
if(!j())return
const t=Et.map(t=>$(t))
x(),Ct(t),t.some(t=>t)&&Tt(t),b(w,wt)}export{ft as S,B as a,O as b,V as c,R as d,G as e,M as f,P as g,z as h,lt as i,U as j,J as k,q as l,ot as m,A as n,Y as o,mt as p,dt as q,C as r,H as s,F as t,j as u,It as v,kt as w,pt as x}
//# sourceMappingURL=injectStoreItems-b018a52b.js.map
