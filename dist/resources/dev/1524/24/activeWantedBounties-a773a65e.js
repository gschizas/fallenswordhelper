import{u as e,B as t,C as n,bE as s,H as r,T as i,Z as a,y as o,q as c,G as l,c as u,m as d,bQ as b,bG as f,A as p,bT as h,h as m,i as y,v as L,x as g,o as v}from"./calfSystem-38898f3e.js"
import"./insertElementBefore-2ad05963.js"
import{i as $}from"./insertElementAfterBegin-32b9e13c.js"
import{c as w}from"./createSpan-f1b09788.js"
...
function _(e,t){A=s("bountyList"),B=s("wantedList"),S=r("bountyListRefreshTime"),W=r("bwNeedsRefresh"),W||M()&&(W=!0),Y.some(N)?(B={},B.bounty=[],B.isRefreshed=!0,B.lastUpdate=i,j=!1,C=x("wantedNames"),a("bwNeedsRefresh",!1),R(1).then(V)):function(e,t){t&&(B.isRefreshed=!1,F()),e&&(A.isRefreshed=!1,D())}(e,t)}function ee(e){e.target===X&&(f("bountyList",null),_(u.enableActiveBountyList,u.enableWantedList)),e.target===K&&(f("wantedList",null),_(u.enableActiveBountyList,u.enableWantedList))}function te(){g()||(u.enableWantedList&&(q=z(),$(b,q)),u.enableActiveBountyList&&(O=z(),$(b,O)),O&&v(O,ee),q&&v(q,ee),_(u.enableActiveBountyList,u.enableWantedList))}export default te
//# sourceMappingURL=activeWantedBounties-a773a65e.js.map
