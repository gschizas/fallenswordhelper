import{a as t}from"./addGuildLogWidgets-417a8ef9.js"
import{a as e}from"./addLogColoring-49bb427b.js"
import{a as s}from"./all-6dfbd6b8.js"
import{u as i,t as n,br as o,bs as a,x as d,A as c,p as r,o as h,g as l,z as f,y as u,H as p,v as m,C as b,B as g,J as k,i as y,G as w}from"./calfSystem-393ab895.js"
import{c as j}from"./createTable-aae48322.js"
import{e as L}from"./eventHandler5-a2b2bc41.js"
import{f as R}from"./functionPasses-75c75ad9.js"
import{h as N}from"./hideElement-d4551277.js"
import{p as G}from"./parseDateAsTimestamp-01885405.js"
import{s as v}from"./selfIdIs-fd8b3a9a.js"
import{t as x}from"./toggleForce-8e48254b.js"
import{g as H,s as T}from"./idb-46b78b1e.js"
import"./dataRows-0805e883.js"
import"./playerName-03162bd7.js"
import"./searchPlayerHref-7d1f7986.js"
...
J.checks[e]=!J.checks[e],Z(),Q.forEach(n(rt,e,!J.checks[e]))}function lt(t){t&&t.classList&&t.classList.remove("fshHide")}function ft(t){lt(t[5]),lt(t[6])}function ut(){J.checks=O.slice(0),ot(),Q.forEach(ft)}function pt(t){N(t[5]),N(t[6])}function mt(){J.checks=B.slice(0),ot(),Q.forEach(pt)}function bt(){J.log=!1,Z(),f("Loading Page 1 ...",M),Q=[],V=!0,c("",u("fshInjectHere")),P(1).then(ct)}function gt(t){!function(t){J=t||J,J.checks=J.checks||O.slice(0)}(t),c(E,r),D=u("fshNewGuildLog"),M=u("fshOutput"),h(D,L([[t=>"INPUT"===t.tagName,ht],[v("fshAll"),ut],[v("fshNone"),mt],[v("rfsh"),bt]])),ot(),F=Number(p("newGuildLogHistoryPages")),$=F,P(1).then(ct)}function kt(){d()||H("fsh_guildLog").then(gt)}export default kt
//# sourceMappingURL=newGuildLog-7f5642d1.js.map
