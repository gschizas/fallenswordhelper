import{r as e,A as t,t as n,ak as s,aa as o,Z as a,aw as i,C as c,m as r,O as l,V as m,i as p,ax as u,D as f,h as d,o as g,p as h,z as b,c as v,ay as C,B as S,a5 as k,j as E,H as j,y as x,J as N}from"./calfSystem-393ab895.js"
import{r as y,g as A}from"./rnd-e56d2178.js"
import{p as $,s as B}from"./pubsub-acba6627.js"
import{c as L}from"./createInput-f7e07c00.js"
import{c as q}from"./createTable-aae48322.js"
import{g as I}from"./getArrayByClassName-1bdcec20.js"
import{i as F}from"./insertElementAfter-2264cfb0.js"
import{i as T}from"./insertHtmlAfterEnd-568576c8.js"
import{i as w}from"./insertElementBefore-43970b1f.js"
function P(e,n){t("",e.children[0]),e.children[0].classList.add("fshPot"),e.children[0].style.backgroundImage=`url(${s}composing/${A(1,11)}_${A(1,51)}.png)`,t(`Creating '<span class="fshBold">${n}</span>' Potion`,e.children[2]),t("",e.children[3])}function H(e){const n=e.parentNode
...
return 0===s&&b(e[1],t.insertCell(-1)),d(t.insertCell(-1),(o=(s+1).toString(),a=e[0],L({className:"awesome orange",dataset:{templateId:a},type:"button",value:o}))),t}function R(e,t,s,o){return e.reduce(n(O,o),s.insertRow(-1)),s}function V(e){return[e.value,e.text]}function Z(e,t,s){const o=function(e,t,s){const o=q({id:"fshFastCompose"})
return D(o,s),e.reduce(n(R,t,s),o)}(f("#composing-template-multi option").map(V),t,s)
d(e,o),g(h,M),B("quickcreate",n(J,o))}function G(e){m("composing","FastCompose"),p(e,"<br>")
...
0===t?W(!0):(W(!1),a(C,t))}(),f("input[id^=create-]:not(#create-multi)",h).forEach(X),g(h,Y),function(){if(j("moveComposingButtons")){const e=x("composing-error-dialog").previousElementSibling
...
F(s,e),l(s,"change",n(G,t))}()}function te(){E()&&h&&ee()}export default te
//# sourceMappingURL=composing-c1f7ee68.js.map
