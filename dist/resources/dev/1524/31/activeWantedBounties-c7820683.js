import{u as e,B as t,C as n,bH as s,H as a,T as r,Z as i,y as o,q as c,G as l,c as u,m as d,bL as b,bJ as f,A as p,bQ as h,h as m,i as y,v as L,x as g,o as v}from"./calfSystem-393ab895.js"
import{f as $}from"./functionPasses-75c75ad9.js"
import{s as w}from"./shouldBeArray-c2b21111.js"
...
function G(e,t){var n;(function(e,t){return"[active]"!==l(t.cells[6])&&U.some((n=>n(e,t)))})(e,t)&&T.bounty.push((n=t.cells,c(A(n),{offerer:l(n[1].children[0].children[0]),tickets:l(n[5]),accept:E(n)})))}let O,q,X,J,K,Q
function Z(){return d({className:"minibox"})}function z(){f("bountyList",B),p("",O)
...
var n
y(O,t)}function D(){f("wantedList",T),p("",q)
const e=d({innerHTML:`<a href="${h}">Wanted Bounties</a> `})
J=N({className:"xxsLink",textContent:"Reset"}),m(e,J),m(q,e)
let t=""
...
G(s,n)}}(s)}function I(e){u.enableActiveBountyList&&!j&&(!function(e){const t=o("bounty-info",e)
if(!t)return
...
I(t),u.enableWantedList&&(F(t),K<Q?R(K+1).then(V):D())}const Y=[()=>!B,()=>!T,()=>S]
function _(e,t){B=s("bountyList"),T=s("wantedList"),H=a("bountyListRefreshTime"),S=a("bwNeedsRefresh"),S||P()&&(S=!0),Y.some($)?(T={},T.bounty=[],T.isRefreshed=!0,T.lastUpdate=r,j=!1,W=w("wantedNames"),i("bwNeedsRefresh",!1),R(1).then(V)):function(e,t){t&&(T.isRefreshed=!1,D()),e&&(B.isRefreshed=!1,z())}(e,t)}function ee(e){e.target===X&&(f("bountyList",null),_(u.enableActiveBountyList,u.enableWantedList)),e.target===J&&(f("wantedList",null),_(u.enableActiveBountyList,u.enableWantedList))}function te(){g()||(u.enableWantedList&&(q=Z(),x(b,q)),u.enableActiveBountyList&&(O=Z(),x(b,O)),O&&v(O,ee),q&&v(q,ee),_(u.enableActiveBountyList,u.enableWantedList))}export default te
//# sourceMappingURL=activeWantedBounties-c7820683.js.map
