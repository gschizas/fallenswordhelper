import{m as t,k as s,f as a,a as e,s as n,$ as r,bb as i,z as l,bc as c,i as o,w as d,b as u,p as f,c as m,ay as p,F as v,aT as h,aQ as b,A as j}from"./calfSystem-ee582533.js"
import{a as g}from"./addCommas-f872a1dc.js"
import"./currentGuildId-0564d9a0.js"
import{c as y}from"./createTable-cbb3667c.js"
import"./all-b94d2d9d.js"
import{a as A}from"./allthen-f1914fd2.js"
import"./indexAjaxJson-e486d467.js"
import{i as B}from"./insertHtmlAfterEnd-4dbaaf09.js"
import"./cmdExport-23cec039.js"
import{l as C}from"./loadDataTables-9af37330.js"
import{g as k}from"./getMembrList-d7782e14.js"
import{d as D}from"./daAdvisor-1d804899.js"
import{r as S}from"./replaceChild-55236ff2.js"
...
L(t,function(t){return T({innerHTML:`<tr><td class="fshRight" colspan="3">Total: </td>${t.slice(1).reduce(X,t[0].stats).map(g).reduce(q,"")}</tr>`})}(e),e.map(n(z,s)))}function O(t,s){return 0===s?b(t):j(t)}function Q(t,s){const a=p(s.cells,O)
return a.splice(0,1,R(a[0],t),x(a[0],t),G(a[0],t)),a}function _(t,s){i("guildAdvisor.injectAdvisorDaily")
const e=function(t,s){return p(t.rows).slice(1,-1).map(n(Q,s))}(t,s),r=function(t){const s=t.rows[t.rows.length-1].cloneNode(!0),e=T()
a(e,s)
const n=s.cells[0]
...
A(s,n(I,t)),c("guildAdvisor.injectAdvisorWeekly")}(t):k(!1).then(n(_,t))}export default function(){if(d())return
const t=u("table",f)[1]
t&&C().then(()=>K(t))}
//# sourceMappingURL=guildAdvisor-afc03359.js.map
