import{f as t,p as s,e,s as n,x as d,y as a,i,az as c,w as o,a5 as l,a as r,D as h,aA as p}from"./calfSystem-ee582533.js"
import{c as u}from"./createTable-cbb3667c.js"
import{p as f}from"./padZ-55be60ec.js"
let b
...
e.className="divider",e.colSpan=3}function y(t){const s=b.getBoundingClientRect().top,e=Math.abs(Math.min(s,0)),a=e/24,i=Math.ceil(document.documentElement.clientHeight/24),c=t.length-a-i,o=u({innerHTML:"<tbody></tbody>"}),l=o.insertRow(-1)
l.style.height=e.toString()+"px",l.insertCell(-1),l.insertCell(-1),l.insertCell(-1),t.slice(a,a+i-1).forEach(n(m,o))
const r=24*c
o.insertRow(-1).style.height=r.toString()+"px",d("fshOutput").textContent="Inject table.",requestAnimationFrame(n(g,o))}function R(d){b=u({className:"width_full",id:"fshInjectHere5",innerHTML:"<tbody></tbody>"}),t(s,b),y(d),e(window,"scroll",function(t,s){let e
