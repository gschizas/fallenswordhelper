import{r as e,A as t,t as n,aH as s,ab as o,Z as a,bG as i,C as c,m as r,O as l,V as m,i as p,a4 as u,D as f,h as d,o as g,p as h,z as b,c as v,bH as C,B as S,a7 as E,j,H as k,y as N,J as x}from"./calfSystem-02c48ff5.js"
import{c as y}from"./createInput-6ef511c8.js"
import{i as A}from"./insertElementBefore-7e0a7ce8.js"
import{c as B}from"./createTable-b0dd7860.js"
import{p as L,a as q}from"./pubsub-acc4334e.js"
import{g as I}from"./getArrayByClassName-8897eb0e.js"
import{i as $}from"./insertHtmlAfterEnd-b7d6a20f.js"
import{i as F}from"./insertElementAfter-1f1153af.js"
import{r as H,g as T}from"./rnd-0568e06a.js"
...
return 0===s&&b(e[1],t.insertCell(-1)),d(t.insertCell(-1),(o=(s+1).toString(),a=e[0],y({className:"awesome orange",dataset:{templateId:a},type:"button",value:o}))),t}function O(e,t,s,o){return e.reduce(n(M,o),s.insertRow(-1)),s}function R(e){return[e.value,e.text]}function V(e,t,s){const o=function(e,t,s){const o=B({id:"fshFastCompose"})
return D(o,s),e.reduce(n(O,t,s),o)}(f("#composing-template-multi option").map(R),t,s)
d(e,o),g(h,J),q("quickcreate",n(G,o))}function Z(e){m("composing","FastCompose"),p(e,"<br>")
...
//# sourceMappingURL=composing-b0929eb4.js.map
