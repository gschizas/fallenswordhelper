import{aU as n,D as t,e as a,t as e,aV as s,d as r,P as o,x as c,V as i,aW as f,aX as l}from"./calfSystem-02c48ff5.js"
...
import{s as p,g as v}from"./idb-49c5b621.js"
import{i as h}from"./interceptSubmit-43d7e549.js"
import{c as b}from"./closestTr-9052729a.js"
import{l as g,p as x}from"./lvlTests-a82a58f4.js"
import{l as y}from"./loadDataTables-b534a318.js"
...
import{a as w}from"./arena-6c34b7f6.js"
...
$("a",a).contents().unwrap(),$(t).prepend($("<thead/>").append(a))}function sn(){z(),E(),$.fn.dataTable.ext.search.push(J),$.fn.dataTable.ext.search.push(R)}function rn(s,[r,o,c]){const i=$('table[width="635"]',s)
i.each(en),function(n){q=n||{},D=q.id||{},q.id={}}(r),function(n){n.children("tbody").children("tr").each(I)}(i),function(s){if(!n(s))return
...
p("fsh_arenaFull",o)}(o),Z(c),sn(),i.DataTable(k),function(n){$(nn,n).off("click"),n.on("click",nn,tn)}(s)}function on(n,a){f("arena.process"),t('#arenaTypeTabs tr[style="display: none;"]').forEach(n=>n.remove()),rn(n,a),h(),l("arena.process")}function cn(){if(c())return
const n=$("#arenaTypeTabs")
1===n.length?function(n){L([v(T),v("fsh_arenaFull"),an().catch(()=>({})),y()],e(on,n))}(n):i("arena","Join error screen ?")}var fn=Object.freeze({__proto__:null,default:cn})
export{fn as a,cn as i,an as v}
//# sourceMappingURL=arena-14fc8216.js.map
