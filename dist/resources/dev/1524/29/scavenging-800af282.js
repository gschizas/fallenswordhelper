import{y as t,h as n,f as e,t as o,A as s,B as r,Z as a,bE as c,aj as i,m as u,p as f,e as m}from"./calfSystem-02c48ff5.js"
import{n as l}from"./numberIsNaN-d1ebf732.js"
import"./toLowerCase-0a22477f.js"
import{i as p}from"./intValue-f94761c7.js"
import{a as d}from"./alpha-90aef395.js"
import{c as b}from"./createSpan-1a0a0b1a.js"
import"./closest-14c30e26.js"
import{c as g}from"./closestTable-d14a96b7.js"
function h(t,n,e){s("",t)
const o=Number(e.value)
l(o)||0===o||function(t,n,e){const o=p(r(n)),a=Math.floor(o/e).toString()
s(`&nbsp;&nbsp;Max: ${a} times`,t)}(t,n,o)}function j(t,n,e){t&&h(t,n,e)}function $(s){!function(t){g(t).removeAttribute("width")}(s),function(t,n,s){const r=o(j,t,n,s)
...
if(n)return M(n)}(t)}return n}function q(t){return function(e,o,r){t(e,o,r),a("lastScavPage",`${c}scavenging&cave_id=${r}&gold=${o}`),s(_(),(v||(v=u(),n(f,v)),s("",v),v))}}function w(){!function(){const t=sendRequest
i(t)&&(sendRequest=q(t))}(),function(){const n=t("multiplier_count")
n&&$(n)}()}export default w
//# sourceMappingURL=scavenging-800af282.js.map
