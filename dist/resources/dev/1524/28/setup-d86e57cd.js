import{x as t,d as o,t as n,g as e,b4 as i,u as a,b3 as p}from"./calfSystem-b136673a.js"
import"./all-7e2b4bf6.js"
import{a as c}from"./allthen-7191069a.js"
import{m as s}from"./assets-48002450.js"
const u=[]
let l,r
...
c(o,h)}function b(){const t=e("select",r).map(f),o=t.map(m)
c(o,n(g,t))}function k(t,o,n){const e=function(t){const o=$(t).attr("src").match(s)
return o?o[1]:"x"}(n)
u.push(e)
...
$("input",o).on("click",b),t.append(o)}(e)}function C(){if(t())return
const o=$('#pCC b:contains("Setup Combat Moves")')
1===o.length&&(o.addClass("fshLink fshGreen"),o.on("click",x))}export default C
//# sourceMappingURL=setup-d86e57cd.js.map
