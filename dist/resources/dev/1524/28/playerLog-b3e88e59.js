import{e,aU as t,D as n,ba as a,bb as s,E as o,C as r,z as i,bc as c,G as f,i as l,w as u,T as m,t as p,aT as d,bd as h,a5 as b,h as g,m as y,B as j,o as w,be as C,H as P,M as _,a6 as v,bf as k,Z as $,x as L}from"./calfSystem-b136673a.js"
import"./playerName-f933c87f.js"
import{t as T}from"./toLowerCase-27ea448e.js"
import{a as B}from"./addCommas-8259c1a9.js"
import{c as E}from"./createStyle-04d9ec28.js"
import{c as x}from"./currentGuildId-4405d1bb.js"
import"./fshOpen-027ef4bd.js"
import{o as G}from"./openQuickBuffByName-1b8ea02b.js"
import"./dataRows-17e46aaa.js"
import{g as R,s as S}from"./idb-c31665cb.js"
...
import{c as I}from"./csvSplit-ab694daa.js"
import{i as M}from"./insertHtmlAfterEnd-a4a64d97.js"
import{p as Y}from"./parseDateAsTimestamp-dc8c4305.js"
import{b as D}from"./buffObj-79519cf4.js"
import"./getProfile-2262c384.js"
import{m as H}from"./myStats-a44245ae.js"
import{c as N}from"./closestTd-0714b6f6.js"
import{g as z}from"./getMembrList-aed8efd6.js"
import"./doBuffLinkClick-96a0b2d6.js"
import{a as O}from"./addLogColoring-edf6d445.js"
let Q
async function J(n){return x()&&!Q&&(Q=async function(){return e(await z(!1)).filter(([,e])=>t(e)).map(([e])=>e)}()),(await Q).includes(n)}const U=e=>[e,a(e.href,"target_username")],W=async([e,t])=>[e,t,await J(t)]
function X([e,t]){M(e,` | <a href="${s}${t}">Attack</a>`)}function Z(e){return`<a href="${c}${f(e)}" data-tooltip="Add to Ignore List">Ignore</a>`}function q([e,,t]){i("Report",t),M(t," | "+Z(e))}function F([e,t]){l(t.cells[1].children[0],`<font size="1"><br>[ ${Z(e)} ]</font>`)}function K(e){return function(e){return u({cmd:"combat",subcmd:"view",combat_id:e})}(e)}let V,ee
...
const n=await V
return n[t]&&n[t].logTime?n[t]:async function(e,t,n){const a=await K(t)
...
e.cells[2].firstChild.remove(),b(e.cells[2],s),g(e.cells[2],y({innerHTML:o}))}const le=([,,e])=>e&&e.s
...
return a?t="guild":s?t="ally":o&&(t="enemy"),[`.fshPlayerColoring tr:nth-of-type(${A(e).rowIndex+1}) td:nth-of-type(3) > a:first-of-type`,t]}function ge(e,[t,n]){return e[n]?e[n].push(t):e[n]=[t],e}const ye={guild:"green",ally:"blue",enemy:"red"}
function je([e,t]){return`${t.join(", ")} { color: ${ye[e]}; }`}const we=([,e])=>e
function Ce(t,n){const a=function(t){return e(t.filter(we).reduce(ge,{})).map(je)}(n)
a.length&&(!function(e){const t=e.rows[0].cells[2]
t&&l(t,'&nbsp;&nbsp;<span class="fshWhite">(Guild mates show up in <span class="fshGreen">green</span>)</span>')}(t),t.classList.add("fshPlayerColoring"),g(document.body,E(a.join("\n"))))}const Pe=e=>(e=>_(N(e).childNodes))(e).map(f)
...
//# sourceMappingURL=playerLog-b3e88e59.js.map
