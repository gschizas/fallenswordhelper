import{u as e,B as t,C as n,bA as s,H as a,T as r,Z as i,y as o,q as l,G as c,c as u,m as d,bM as f,bC as b,A as p,bR as h,h as m,i as y,v as L,x as g,o as v}from"./calfSystem-b136673a.js"
import"./insertElementBefore-eada6f05.js"
import{i as $}from"./insertElementAfterBegin-9a4b7ee1.js"
import{c as w}from"./createSpan-65142707.js"
import"./csvSplit-ab694daa.js"
import{s as x}from"./shouldBeArray-f0a179d2.js"
...
function W(e){return l(A(e),{progress:t(e[5])})}function H(e){(function(e){return!/No bounties active/.test(e.rows[1].cells[0].innerHTML)})(e)&&function(e){for(let t=1;t<e.rows.length-2;t+=2){const n=W(e.rows[t].cells)
B.bounty.push(n)}}(e)}function P(){return B&&r-B.lastUpdate>C||T&&r-T.lastUpdate>C}function E(e){const t=e[6]
return"[n/a]"!==c(t)?t.children[0].children[0].getAttribute("onclick"):""}const U=[()=>S.includes("*"),e=>S.includes(e),(e,t)=>u.wantedGuildMembers&&"[n/a]"===c(t.cells[6])]
function G(e,t){var n;(function(e,t){return"[active]"!==c(t.cells[6])&&U.some(n=>n(e,t))})(e,t)&&T.bounty.push((n=t.cells,l(A(n),{offerer:c(n[1].children[0].children[0]),tickets:c(n[5]),accept:E(n)})))}let O,q,X,K,Z,z
...
function _(e,t){B=s("bountyList"),T=s("wantedList"),C=a("bountyListRefreshTime"),M=a("bwNeedsRefresh"),M||P()&&(M=!0),Y.some(N)?(T={},T.bounty=[],T.isRefreshed=!0,T.lastUpdate=r,j=!1,S=x("wantedNames"),i("bwNeedsRefresh",!1),R(1).then(V)):function(e,t){t&&(T.isRefreshed=!1,I()),e&&(B.isRefreshed=!1,F())}(e,t)}function ee(e){e.target===X&&(b("bountyList",null),_(u.enableActiveBountyList,u.enableWantedList)),e.target===K&&(b("wantedList",null),_(u.enableActiveBountyList,u.enableWantedList))}function te(){g()||(u.enableWantedList&&(q=D(),$(f,q)),u.enableActiveBountyList&&(O=D(),$(f,O)),O&&v(O,ee),q&&v(q,ee),_(u.enableActiveBountyList,u.enableWantedList))}export default te
//# sourceMappingURL=activeWantedBounties-36f1fb3d.js.map
