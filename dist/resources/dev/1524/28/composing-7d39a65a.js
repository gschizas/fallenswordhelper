import{r as e,A as t,t as n,aH as s,ab as o,Z as a,bG as i,C as c,m as r,O as l,V as m,i as p,a4 as u,D as d,h as f,o as g,p as h,z as b,c as v,bH as C,B as S,a7 as E,j,H as k,y as N,J as x}from"./calfSystem-b136673a.js"
import{c as y}from"./createInput-08c848a9.js"
import{i as A}from"./insertElementBefore-eada6f05.js"
import{c as B}from"./createTable-629a2fee.js"
import{p as L,a as q}from"./pubsub-d172ae32.js"
import{g as I}from"./getArrayByClassName-d5f86271.js"
import{i as $}from"./insertHtmlAfterEnd-a4a64d97.js"
import{i as F}from"./insertElementAfter-a11d280f.js"
import{r as H,g as T}from"./rnd-162aabc4.js"
...
return 0===s&&b(e[1],t.insertCell(-1)),f(t.insertCell(-1),(o=(s+1).toString(),a=e[0],y({className:"awesome orange",dataset:{templateId:a},type:"button",value:o}))),t}function O(e,t,s,o){return e.reduce(n(M,o),s.insertRow(-1)),s}function R(e){return[e.value,e.text]}function V(e,t,s){const o=function(e,t,s){const o=B({id:"fshFastCompose"})
return D(o,s),e.reduce(n(O,t,s),o)}(d("#composing-template-multi option").map(R),t,s)
f(e,o),g(h,J),q("quickcreate",n(G,o))}function Z(e){m("composing","FastCompose"),p(e,"<br>")
...
//# sourceMappingURL=composing-7d39a65a.js.map
