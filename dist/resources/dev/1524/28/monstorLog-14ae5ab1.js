import{q as t,aH as e,au as s,e as n,ak as a,c as r,j as o,p as i,A as c,y as l,o as h,t as f,l as d}from"./calfSystem-b136673a.js"
import"./toLowerCase-27ea448e.js"
import{a as u}from"./addCommas-8259c1a9.js"
import{g as p,s as m}from"./idb-c31665cb.js"
import"./alpha-08ee6ec8.js"
import{d as g}from"./doSortParams-33bbd03c.js"
import{p as y,s as b,a as C}from"./stringSort-1bf3ba41.js"
...
return e+=n(t).map(k).join("<br>"),e+"</span>"}return'<span class="fshGrey">**Missing**</span>'}function L(s,n){return t(s[n],{name:n,image:(a=s[n].image_id,`<img class="tip-static" src="${e}creatures/${a}.png" data-tipped="<img src='${e}creatures/${a}.png' width=200 height=200>" width=40 height=40>`),level:u(s[n].level),attack:$(s[n].attack),defense:$(s[n].defense),armor:$(s[n].armor),damage:$(s[n].damage),hp:$(s[n].hp),enhancements:j(s[n].enhancements)})
