import{M as o,t as n,o as t,a4 as e,y as c,f as r,_ as a,aF as s}from"./calfSystem-19a5d332.js"
...
u[c]=e(u[c],{})
const r=u[c]
r.rows=r.rows||[],b(n,t,r,o)}function j(o){o.header.classList.toggle("fshPoint")}function F(o){h=!h,a(o,h),h?l():u.forEach(x),u.forEach(j)}function L(e){d=e.headInd,function(o){const t=c(o)
h=t.checked,r(c(o),"change",n(F,o))}(e.prefName),o(e.theTable.rows).forEach(n(N,e)),t(e.theTable,T)}export{L as c}
//# sourceMappingURL=collapse-736140c3.js.map
