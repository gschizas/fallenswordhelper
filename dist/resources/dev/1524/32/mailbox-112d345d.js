...
import{w as n,x as e,g as i,p as s,P as a,t as c,k as o,m as r,h as f,o as u,e as m,l as d,A as l,Q as p,y as h}from"./calfSystem-19a5d332.js"
import{c as k}from"./createInput-85638c5e.js"
import{c as b}from"./createLabel-828801e7.js"
import{c as g}from"./createUl-eb9ba17c.js"
import{i as v}from"./insertElementBefore-aa28f497.js"
import{j as T,o as j}from"./jsonFail-1861cebb.js"
...
n&&l("",n)}function M(t,n){T(n,t)||p(n.r)&&function(t,n){n.r.forEach(L),j(`${n.r.length.toString()} item(s) taken.`,t)}(t,n)}function Q(t,n){x(n).then(c(M,t))}function q(n,e,i){d("fshBls",i.target)&&function(n,e,i){const s=i.dataset.id,{invIds:a}=n[s]
...
!function(t,n){m(n).forEach(c(I,t))}(i,t),f(n,i),u(i,c(q,t,e))}function C(t){const n=r({id:"quickTake",innerHTML:'<div class="fshCenter"><br><font size="3"><b>Quick Take</b></font><br><br>Select which item to take all similar items from your Mailbox.</div><div></div>'}),e=function(t){const n=r(),e=g()
...
//# sourceMappingURL=mailbox-112d345d.js.map
