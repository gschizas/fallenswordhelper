import{d as t}from"./doSortParams-a31337c3.js"
import{H as e,aB as n,A as i,y as r,g as s,v as a,i as o,t as c,B as d,bg as p,aD as u,J as m,m as f,h,u as l,x as g,o as b,p as $}from"./calfSystem-19a5d332.js"
import{s as v,g as x}from"./idb-faef0351.js"
import{s as _}from"./shouldBeArray-63bb1c4a.js"
import{a as y}from"./stringSort-a73feb77.js"
import{a as N}from"./all-31b59575.js"
import"./csvSplit-a4e91aa0.js"
import"./alpha-6743d5a2.js"
import"./toLowerCase-ace931b6.js"
let j,k=[]
function w(t){return`<div class="rmItem"><img class="tip-dynamic" data-tipped="fetchitem.php?item_id=${t.id}&inv_id=-1&t=2&p=${j}&vcode=${t.verify}" src="${t.img}" height="20px" width="20px"><p>${t.amountPresent}/${t.amountNeeded}</p></div>`}function C(t){return`<div class="rmItem"><img class="tip-dynamic" data-tipped="fetchitem.php?item_id=${t.id}&inv_id=-1&t=2&p=${j}&vcode=${t.verify}" src="${t.img}" height="20px" width="20px"><p>${t.amountPresent}/${t.amountNeeded}</p></div>`}function S(t){return!k.includes(t.name)}function B(t){return`<tr class="rmTr"><td class="rmTd"><a href="${t.link}"><img src="${t.img}" height="30px" width="30px"></a></td><td class="rmTd"><a href="${t.link}">${t.name}</a></td><td class="rmTd">${function(t){return t.items?t.items.map(w).join(""):""}(t)}</td><td class="rmTd">${function(t){return t.components?t.components.map(C).join(""):""}(t)}</td><td class="rmTd">${function(t){return t.target?` <img class="tip-dynamic" data-tipped="fetchitem.php?item_id=${t.target.id}&inv_id=-1&t=2&p=${j}&vcode=${t.target.verify}" src="${t.target.img}" height="30px" width="30px"><br/>`:""}(t)}</td></tr>`}function T(t,r){r&&(e("hideRecipes")&&(k=_("hideRecipeNames")),function(t,e){j=n()
...
r+=e.recipe.filter(S).map(B).join(""),r+="</table>",i(r,t),v("fsh_recipeBook",e)}(t,r))}function A(t){const e=r("pCC",t).children[0].rows[4].cells[0].children[0]
...
return N(i)}function z(t){return/\/folder_on\./.test(t.getAttribute("src"))}function D(t,e){return 0!==e}function H(t){return t.value}function J(t,e,n){return u(`${t}&page=${n}`).then(e)}function M(t,e,n){return function(t){return s("option",m("customselect",r("pCC",t))[0]).filter(D).map(H)}(t).map(c(J,e,n))}function G(t,e,n){const i=a(n),r=function(t){return A(t).find(z).parentNode.href}(i),s=c(q,t,e),o=M(i,r,s)
...
//# sourceMappingURL=recipeMgr-e605ed05.js.map
