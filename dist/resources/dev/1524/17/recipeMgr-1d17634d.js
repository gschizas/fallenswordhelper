import{D as t,b8 as e,z as n,x as i,g as r,u as s,i as a,s as o,A as c,bv as d,aR as p,F as u,k as f,f as m,t as h,w as l,o as g,p as b}from"./calfSystem-1c103624.js"
import"./toLowerCase-9f60cfa4.js"
import{s as $,g as v}from"./idb-347cc2af.js"
import"./alpha-71a6f0bf.js"
import{a as x}from"./all-bf5942c7.js"
import"./csvSplit-0d83582d.js"
import{s as _}from"./shouldBeArray-2ea11280.js"
import{d as N}from"./doSortParams-266554df.js"
import{a as j}from"./stringSort-2a8c9e9b.js"
let k,w=[]
function y(t){return`<div class="rmItem"><img class="tip-dynamic" data-tipped="fetchitem.php?item_id=${t.id}&inv_id=-1&t=2&p=${k}&vcode=${t.verify}" src="${t.img}" height="20px" width="20px"><p>${t.amountPresent}/${t.amountNeeded}</p></div>`}function C(t){return`<div class="rmItem"><img class="tip-dynamic" data-tipped="fetchitem.php?item_id=${t.id}&inv_id=-1&t=2&p=${k}&vcode=${t.verify}" src="${t.img}" height="20px" width="20px"><p>${t.amountPresent}/${t.amountNeeded}</p></div>`}function S(t){return!w.includes(t.name)}function T(t){return`<tr class="rmTr"><td class="rmTd"><a href="${t.link}"><img src="${t.img}" height="30px" width="30px"></a></td><td class="rmTd"><a href="${t.link}">${t.name}</a></td><td class="rmTd">${function(t){return t.items?t.items.map(y).join(""):""}(t)}</td><td class="rmTd">${function(t){return t.components?t.components.map(C).join(""):""}(t)}</td><td class="rmTd">${function(t){return t.target?` <img class="tip-dynamic" data-tipped="fetchitem.php?item_id=${t.target.id}&inv_id=-1&t=2&p=${k}&vcode=${t.target.verify}" src="${t.target.img}" height="30px" width="30px"><br/>`:""}(t)}</td></tr>`}function A(i,r){r&&(t("hideRecipes")&&(w=_("hideRecipeNames")),function(t,i){k=e()
