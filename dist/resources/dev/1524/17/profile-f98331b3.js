import{o as t,p as n,s as e,aR as o,bv as s,x as a,b1 as r,T as i,M as c,z as f,f as u,i as l,aG as p,b8 as d,k as m,y as b,F as h,g,h as k,A as N,N as j,bw as C,U as v,bx as y,P as T,D as S,aq as x,aa as B,a4 as E,a as D,I as A,bp as L,X as M,by as _,bi as R,bz as q,bA as w,bu as I,r as G,a2 as H,b as P,d as J,a9 as U,bB as Q,bC as W,bD as F,G as z,E as O,a3 as V,w as X,e as K,a1 as Y,O as Z,J as tt}from"./calfSystem-1c103624.js"
import{n as nt}from"./numberIsNaN-40c4542d.js"
import"./round-c701b797.js"
import"./roundToString-c17b23bf.js"
import{r as et,b as ot}from"./render-c60bd0c9.js"
import{p as st}from"./playerName-191d9509.js"
import{t as at}from"./toLowerCase-9f60cfa4.js"
import"./createInput-7f1f4562.js"
import{i as rt}from"./insertTextBeforeEnd-99ca3a1f.js"
import"./onlineDot-764e0ffe.js"
import{s as it}from"./setTipped-d80523c9.js"
import"./batch-5d6f84ee.js"
import{c as ct,a as ft}from"./compressBio-15e584c3.js"
import"./createLabel-da6d9667.js"
import{c as ut}from"./currentGuildId-b6fa52f3.js"
import{i as lt}from"./intValue-f5e62e5b.js"
import{v as pt}from"./valueText-ef8b2cab.js"
import{c as dt}from"./createTBody-063a5f27.js"
import{c as mt}from"./createTable-930c2471.js"
import{c as bt}from"./createButton-c8469336.js"
import"./dialogMsg-d0fce5cd.js"
import{c as ht}from"./createSpan-475e9683.js"
import{h as gt}from"./hideElement-e9cdcfef.js"
import"./closest-a4273a71.js"
import"./closestTable-67ab97b7.js"
import"./insertHtmlBeforeBegin-ff6f06a1.js"
import{a as kt}from"./addStatTotalToMouseover-9ae5f9e8.js"
import{c as Nt}from"./closestForm-29ccb52c.js"
import"./all-bf5942c7.js"
import{a as $t}from"./allthen-a3d432e8.js"
import{c as jt}from"./chunk-ccdd17c4.js"
import{e as Ct}from"./errorDialog-3ded88bf.js"
import{g as vt}from"./getArrayByClassName-5fd609f9.js"
import"./rnd-39ca3451.js"
import{f as yt}from"./fetchdata-90c9a53c.js"
import{j as Tt}from"./jConfirm-dcf37b4e.js"
import"./dialog-5bdfcc8e.js"
import"./indexAjaxJson-ed231bc3.js"
import{e as St,u as xt}from"./useItem-c7484c7e.js"
import"./ajaxReturnCode-9f3bc5f9.js"
import"./daUseItem-81f661aa.js"
import{r as Bt}from"./replaceDoubleSpace-f11ce31f.js"
import"./csvSplit-0d83582d.js"
import{s as Et}from"./shouldBeArray-2ea11280.js"
import{i as Dt}from"./insertHtmlAfterEnd-cca1ed99.js"
import{q as At}from"./quickBuffHref-62aa05f3.js"
import{t as Lt}from"./textNodes-75c6c982.js"
let Mt
const _t=[t=>"A"===t.tagName,t=>Boolean(t.href),t=>t.href.includes("togglesection")]
function Rt(t,n){return n(t)}function qt(t){t.hasAttribute("style")?function(t){"block"===t.style.display&&gt(t),t.removeAttribute("style")}(t):t.classList.toggle("fshHide")}function wt(t){qt(5===Number(s(t.href,"section_id"))?(Mt||(Mt=a("backpackContainer")),Mt):t.parentNode.parentNode.nextElementSibling)}function It(t){const{target:n}=t;(function(t){return _t.every(e(Rt,t))})(n)&&(wt(n),o(n.href),t.preventDefault())}function Gt(){return r({subcmd:"loadcomponents"})}let Ht,Pt,Jt
...
n.replaceChild(o,e)}const Rn=[["self","fshGreen","guildSelfMessage"],["friendly","fshOliveDrab","guildFrndMessage"],["old","fshDarkCyan","guildPastMessage"],["enemy","fshRed","guildEnmyMessage"]],qn=[["guildFrnd","friendly"],["guildPast","old"],["guildEnmy","enemy"]]
function wn(t){const n=Et(t)
return n?n.map(Bt).map(at):[]}function In(t){return[wn(t[0]),t[1]]}function Gn(t,n){return n[0].includes(t)}function Hn(t){const n=qn.map(In),o=Bt(at(t)),s=n.find(e(Gn,o))
if(s)return s[1]}function Pn(t){return En=function(t){const n=/guild_id=([0-9]+)/i.exec(t.href)
if(n)return Number(n[1])}(t),En&&En===ut()?(M("guildSelf",N(t)),"self"):Hn(N(t))}function Jn(t){return t[0]===Dn}function Un(t){Dn=Pn(t),Dn&&function(t){const n=Rn.find(Jn)
t.parentNode.classList.add(n[1]),l(t.parentNode,"<br>"+S(n[2]))}(t)}function Qn(t,n,e){let o='<div align="center">'
o+=`<a class="quickButton buttonQuickBuff tip-static fshQuickBuff" ${At(n)}data-tipped="Buff ${e}"></a>&nbsp;&nbsp;`,o+=function(){if(!S("enableMaxGroupSizeToJoin"))return`<a class="quickButton buttonJoinAll tip-static fshJoin" href="${q}" data-tipped="Join All Groups"></a>&nbsp;&nbsp;`
...
//# sourceMappingURL=profile-f98331b3.js.map
