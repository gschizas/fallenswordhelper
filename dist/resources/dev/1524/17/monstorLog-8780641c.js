import{n as t,aG as s,au as e,l as n,ak as a,c as r,j as i,p as o,z as c,x as f,o as l,s as h}from"./calfSystem-1c103624.js"
import"./toLowerCase-9f60cfa4.js"
import{a as d}from"./addCommas-708246cb.js"
import{g as u,s as p}from"./idb-347cc2af.js"
import"./alpha-71a6f0bf.js"
import{d as m}from"./doSortParams-266554df.js"
import{p as g,s as y,a as b}from"./stringSort-2a8c9e9b.js"
...
function A(){c("<span>No monster information! Please enable entity log and travel a bit to see the world</span>",w)}function E(t){return`<tr><td class="fshCenter">${t.image}</td><td>${t.name}</td><td class="fshCenter">${t.creature_class}</td><td class="fshCenter">${t.level}</td><td class="fshCenter">${t.attack}</td><td class="fshCenter">${t.defense}</td><td class="fshCenter">${t.armor}</td><td class="fshCenter">${t.damage}</td><td class="fshCenter">${t.hp}</td><td class="fshCenter">${t.enhancements}</td></tr>`}function _(){const t=f("entityTableOutput")
