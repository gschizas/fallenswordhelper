import{r as n,y as t,p as e,h as i,o as s,S as o,U as a,C as r,N as c,by as u,ax as f,aw as m,P as l,j as p}from"./calfSystem-01eb06ed.js"
import{c as v}from"./createInput-7fd54c66.js"
import{i as d}from"./insertTextBeforeEnd-7d27fb10.js"
import{j as h,o as b}from"./jsonFail-aa8cac7f.js"
import{x as g}from"./xPath-e480b698.js"
function j(n){return function(n){return t({cmd:"inventing",subcmd:"doinvent",recipe_id:n})}(n)}let C,y,N
function w(n){var t
h(n,N)||b((t=n.r).item?`<span class="fshGreen">You successfully invented the item [${t.item.n}].</span>`:'<span class="fshRed">You have failed to invent the item.</span>',N)}function x(n){r(n,y),r("",N)}function I(){const n=Number(C.value)
if(!n)return void x("")
...
P(o("#pCC b"),n)}(),c('#pCC img[src*="/items/"]').forEach(R)}export default function(){p()&&(T(),k(e.lastElementChild))}
//# sourceMappingURL=inventing-d2261884.js.map
