import{ay as n,v as e,G as t,b4 as a,I as s,aO as l,ab as i,a5 as r,bg as o,z as f,ai as c,o as u,f as h,x as d,ak as p}from"./calfSystem-01eb06ed.js"
import{n as v}from"./numberIsNaN-5d7b8ccd.js"
import{b as m,p as g,c as y}from"./levelHighlight-3043bc40.js"
import"./all-6b303efd.js"
import{l as M,p as L}from"./lvlTests-bc179c25.js"
import{l as b}from"./loadDataTables-00c29ac6.js"
import{o as P}from"./onlinePlayersPage-1c6bd8fc.js"
...
return l-n>3e5?'<span> (takes a while to refresh so only do it if you really need to) </span><span id="fshRefresh" class="fshLink">[Refresh]</span>':`<span>[ Wait ${Math.round(300-(l-n)/1e3)}s ]</span>`}()}<div id="fshOutput"></div>`),c("fsh_onlinePlayers").then(H),u(T[0],E),h(T[0],"keyup",w)}export default function(n){f()||(T=n?$(n):$("#pCC"),b().then(F))}
//# sourceMappingURL=injectOnlinePlayers-1d950de6.js.map
