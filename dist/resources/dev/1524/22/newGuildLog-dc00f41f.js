import{u as t,t as e,bl as s,bm as i,x as n,A as o,p as a,o as c,g as d,z as r,y as h,G as l,v as f,C as u,B as p,I as m,i as g,K as b}from"./calfSystem-4cc738f8.js"
import"./playerName-2fd84b2a.js"
import"./fshOpen-91ef7542.js"
import"./openQuickBuffByName-ecb987ca.js"
import"./dataRows-03f8210c.js"
import{g as k,s as y}from"./idb-670c0cca.js"
import{c as w}from"./createTable-8f45252e.js"
import"./createStyle-639ee71b.js"
import{h as j}from"./hideElement-22c940e2.js"
import{p as L}from"./parseDateAsTimestamp-adcf08c1.js"
import{t as R}from"./toggleForce-521f5f12.js"
import{a as N}from"./all-4929a748.js"
import{e as G}from"./eventHandler5-839ad5d6.js"
import{s as v}from"./selfIdIs-40d5d5a8.js"
import{f as x}from"./functionPasses-3701c8f5.js"
import"./doBuffLinkClick-4a349c18.js"
import{a as T}from"./addLogColoring-329c397f.js"
import"./searchPlayerHref-23483064.js"
import{a as H}from"./addGuildLogWidgets-29b211b8.js"
...
s.className="divider",s.colSpan=3}(t)}function nt(t){t.checked=K.checks[t.getAttribute("item")]}function ot(){d("input",D).forEach(nt),Z()}function at(t,e){return t[0]-e[0]}function ct(){V&&Q.sort(at),r("Loading complete.",M),K.log=Q.filter(e(tt,(new Date).setSeconds(0,0))).map(et),Z(),function(){q=w({id:"fshInjectHere",className:"width_full"}),g(q,'<tbody><tr><td class="header" width="16">&nbsp;</td><td class="header" width="20%">Date</td><td class="header" width="80%">Message</td></tr></tbody>'),Q.forEach(it)
const t=h("fshInjectHere")
a.replaceChild(q,t),T("myGuildLog",1),H()}()}function dt(t){J(t),function(){const t=[]
...
K.checks[s]=!K.checks[s],Z(),Q.forEach(e(rt,s,!K.checks[s]))}function lt(t){t&&t.classList&&t.classList.remove("fshHide")}function ft(t){lt(t[5]),lt(t[6])}function ut(){K.checks=O.slice(0),ot(),Q.forEach(ft)}function pt(t){j(t[5]),j(t[6])}function mt(){K.checks=B.slice(0),ot(),Q.forEach(pt)}function gt(){K.log=!1,Z(),r("Loading Page 1 ...",M),Q=[],V=!0,o("",h("fshInjectHere")),I(1).then(dt)}function bt(t){!function(t){K=t||K,K.checks=K.checks||O.slice(0)}(t),o(E,a),D=h("fshNewGuildLog"),M=h("fshOutput"),c(D,G([[t=>"INPUT"===t.tagName,ht],[v("fshAll"),ut],[v("fshNone"),mt],[v("rfsh"),gt]])),ot(),F=Number(l("newGuildLogHistoryPages")),$=F,I(1).then(dt)}export default function(){n()||k("fsh_guildLog").then(bt)}
//# sourceMappingURL=newGuildLog-dc00f41f.js.map
