import{u as e,B as t,C as n,bt as s,H as a,S as r,Y as i,y as o,q as c,G as l,c as u,m as d,bF as b,bv as f,A as p,bK as h,h as m,i as y,v as L,x as g,o as v}from"./calfSystem-57628ebe.js"
import"./insertElementBefore-7e0a7ce8.js"
import{i as $}from"./insertElementAfterBegin-8d3bd0da.js"
import{c as w}from"./createSpan-4a052a9f.js"
import"./csvSplit-b214d56b.js"
import{s as x}from"./shouldBeArray-2a74e3f9.js"
import{f as N}from"./functionPasses-3c1df9d8.js"
...
function _(e,t){B=s("bountyList"),T=s("wantedList"),S=a("bountyListRefreshTime"),W=a("bwNeedsRefresh"),W||P()&&(W=!0),Z.some(N)?(T={},T.bounty=[],T.isRefreshed=!0,T.lastUpdate=r,j=!1,C=x("wantedNames"),i("bwNeedsRefresh",!1),R(1).then(V)):function(e,t){t&&(T.isRefreshed=!1,I()),e&&(B.isRefreshed=!1,D())}(e,t)}function ee(e){e.target===K&&(f("bountyList",null),_(u.enableActiveBountyList,u.enableWantedList)),e.target===X&&(f("wantedList",null),_(u.enableActiveBountyList,u.enableWantedList))}function te(){g()||(u.enableWantedList&&(q=z(),$(b,q)),u.enableActiveBountyList&&(O=z(),$(b,O)),O&&v(O,ee),q&&v(q,ee),_(u.enableActiveBountyList,u.enableWantedList))}export default te
//# sourceMappingURL=activeWantedBounties-806c3650.js.map
