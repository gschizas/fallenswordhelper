import{e as t,aS as e,D as n,b3 as s,b4 as a,E as o,C as r,z as i,b5 as c,G as f,i as l,w as u,S as m,t as p,aR as d,b6 as h,a7 as b,h as g,m as y,B as j,o as w,b7 as C,H as P,M as _,a3 as v,b8 as k,Y as $,x as L}from"./calfSystem-57628ebe.js"
import"./playerName-d617838d.js"
import{t as T}from"./toLowerCase-0a22477f.js"
import{a as B}from"./addCommas-0aacc5f1.js"
import{c as E}from"./createStyle-91aeec8a.js"
import{c as x}from"./currentGuildId-909a3fed.js"
import"./fshOpen-71b2b356.js"
import{o as R}from"./openQuickBuffByName-4b21bd39.js"
import"./dataRows-2520efc0.js"
import{g as G,s as S}from"./idb-5c863a6f.js"
import"./closest-14c30e26.js"
import{c as Y}from"./closestTr-125f03b2.js"
import"./indexAjaxJson-676110f0.js"
import"./cmdExport-2dc8f38e.js"
import{c as A}from"./csvSplit-b214d56b.js"
import{i as I}from"./insertHtmlAfterEnd-5ac4fa8d.js"
import{p as M}from"./parseDateAsTimestamp-a0fe37ba.js"
import{b as D}from"./buffObj-cea0717c.js"
import"./getProfile-905245f8.js"
import{m as H}from"./myStats-34d3679b.js"
import{c as N}from"./closestTd-ca27801b.js"
import{g as z}from"./getMembrList-1e9673b5.js"
import"./doBuffLinkClick-5033c62b.js"
import{a as O}from"./addLogColoring-ab00f47a.js"
let Q
...
t.cells[2].firstChild.remove(),b(t.cells[2],a),g(t.cells[2],y({innerHTML:o}))}const lt=([,,t])=>t&&t.s
...
return s?e="guild":a?e="ally":o&&(e="enemy"),[`.fshPlayerColoring tr:nth-of-type(${Y(t).rowIndex+1}) td:nth-of-type(3) > a:first-of-type`,e]}function gt(t,[e,n]){return t[n]?t[n].push(e):t[n]=[e],t}const yt={guild:"green",ally:"blue",enemy:"red"}
function jt([t,e]){return`${e.join(", ")} { color: ${yt[t]}; }`}const wt=([,t])=>t
function Ct(e,n){const s=function(e){return t(e.filter(wt).reduce(gt,{})).map(jt)}(n)
s.length&&(!function(t){const e=t.rows[0].cells[2]
e&&l(e,'&nbsp;&nbsp;<span class="fshWhite">(Guild mates show up in <span class="fshGreen">green</span>)</span>')}(e),e.classList.add("fshPlayerColoring"),g(document.body,E(s.join("\n"))))}const Pt=t=>(t=>_(N(t).childNodes))(t).map(f)
...
//# sourceMappingURL=playerLog-b657f984.js.map
