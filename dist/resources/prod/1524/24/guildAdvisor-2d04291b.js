import{n as t,m as s,h as a,a as e,t as n,a1 as r,A as i,i as c,x as l,b as o,p as d,c as f,M as u,J as m,a6 as p,G as h,B as v}from"./calfSystem-ec854151.js"
import{a as b}from"./addCommas-6d131931.js"
import"./currentGuildId-1299fc05.js"
import"./idb-72ad0068.js"
import{c as g}from"./createTable-4fb4ab07.js"
import"./indexAjaxJson-7630ad10.js"
import"./cmdExport-8168eb49.js"
import{i as j}from"./insertHtmlAfterEnd-29e289c9.js"
import"./all-e4fd8fad.js"
import{l as B}from"./loadDataTables-27ca2fa3.js"
import{g as y}from"./guild-abdc2f12.js"
import{a as C}from"./allthen-c22b3f9e.js"
import{g as S}from"./getMembrList-feaff568.js"
import{r as T}from"./replaceChild-35fb1f4f.js"
...
E(t,function(t){return w({innerHTML:`<tr><td class="fshRight" colspan="3">Total: </td>${t.slice(1).reduce(X,t[0].stats).map(b).reduce(q,"")}</tr>`})}(e),e.map(n(I,s)))}function W(t,s){return 0===s?h(t):v(t)}function _(t,s){const a=u(s.cells,W)
return a.splice(0,1,G(a[0],t),R(a[0],t),k(a[0],t)),a}function z(t,s){const e=function(t,s){return u(t.rows).slice(1,-1).map(n(_,s))}(t,s),r=function(t){const s=t.rows[t.rows.length-1].cloneNode(!0),e=w()
a(e,s)
const n=s.cells[0]
return n.className="fshRight",n.setAttribute("colspan","3"),e}(t)
E(t,r,e),function(){const t=m("custombutton",d)
0!==t.length&&j(t[0],`<span> <a href="${p}guild&subcmd=advisor&subcmd2=weekly">7-Day Summary</a></span>`)}()}function K(t){"weekly"===f.subcmd2?function(t){i('<span class="fshCurveContainer fshFlex"><span class="fshCurveEle fshCurveLbl fshOldSpinner"></span><span class="fshSpinnerMsg">&nbsp;Retrieving daily data ...</span></span>',t)
const s=[S(!1)].concat([1,2,3,4,5,6,7].map(n(F,t)))
C(s,n(O,t))}(t):S(!1).then(n(z,t))}function Q(){if(l())return
const t=o("table",d)[1]
t&&B().then(()=>K(t))}export default Q
//# sourceMappingURL=guildAdvisor-2d04291b.js.map
