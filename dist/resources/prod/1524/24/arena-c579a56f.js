import{aT as t,D as n,e,t as a,aU as s,d as r,w as o,q as c,x as i,U as l}from"./calfSystem-ec854151.js"
import{i as f}from"./isArray-2519a795.js"
...
import{s as p,g as v}from"./idb-72ad0068.js"
import{i as h}from"./interceptSubmit-99d78c5d.js"
import{c as b}from"./closestTr-25a90971.js"
import{l as g,p as x}from"./lvlTests-2fd3e201.js"
import{l as y}from"./loadDataTables-27ca2fa3.js"
...
var e})(t,e)&&V(n)}function P(t,n,e){d(e.players.map(a(O,t)).join("<br>"),n),n.classList.add("tip-static"),t&&"Join"===n.value&&function(t,n,e){e.players.filter(n=>n.guild_id===t).length===e.max_players/4&&V(n)}(t,n,e)}const Q=[t,t=>f(t.players),t=>t.players.length>0]
...
$("a",e).contents().unwrap(),$(n).prepend($("<thead/>").append(e))}function et(){J(),D(),$.fn.dataTable.ext.search.push(G)}function at(s,[r,o,c]){const i=$('table[width="635"]',s)
...
s.forEach(a(W,u())),s.forEach(a(K,e))}(c),et(),i.DataTable(k),function(t){$(X,t).off("click"),t.on("click",X,Y)}(s)}function st(t,e){n('#arenaTypeTabs tr[style="display: none;"]').forEach(t=>t.remove()),at(t,e),h()}function rt(){if(i())return
const t=$("#arenaTypeTabs")
1===t.length?L([v(T),v("fsh_arenaFull"),tt().catch(()=>({})),y()],a(st,t)):l("arena","Join error screen ?")}var ot=Object.freeze({__proto__:null,default:rt})
export{Z as a,ot as b,rt as i,tt as v}
//# sourceMappingURL=arena-c579a56f.js.map
