import{u as e,B as t,C as n,bx as s,H as r,S as a,Y as i,y as o,q as c,G as l,c as u,m as d,bJ as f,bz as b,A as p,bM as h,h as m,i as y,v as L,x as g,o as v}from"./calfSystem-ec854151.js"
import"./insertElementBefore-2ad05963.js"
import{i as $}from"./insertElementAfterBegin-a7242446.js"
import{c as w}from"./createSpan-3f02730c.js"
import"./csvSplit-dcc6dfc9.js"
import{s as x}from"./shouldBeArray-9b99ea80.js"
import{f as N}from"./functionPasses-3ebe883f.js"
...
B.bounty.push(n)}}(e)}function P(){return B&&a-B.lastUpdate>S||T&&a-T.lastUpdate>S}function E(e){const t=e[6]
...
function Y(){return d({className:"minibox"})}function D(){b("bountyList",B),p("",O)
...
B={},B.bounty=[],B.isRefreshed=!0,B.lastUpdate=a,n&&H(n),j=!0}(e),D())}function V(e){const t=L(e)
Q(t),u.enableWantedList&&(I(t),J<K?R(J+1).then(V):F())}const Z=[()=>!B,()=>!T,()=>M]
function _(e,t){B=s("bountyList"),T=s("wantedList"),S=r("bountyListRefreshTime"),M=r("bwNeedsRefresh"),M||P()&&(M=!0),Z.some(N)?(T={},T.bounty=[],T.isRefreshed=!0,T.lastUpdate=a,j=!1,W=x("wantedNames"),i("bwNeedsRefresh",!1),R(1).then(V)):function(e,t){t&&(T.isRefreshed=!1,F()),e&&(B.isRefreshed=!1,D())}(e,t)}function ee(e){e.target===X&&(b("bountyList",null),_(u.enableActiveBountyList,u.enableWantedList)),e.target===z&&(b("wantedList",null),_(u.enableActiveBountyList,u.enableWantedList))}function te(){g()||(u.enableWantedList&&(q=Y(),$(f,q)),u.enableActiveBountyList&&(O=Y(),$(f,O)),O&&v(O,ee),q&&v(q,ee),_(u.enableActiveBountyList,u.enableWantedList))}export default te
//# sourceMappingURL=activeWantedBounties-278d127c.js.map
