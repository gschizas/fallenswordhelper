import{x as t,d as o,t as n,g as e,aY as i,u as a,aX as p}from"./calfSystem-6459f18a.js"
import"./all-36f83e81.js"
import{a as c}from"./allthen-7d061027.js"
import{m as s}from"./assets-c6a1020c.js"
const u=[]
let l,r
...
$(`option[value=${e}]`,i).prop("selected",!0),t.append(i)}function C(t){$(t.target).off(),l=$('#pCC a[href*="=pickmove&"] img')
...
$("input",o).on("click",k),t.append(o)}(e)}function b(){if(t())return
const o=$('#pCC b:contains("Setup Combat Moves")')
1===o.length&&(o.addClass("fshLink fshGreen"),o.on("click",C))}export default b
//# sourceMappingURL=setup-e6924f4d.js.map
