import{n as t,aB as s,ap as e,l as n,ah as a,c as r,j as i,p as o,z as c,x as f,o as l,s as h}from"./calfSystem-be09bdff.js"
import"./toLowerCase-28455111.js"
import{a as d}from"./addCommas-f6a1bc8a.js"
import{g as p,s as u}from"./idb-a63ec135.js"
import"./alpha-21380883.js"
import{d as m}from"./doSortParams-640ef24f.js"
import{p as g,s as y,a as b}from"./stringSort-ff3f86cd.js"
...
function A(){c("<span>No monster information! Please enable entity log and travel a bit to see the world</span>",w)}function B(t){return`<tr><td class="fshCenter">${t.image}</td><td>${t.name}</td><td class="fshCenter">${t.creature_class}</td><td class="fshCenter">${t.level}</td><td class="fshCenter">${t.attack}</td><td class="fshCenter">${t.defense}</td><td class="fshCenter">${t.armor}</td><td class="fshCenter">${t.damage}</td><td class="fshCenter">${t.hp}</td><td class="fshCenter">${t.enhancements}</td></tr>`}function E(){const t=f("entityTableOutput")
