import{t as e,A as t,M as n,bD as s,D as a,Q as r,W as i,x as o,n as c,a8 as l,c as u,k as d,bP as b,bF as f,z as p,bR as h,f as m,i as y,u as L,w as g,o as v}from"./calfSystem-be09bdff.js"
import"./insertElementBefore-1fd7bda7.js"
import{i as w}from"./insertElementAfterBegin-c450d776.js"
import{c as $}from"./createSpan-1d780ca0.js"
import"./csvSplit-e4a6d9be.js"
import{s as x}from"./shouldBeArray-4191a3ae.js"
import{f as N}from"./functionPasses-7c70a053.js"
...
function K(){return d({className:"minibox"})}function Q(){f("bountyList",B),p("",D)
...
function _(e,t){B=s("bountyList"),T=s("wantedList"),W=a("bountyListRefreshTime"),M=a("bwNeedsRefresh"),M||E()&&(M=!0),Z.some(N)?(T={},T.bounty=[],T.isRefreshed=!0,T.lastUpdate=r,j=!1,P=x("wantedNames"),i("bwNeedsRefresh",!1),R(1).then(Y)):function(e,t){t&&(T.isRefreshed=!1,I()),e&&(B.isRefreshed=!1,Q())}(e,t)}function ee(e){e.target===X&&(f("bountyList",null),_(u.enableActiveBountyList,u.enableWantedList)),e.target===q&&(f("wantedList",null),_(u.enableActiveBountyList,u.enableWantedList))}export default function(){g()||(u.enableWantedList&&(G=K(),w(b,G)),u.enableActiveBountyList&&(D=K(),w(b,D)),D&&v(D,ee),G&&v(G,ee),_(u.enableActiveBountyList,u.enableWantedList))}
//# sourceMappingURL=activeWantedBounties-497495c7.js.map
