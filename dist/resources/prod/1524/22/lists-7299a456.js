import{bc as e,bx as t,A as s,y as a,bz as n,o as i,p as r,aK as c,aU as d}from"./calfSystem-d04e4be4.js"
import{i as l}from"./isArray-7fc52818.js"
import{i as o}from"./isChecked-522ec787.js"
import{a as u,m as h}from"./makePageTemplate-77251c26.js"
import{e as f}from"./eventHandler5-296d432a.js"
import{s as m}from"./selfIdIs-f08d01d9.js"
let p
...
return t}(t),n+=`<td><span class="HelperTextLink" data-itemId="${s}" id="fshDel${s}">[Del]</span></td></tr>`,e+n}function b(){let e='<table cellspacing="2" cellpadding="2" class="fshLists" width="100%"><tr class="fshOr">'
...
p.currentItems.splice(t,1),b()}function x(){let e={}
...
return e}(),p.currentItems.push(e),b()}function w(){const e=c(a("fshEd").value)
l(e)&&(p.currentItems=e,b())}function v(){"fshAso"===p.id?p.currentItems=c(d.quickSearchList):p.currentItems=[],b()}function A(e){i(e,f([[m("fshReset"),v],[m("fshSave"),w],[m("fshAdd"),x],[e=>e.id.startsWith("fshDel"),I]]))}function L(a){const n=a||r
