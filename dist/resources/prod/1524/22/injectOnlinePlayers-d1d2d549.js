import{aq as e,t as n,G as t,bj as a,a4 as s,a2 as l,Y as i,aU as r,x as o,o as f,f as u,v as c}from"./calfSystem-d04e4be4.js"
import{n as h}from"./numberIsNaN-eb16384c.js"
import{c as d}from"./currentGuildId-9ae9b1fe.js"
import{i as p}from"./intValue-ec94378e.js"
import"./valueText-bd7566e4.js"
import{b as v,p as m,c as g}from"./levelHighlight-67064a23.js"
import{g as y,s as M}from"./idb-0492f5ed.js"
import{l as L,p as b}from"./lvlTests-b64fe2f8.js"
import"./all-f846cd86.js"
import{l as x}from"./loadDataTables-b5e9e533.js"
import{o as P}from"./onlinePlayersPage-4bee721d.js"
...
return s-e>3e5?'<span> (takes a while to refresh so only do it if you really need to) </span><span id="fshRefresh" class="fshLink">[Refresh]</span>':`<span>[ Wait ${Math.round(300-(s-e)/1e3)}s ]</span>`}()}<div id="fshOutput"></div>`),y("fsh_onlinePlayers").then(S),f(D[0],Y),u(D[0],"keyup",k)}export default function(e){o()||(D=e?$(e):$("#pCC"),x().then(B))}
//# sourceMappingURL=injectOnlinePlayers-d1d2d549.js.map
