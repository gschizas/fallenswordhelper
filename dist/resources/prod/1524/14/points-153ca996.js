import{M as n,H as e,C as t,z as a,B as s,u as i,b4 as l,b5 as o,a3 as r,e as c,S as f,f as u,A as m,W as b,b6 as d}from"./calfSystem-d587d232.js"
import{n as x}from"./numberIsNaN-054e0c59.js"
import{i as p}from"./insertTextBeforeEnd-2aca15fb.js"
let E,S
const g={}
...
let l
t*i<=S?(l=t*s,a.className="fshBlue"):(l=Math.floor(S/i)*s,a.className="fshRed"),m(`(+${l} stamina)`,a)}function C(n,e,t){const{target:a}=t,s=Number(a.value),i=function(n,e){if(g[n]||(g[n]={}),!g[n].span){const t=f()
...
//# sourceMappingURL=points-153ca996.js.map
