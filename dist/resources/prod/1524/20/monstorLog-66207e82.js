import{q as t,aD as s,aq as e,m as n,ai as a,c as r,j as i,p as o,A as c,y as h,o as l,t as f,k as d}from"./calfSystem-03970067.js"
import"./toLowerCase-5a7ad345.js"
import{a as m}from"./addCommas-623b93c1.js"
import{g as p,s as u}from"./idb-3dad9172.js"
import"./alpha-bba33c85.js"
import{d as g}from"./doSortParams-6dff2cd1.js"
import{p as y,s as b,a as C}from"./stringSort-2a353898.js"
...
return s+=n(t).map(k).join("<br>"),s+"</span>"}return'<span class="fshGrey">**Missing**</span>'}function L(e,n){return t(e[n],{name:n,image:(a=e[n].image_id,`<img class="tip-static" src="${s}creatures/${a}.png" data-tipped="<img src='${s}creatures/${a}.png' width=200 height=200>" width=40 height=40>`),level:m(e[n].level),attack:$(e[n].attack),defense:$(e[n].defense),armor:$(e[n].armor),damage:$(e[n].damage),hp:$(e[n].hp),enhancements:j(e[n].enhancements)})
...
!function(t){"string"===t?A.sort(C):A.sort(w)}(function(t){return t.getAttribute("sortType")||"string"}(t)),B()}function D(t){const{target:s}=t
...
//# sourceMappingURL=monstorLog-66207e82.js.map
