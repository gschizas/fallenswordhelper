import{aT as t,D as n,e as a,t as e,aU as s,d as r,w as o,q as i,x as c,U as f}from"./calfSystem-a5fc99d4.js"
...
import{s as p,g as v}from"./idb-b13ab254.js"
import{i as h}from"./interceptSubmit-1ba9df73.js"
import{c as b}from"./closestTr-a52072b1.js"
import{l as g,p as x}from"./lvlTests-8400fcaa.js"
import{l as y}from"./loadDataTables-c20a07f5.js"
...
var a})(t,a)&&V(n)}function P(t,n,a){d(a.players.map(e(O,t)).join("<br>"),n),n.classList.add("tip-static"),t&&"Join"===n.value&&function(t,n,a){a.players.filter(n=>n.guild_id===t).length===a.max_players/4&&V(n)}(t,n,a)}const Q=[t,t=>l(t.players),t=>t.players.length>0]
...
$("a",a).contents().unwrap(),$(n).prepend($("<thead/>").append(a))}function at(){J(),D(),$.fn.dataTable.ext.search.push(G)}function et(s,[r,o,i]){const c=$('table[width="635"]',s)
...
s.forEach(e(W,u())),s.forEach(e(K,a))}(i),at(),c.DataTable(k),function(t){$(X,t).off("click"),t.on("click",X,Y)}(s)}function st(t,a){n('#arenaTypeTabs tr[style="display: none;"]').forEach(t=>t.remove()),et(t,a),h()}function rt(){if(c())return
const t=$("#arenaTypeTabs")
1===t.length?L([v(T),v("fsh_arenaFull"),tt().catch(()=>({})),y()],e(st,t)):f("arena","Join error screen ?")}var ot=Object.freeze({__proto__:null,default:rt})
export{Z as a,ot as b,rt as i,tt as v}
//# sourceMappingURL=arena-1472f1f7.js.map
