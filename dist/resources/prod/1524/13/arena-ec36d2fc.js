import{b4 as n,N as t,q as a,v as e,aj as s,bc as r,I as o,c,b3 as i,y as l,aP as d,z as f,a0 as u,ah as m}from"./calfSystem-e6a24264.js"
import{i as p}from"./isArray-3522bd29.js"
import{s as v}from"./setTipped-3dcc58a1.js"
import{a as h}from"./allthen-5b2ae140.js"
import{l as b,p as g}from"./lvlTests-4cd3827a.js"
import{l as y}from"./loadDataTables-c15b8735.js"
import{c as x}from"./changeMinMax-919d8716.js"
import{f as L,a as M,m as T,t as _}from"./assets-10d3888a.js"
import{u as j}from"./updateUrl-ffa346d7.js"
...
3!==t?e.order([3,"asc"],[t,a]).draw():e.order([3,a]).draw()}(t,t.index(),a)}function Y(n){return l(d({cmd:"arena"},n))}function Z(){return Y({subcmd:"view"})}function nn(n,t){const a=$("tr",t).first()
$("a",a).contents().unwrap(),$(t).prepend($("<thead/>").append(a))}function tn(){A(),F(),$.fn.dataTable.ext.search.push(z)}function an(r,[o,c,l]){const d=$('table[width="635"]',r)
d.each(nn),function(n){w=n||{},q=w.id||{},w.id={}}(o),function(n){n.children("tbody").children("tr").each(G)}(d),function(r){if(!n(r))return
...
s.forEach(e(V,i())),s.forEach(e(U,a))}(l),tn(),d.DataTable(_),function(n){$(W,n).off("click"),n.on("click",W,X)}(r),r.on("click",'input.custombutton[type="submit"]',j)}function en(n,a){t('#arenaTypeTabs tr[style="display: none;"]').forEach(n=>n.remove()),an(n,a)}function sn(){if(f())return
...
//# sourceMappingURL=arena-ec36d2fc.js.map
