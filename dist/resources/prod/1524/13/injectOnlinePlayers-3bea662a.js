import{av as n,v as e,G as t,b3 as a,I as s,aL as l,aa as i,a4 as r,bc as o,z as f,ah as c,o as u,f as h,x as d,aj as p}from"./calfSystem-e6a24264.js"
import{n as v}from"./numberIsNaN-c3be1434.js"
import{b as m,p as g,c as y}from"./levelHighlight-903ab6df.js"
import"./all-cd59a0c8.js"
import{l as L,p as M}from"./lvlTests-4cd3827a.js"
import{l as P}from"./loadDataTables-c15b8735.js"
import{o as b}from"./onlinePlayersPage-9a0df7de.js"
...
return l-n>3e5?'<span> (takes a while to refresh so only do it if you really need to) </span><span id="fshRefresh" class="fshLink">[Refresh]</span>':`<span>[ Wait ${Math.round(300-(l-n)/1e3)}s ]</span>`}()}<div id="fshOutput"></div>`),c("fsh_onlinePlayers").then(H),u(T[0],E),h(T[0],"keyup",k)}export default function(n){f()||(T=n?$(n):$("#pCC"),P().then(F))}
//# sourceMappingURL=injectOnlinePlayers-3bea662a.js.map
