import{R as t,C as n,S as s,T as e,b as a,U as i,D as f,V as c,W as u,N as r,v as l,X as o,A as d,Y as h,Z as b,z as m,_ as p,o as k}from"./calfSystem-e6a24264.js"
import{s as q}from"./setTipped-3dcc58a1.js"
import{d as v,q as T}from"./quickbuffSuccess-b85fa78c.js"
function S(f){const c=function(n){let s=t("span.fshLastActivity",n)
if(!s){s=e({className:"fshLastActivity"})
const t=a("h1",n)[0]
i(s,t)}return s}(t(`div.player[data-username="${f.username}"]`))
n(`Last Activity: ${s(f.last_login)}<br>Stamina: ${f.current_stamina} / ${f.stamina} ( ${Math.floor(f.current_stamina/f.stamina*100)}% )`,c)}function $(t){return Number(f(t).replace(/\[|\]/g,""))}function y(t,s,a){if(!s)return void n("",a)
const f=$(t.nextElementSibling.children[0].children[0]),c=function(t,n){if(!n){const n=e({className:"fshPlayer"})
...
//# sourceMappingURL=quickBuff-b705bb99.js.map
