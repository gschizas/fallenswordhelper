import{t,H as n,aL as s,c as e,U as o,b as f,p as a,B as u,l as r,A as c,y as i,e as l}from"./calfSystem-7aee5245.js"
import{r as p}from"./roundToString-9dec41f7.js"
import{p as d}from"./playerName-87d03488.js"
...
function y(t){return`<tr><td>${t[0]}</td><td>: ${t[1][0]}${t[1][1]}</td></tr>`}function L(t,n){return t[n[1][1]]+=n[1][0],t}function x(){const n=l(j.buffs),s=(e=n.reduce(L,{k:0,fsp:0,stam:0,unknown:0}),m.map(t(g,e)).join(""))
var e
...
let s,e
n?(s=function(t){return t[0].includes("k")?"k":t[0].includes("f")?"fsp":"stam"}(n),[e]=n[0].match(/([+-]?[.\d]+)/)):(s="unknown",e="1"),j.buffs[u(t)]=[parseFloat(e),s],j.count+=1}(t):(j.count-=1,delete j.buffs[s]),j.count>0?x():(c("&nbsp;",i("buffCost")),j.buffCostTotalText="")}function v(t){return t.tagName&&"SPAN"!==t.tagName?v(t.parentNode):t}function A(t){if("fshSendBuffMsg"===t.target.id)return void function(t){t.count>0&&$(t)}(j)
...
//# sourceMappingURL=render-eb8e7edc.js.map
