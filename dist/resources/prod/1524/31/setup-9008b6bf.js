...
import{x as o,d as n,t as e,g as i,aj as a,u as p,ai as c}from"./calfSystem-7aee5245.js"
...
t(n,h)}function b(){const o=i("select",r).map(f),n=o.map(m)
t(n,e(g,o))}function k(t,o,n){const e=function(t){const o=$(t).attr("src").match(s)
return o?o[1]:"x"}(n)
u.push(e)
...
r=o.get(0),o.append("<td/>"),l.each(e(k,o)),t.append(o)}(o),$('img[src*="arena/bar_spacer."]',o).attr({width:"15",height:"50"}),function(t){const o=$('<tr><td colspan=32 align=center style="padding-top: 2px;padding-bottom: 2px;"><input class="custombutton" value="Update" type="button"></td></tr>')
$("input",o).on("click",b),t.append(o)}(o)}function C(){if(o())return
const t=$('#pCC b:contains("Setup Combat Moves")')
1===t.length&&(t.addClass("fshLink fshGreen"),t.on("click",x))}export default C
//# sourceMappingURL=setup-9008b6bf.js.map
