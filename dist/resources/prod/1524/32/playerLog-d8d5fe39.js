...
import{e as t,ad as n,D as a,b9 as s,ba as o,E as r,C as i,z as c,bb as f,G as l,i as u,w as m,T as p,t as d,ay as h,bc as b,a8 as g,h as y,m as j,B as w,o as C,bd as P,H as _,M as v,a4 as $,be as k,Z as L,x as T}from"./calfSystem-45544049.js"
import{i as B}from"./insertHtmlAfterEnd-05df8cbc.js"
import{c as E}from"./currentGuildId-2687cdb7.js"
import{g as x}from"./getMembrList-dc370f1b.js"
import{c as G}from"./closestTr-709cb52e.js"
import{a as R}from"./addCommas-b2b2ad82.js"
import{p as S}from"./parseDateAsTimestamp-63431542.js"
import{g as A,s as I}from"./idb-ca3578bc.js"
import{c as M}from"./createStyle-e1e4f54e.js"
import{m as Y}from"./myStats-81d199a4.js"
import{b as D}from"./buffObj-40298e85.js"
import{c as H}from"./closestTd-8ae6810f.js"
...
if(a&&a.s)return ee||(ee={...n}),ee[t]={...a,logTime:S(l(e.cells[1]))/1e3},I("fsh_pvpCombat",ee),a}(e,t,n)}const se=e=>i(b,e),oe=([,e])=>!/\(Guild Conflict\)/.test(e),re=async([e,t])=>[e,t,await ae(e,/combat_id=(\d+)/.exec(t)[1])]
...
e.cells[2].firstChild.remove(),g(e.cells[2],s),y(e.cells[2],j({innerHTML:o}))}const le=([,,e])=>e&&e.s
...
return a?t="guild":s?t="ally":o&&(t="enemy"),[`.fshPlayerColoring tr:nth-of-type(${G(e).rowIndex+1}) td:nth-of-type(3) > a:first-of-type`,t]}function ge(e,[t,n]){return e[n]?e[n].push(t):e[n]=[t],e}const ye={guild:"green",ally:"blue",enemy:"red"}
function je([e,t]){return`${t.join(", ")} { color: ${ye[e]}; }`}const we=([,e])=>e
function Ce(e,n){const a=function(e){return t(e.filter(we).reduce(ge,{})).map(je)}(n)
...
if(!t.length)return
Ce(e,await Promise.all(t.map(be)))}],["addAttackLinkToLog",async function(e){const t=a('a[href*="=createsecure&"]',e)
if(!t.length)return
...
//# sourceMappingURL=playerLog-d8d5fe39.js.map
