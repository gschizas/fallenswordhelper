import{a as t}from"./addGuildLogWidgets-44f19d4d.js"
import{a as e}from"./addLogColoring-d97cbaf0.js"
import{a as s}from"./all-31b59575.js"
import{u as i,t as n,bn as a,bo as o,x as c,A as d,p as r,o as h,g as l,z as f,y as u,H as p,v as m,C as b,B as g,J as k,i as y,G as w}from"./calfSystem-45544049.js"
import{c as j}from"./createTable-7f36caa1.js"
...
import{p as G}from"./parseDateAsTimestamp-63431542.js"
import{s as v}from"./selfIdIs-05e1a8a1.js"
import{t as x}from"./toggleForce-d3228ccb.js"
import{g as H,s as T}from"./idb-ca3578bc.js"
import"./dataRows-d35c7cec.js"
import"./playerName-c1bcaeb9.js"
import"./searchPlayerHref-b001abe8.js"
...
if(W(n,a)){V=!1
break}Q.push([100*z+t,n,i,a,C(a)])}}(t)}function K(t){!function(t){_=m(t)
const e=b('input[name="page"]',_)
e&&(z=Number(e.value),U=Number(/\d+/.exec(g(e.parentNode))[0]),1===z&&($=Math.min(U,F)),f(`Loading ${z} of ${$}...`,M))}(t),Y()}function X(t){Q.push([0].concat(t))}function Z(){T("fsh_guildLog",J)}function tt(t,e){return e[1]!==t}function et(t){return t.slice(1,5)}function st(t,e){const s=t.insertCell(-1)
...
s.className="divider",s.colSpan=3}(t)}function nt(t){t.checked=J.checks[t.getAttribute("item")]}function at(){l("input",D).forEach(nt),Z()}function ot(t,e){return t[0]-e[0]}function ct(){V&&Q.sort(ot),f("Loading complete.",M),J.log=Q.filter(n(tt,(new Date).setSeconds(0,0))).map(et),Z(),function(){q=j({id:"fshInjectHere",className:"width_full"}),y(q,'<tbody><tr><td class="header" width="16">&nbsp;</td><td class="header" width="20%">Date</td><td class="header" width="80%">Message</td></tr></tbody>'),Q.forEach(it)
const s=u("fshInjectHere")
r.replaceChild(q,s),e("myGuildLog",1),t()}()}function dt(t){K(t),function(){const t=[]
...
J.checks[e]=!J.checks[e],Z(),Q.forEach(n(rt,e,!J.checks[e]))}function lt(t){t&&t.classList&&t.classList.remove("fshHide")}function ft(t){lt(t[5]),lt(t[6])}function ut(){J.checks=O.slice(0),at(),Q.forEach(ft)}function pt(t){N(t[5]),N(t[6])}function mt(){J.checks=B.slice(0),at(),Q.forEach(pt)}function bt(){J.log=!1,Z(),f("Loading Page 1 ...",M),Q=[],V=!0,d("",u("fshInjectHere")),P(1).then(dt)}function gt(t){!function(t){J=t||J,J.checks=J.checks||O.slice(0)}(t),d(E,r),D=u("fshNewGuildLog"),M=u("fshOutput"),h(D,L([[t=>"INPUT"===t.tagName,ht],[v("fshAll"),ut],[v("fshNone"),mt],[v("rfsh"),bt]])),at(),F=Number(p("newGuildLogHistoryPages")),$=F,P(1).then(dt)}function kt(){c()||H("fsh_guildLog").then(gt)}export default kt
//# sourceMappingURL=newGuildLog-a434c454.js.map
