import{m as t,k as s,f as a,a as e,s as n,$ as r,z as c,i,w as l,b as o,p as d,c as u,aD as f,F as m,a4 as p,a8 as h,A as v}from"./calfSystem-6fc0cc1b.js"
import{a as b}from"./addCommas-1fbf27a6.js"
import"./currentGuildId-33ea4168.js"
import"./idb-92d6a2b5.js"
import{c as g}from"./createTable-380d7c97.js"
import"./all-31f0cef5.js"
import{a as j}from"./allthen-14038593.js"
import"./indexAjaxJson-608117f0.js"
import{i as y}from"./insertHtmlAfterEnd-cb1e0a76.js"
import"./cmdExport-ce8b0402.js"
import{l as B}from"./loadDataTables-2ed3a59d.js"
import{g as C}from"./guild-6c498bb2.js"
import{g as S}from"./getMembrList-24c64c1b.js"
import{r as w}from"./replaceChild-ec811329.js"
...
0!==t.length&&y(t[0],`<span> <a href="${p}guild&subcmd=advisor&subcmd2=weekly">7-Day Summary</a></span>`)}()}function K(t){"weekly"===u.subcmd2?function(t){c('<span class="fshCurveContainer fshFlex"><span class="fshCurveEle fshCurveLbl fshOldSpinner"></span><span class="fshSpinnerMsg">&nbsp;Retrieving daily data ...</span></span>',t)
const s=[S(!1)].concat([1,2,3,4,5,6,7].map(n(M,t)))
j(s,n(I,t))}(t):S(!1).then(n(_,t))}export default function(){if(l())return
const t=o("table",d)[1]
t&&B().then(()=>K(t))}
//# sourceMappingURL=guildAdvisor-dbea4da7.js.map
