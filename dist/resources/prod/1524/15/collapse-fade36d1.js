import{av as o,s as n,o as t,$ as e,x as c,e as r,V as a,a7 as f}from"./calfSystem-740ec4d2.js"
import{h as s}from"./hideElement-f48178cf.js"
import{t as i}from"./toggleForce-d0f18056.js"
const u=[]
let h,d
...
u[c]=e(u[c],{})
const r=u[c]
r.rows=r.rows||[],N(n,t,r,o)}function L(o){o.header.classList.toggle("fshPoint")}function b(o){h=!h,a(o,h),h?l():u.forEach(x),u.forEach(L)}function v(e){d=e.headInd,function(o){const t=c(o)
h=t.checked,r(c(o),"change",n(b,o))}(e.prefName),o(e.theTable.rows).forEach(n(j,e)),t(e.theTable,T)}export{v as c}
//# sourceMappingURL=collapse-fade36d1.js.map
