import{L as t,z as n,b as e,A as s,I as a,s as i,M as f,x as r,N as c,w as u,o}from"./calfSystem-740ec4d2.js"
import{s as l}from"./setTipped-af58be0b.js"
import"./insertElementBefore-d3961941.js"
import{c as d}from"./createSpan-b29fd959.js"
import"./indexAjaxJson-1e1af708.js"
import{c as b}from"./csvSplit-dbbb8019.js"
import{i as m}from"./insertHtmlAfterEnd-85b35954.js"
import"./cmdExport-7c541a4f.js"
import{o as h}from"./outputFormat-5edaf4fe.js"
import{f as p}from"./formatLastActivity-00025420.js"
import{g as k}from"./getProfile-b78d4980.js"
import{i as q}from"./insertElementAfter-c1c5f2c6.js"
import{d as v,q as E}from"./quickbuffSuccess-dd329825.js"
...
n(`Last Activity: ${p(s.last_login)}<br>Stamina: ${s.current_stamina} / ${s.stamina} ( ${Math.floor(s.current_stamina/s.stamina*100)}% )`,a)}function T(t){return Number(s(t).replace(/\[|\]/g,""))}function g(t,e,s){if(!e)return void n("",s)
const a=T(t.nextElementSibling.children[0].children[0]),i=function(t,n){if(!n){const n=d({className:"fshPlayer"})
return q(n,t.nextElementSibling),n}return n}(t,s),f=function(t,n){return t>n?"fshRed":"fshGreen"}(a,e)
...
function B(t,n){(function(t,n){return!A.includes(Number(t.htmlFor.slice(6)))&&T(n.children[0])<125})(t,n)&&t.classList.add("fshDim")}function L(t){const n=t.children[0]
!function(t,n){const e=n.dataset.tipped,{cost:s}=t.previousElementSibling.dataset
l(e.replace("</center>",`<br>Stamina Cost: ${s}$&`),n)}(t,n),B(t,n)}function N(t){const n=r("skill-"+t)
n&&(n.checked=!0)}function H(){const t=f("blist")
...
let s=h(n,"m")
return n>0&&e>0&&(s+=" "),s+=h(e,"s"),s}(t)})</span>`}function F(n,e){const s=n[e]||0
return s?R(s):function(n){const e=t(`#buff-outer input[data-name="${n}"]`)
return e?`<span class="quickbuffActivate" data-buffid="${e.value}">Activate</span>`:'<span class="fshRed;">Off</span>'}(e)}function w(t,e,s){n(F(t,e),s)}function G(t,n){return t[n.name]=n.duration,t}function _(t,n){return n.name===t}function C(t,e,s){const a=function(t,n){const e=t.find(i(_,n))
return e&&e.value||0}(t,e)
let f="fshLime"
a<100&&(f="fshRed"),n(`<span class="${f}">${a}%</span>`,s)}function O(t){!function(t){const n=t._enhancements
C(n,"Sustain",r("fshSus")),C(n,"Fury Caster",r("fshFur"))}(t),function(t){const n=t._skills.reduce(G,{})
...
//# sourceMappingURL=quickBuff-ca7e1a4c.js.map
