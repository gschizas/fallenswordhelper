import{t,s as e,bh as s,bi as i,w as n,z as o,p as a,o as c,g as d,y as r,x as h,D as l,u as f,M as u,A as p,F as m,i as g,a8 as b}from"./calfSystem-8b6534a5.js"
import"./playerName-bb9c2b65.js"
import"./fshOpen-b5a7c2c8.js"
import"./openQuickBuffByName-ccc15ff1.js"
import"./dataRows-7ad53ca7.js"
import{g as k,s as y}from"./idb-abce8d8d.js"
import{c as w}from"./createTable-e198f036.js"
import"./createStyle-046c3f77.js"
import{h as j}from"./hideElement-551a92b9.js"
import{a as L}from"./all-a74f4d72.js"
import{e as R}from"./eventHandler5-e5345edb.js"
import{t as N}from"./toggleForce-c312b2b1.js"
import{s as G}from"./selfIdIs-0094e7b3.js"
import{p as v}from"./parseDateAsTimestamp-c909c985.js"
import{f as x}from"./functionPasses-3ba79ff2.js"
import{a as T}from"./addLogColoring-7c1e6876.js"
import"./searchPlayerHref-0290c148.js"
import{a as H}from"./addGuildLogWidgets-c3e43ae7.js"
...
s.className="divider",s.colSpan=3}(t)}function nt(t){t.checked=Q.checks[t.getAttribute("item")]}function ot(){d("input",C).forEach(nt),Z()}function at(t,e){return t[0]-e[0]}function ct(){W&&V.sort(at),r("Loading complete.",F),Q.log=V.filter(e(tt,(new Date).setSeconds(0,0))).map(et),Z(),function(){q=w({id:"fshInjectHere",className:"width_full"}),g(q,'<tbody><tr><td class="header" width="16">&nbsp;</td><td class="header" width="20%">Date</td><td class="header" width="80%">Message</td></tr></tbody>'),V.forEach(it)
...
Q.checks[s]=!Q.checks[s],Z(),V.forEach(e(rt,s,!Q.checks[s]))}function lt(t){t&&t.classList&&t.classList.remove("fshHide")}function ft(t){lt(t[5]),lt(t[6])}function ut(){Q.checks=M.slice(0),ot(),V.forEach(ft)}function pt(t){j(t[5]),j(t[6])}function mt(){Q.checks=O.slice(0),ot(),V.forEach(pt)}function gt(){Q.log=!1,Z(),r("Loading Page 1 ...",F),V=[],W=!0,o("",h("fshInjectHere")),P(1).then(dt)}function bt(t){!function(t){Q=t||Q,Q.checks=Q.checks||M.slice(0)}(t),o(D,a),C=h("fshNewGuildLog"),F=h("fshOutput"),c(C,R([[t=>"INPUT"===t.tagName,ht],[G("fshAll"),ut],[G("fshNone"),mt],[G("rfsh"),gt]])),ot(),$=Number(l("newGuildLogHistoryPages")),_=$,P(1).then(dt)}export default function(){n()||k("fsh_guildLog").then(bt)}
//# sourceMappingURL=newGuildLog-97d08f95.js.map
