import{t as e,A as t,M as n,bD as s,D as a,Q as r,W as i,x as o,n as l,a8 as c,c as u,k as b,bP as d,bF as f,z as p,bR as h,f as m,i as y,u as L,w as g,o as v}from"./calfSystem-8b6534a5.js"
import"./insertElementBefore-91801123.js"
import{i as w}from"./insertElementAfterBegin-982d3e85.js"
import{c as $}from"./createSpan-a256b285.js"
import"./csvSplit-69b90268.js"
import{s as x}from"./shouldBeArray-725a5113.js"
import{f as N}from"./functionPasses-3ba79ff2.js"
...
function S(e){return l(A(e),{progress:t(e[5])})}function C(e){(function(e){return!/No bounties active/.test(e.rows[1].cells[0].innerHTML)})(e)&&function(e){for(let t=1;t<e.rows.length-2;t+=2){const n=S(e.rows[t].cells)
B.bounty.push(n)}}(e)}function E(){return B&&r-B.lastUpdate>W||T&&r-T.lastUpdate>W}function H(e){const t=e[6]
return"[n/a]"!==c(t)?t.children[0].children[0].getAttribute("onclick"):""}const U=[()=>P.includes("*"),e=>P.includes(e),(e,t)=>u.wantedGuildMembers&&"[n/a]"===c(t.cells[6])]
function O(e,t){var n;(function(e,t){return"[active]"!==c(t.cells[6])&&U.some(n=>n(e,t))})(e,t)&&T.bounty.push((n=t.cells,l(A(n),{offerer:c(n[1].children[0].children[0]),tickets:c(n[5]),accept:H(n)})))}let D,G,X,q,z,F
function K(){return b({className:"minibox"})}function Q(){f("bountyList",B),p("",D)
...
var n
y(D,t)}function I(){f("wantedList",T),p("",G)
...
function _(e,t){B=s("bountyList"),T=s("wantedList"),W=a("bountyListRefreshTime"),M=a("bwNeedsRefresh"),M||E()&&(M=!0),Z.some(N)?(T={},T.bounty=[],T.isRefreshed=!0,T.lastUpdate=r,j=!1,P=x("wantedNames"),i("bwNeedsRefresh",!1),R(1).then(Y)):function(e,t){t&&(T.isRefreshed=!1,I()),e&&(B.isRefreshed=!1,Q())}(e,t)}function ee(e){e.target===X&&(f("bountyList",null),_(u.enableActiveBountyList,u.enableWantedList)),e.target===q&&(f("wantedList",null),_(u.enableActiveBountyList,u.enableWantedList))}export default function(){g()||(u.enableWantedList&&(G=K(),w(d,G)),u.enableActiveBountyList&&(D=K(),w(d,D)),D&&v(D,ee),G&&v(G,ee),_(u.enableActiveBountyList,u.enableWantedList))}
//# sourceMappingURL=activeWantedBounties-4356f39f.js.map
