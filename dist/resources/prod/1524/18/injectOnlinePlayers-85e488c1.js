import{ap as n,s as e,D as t,a2 as a,a0 as s,W as l,aV as i,w as r,o,e as f,u}from"./calfSystem-8b6534a5.js"
import{n as c}from"./numberIsNaN-0a4ef3fd.js"
import{c as d}from"./currentGuildId-4a8535f4.js"
import{i as h}from"./intValue-bb1f2246.js"
import"./valueText-ed45d645.js"
import{b as p,p as v,c as m}from"./levelHighlight-22a75054.js"
import{g,s as y}from"./idb-abce8d8d.js"
import"./all-a74f4d72.js"
import{l as M,p as b}from"./lvlTests-84d5bdc1.js"
import{l as L}from"./loadDataTables-388b4b0b.js"
import{o as P}from"./onlinePlayersPage-b7209d83.js"
...
for(let e=2;e<=G;e+=1)P(e).then(n)}function W(n){$("#fshOutput",_).append(n)}function A(n){W(" "+(z+1))
const t=u(n),a=$("#pCC input.custominput",t).first()
!function(n,t){const a=t.attr("value")
$('#pCC img[src$="/world/icon_action_view.png',n).parent().parent().parent().each(e(S,a))}(t,a),z+=1,1===z&&V(A,a),z===G&&(y("fsh_onlinePlayers",D),H(D))}function B(n){"fshRefresh"===n.target.id&&($("#fshRefresh",_).hide(),z=0,D={},P(1).then(A),l("lastOnlineCheck",a),W("Parsing online players...")),"fshReset"===n.target.id&&function(n){l("onlinePlayerMinLvl",i.onlinePlayerMinLvl),l("onlinePlayerMaxLvl",i.onlinePlayerMaxLvl),$("#fshMinLvl",n).val(i.onlinePlayerMinLvl),$("#fshMaxLvl",n).val(i.onlinePlayerMaxLvl),O()}(_)}function E(){_.html(`<span><b>Online Players</b></span>${function(){const n=t("lastOnlineCheck")
return a-n>3e5?'<span> (takes a while to refresh so only do it if you really need to) </span><span id="fshRefresh" class="fshLink">[Refresh]</span>':`<span>[ Wait ${Math.round(300-(a-n)/1e3)}s ]</span>`}()}<div id="fshOutput"></div>`),g("fsh_onlinePlayers").then(H),o(_[0],B),f(_[0],"keyup",k)}export default function(n){r()||(_=n?$(n):$("#pCC"),L().then(E))}
//# sourceMappingURL=injectOnlinePlayers-85e488c1.js.map
