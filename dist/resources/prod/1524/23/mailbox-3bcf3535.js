import{w as t,x as n,g as e,p as i,O as s,t as a,k as c,m as o,h as r,o as f,e as d,l as u,A as m,y as l}from"./calfSystem-019de1cf.js"
import{i as p}from"./isArray-de90de98.js"
import{c as h}from"./createInput-939428fe.js"
import{c as k}from"./createLabel-eacd9ffb.js"
import{i as b}from"./insertElementBefore-f1fdb06b.js"
import{c as g}from"./createUl-80b6130b.js"
import{c as v}from"./chunk-3dd35605.js"
import{j as T,o as j}from"./jsonFail-85165c1e.js"
...
n&&m("",n)}function M(t,n){T(n,t)||p(n.r)&&function(t,n){n.r.forEach(L),j(n.r.length.toString()+" item(s) taken.",t)}(t,n)}function q(t,n){x(n).then(a(M,t))}function B(t,n,e){u("fshBls",e.target)&&function(t,n,e){const i=e.dataset.id,{invIds:s}=t[i]
...
!function(t,n){d(n).forEach(a(I,t))}(i,t),r(n,i),f(i,a(B,t,e))}function A(t){const n=o({id:"quickTake",innerHTML:'<div class="fshCenter"><br><font size="3"><b>Quick Take</b></font><br><br>Select which item to take all similar items from your Mailbox.</div><div></div>'}),e=function(t){const n=o(),e=g()
...
//# sourceMappingURL=mailbox-3bcf3535.js.map
