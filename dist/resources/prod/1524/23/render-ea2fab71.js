import{t,G as n,aq as s,c as e,U as o,b as f,p as a,B as u,l as c,A as r,y as i,e as l}from"./calfSystem-019de1cf.js"
import{a as p}from"./roundToString-09c0d154.js"
import{p as d}from"./playerName-569fc693.js"
import{t as b}from"./toLowerCase-dda30e6b.js"
...
function T(t){return t&&"BR"!==t.nodeName}function S(t){return b(t.replace(w,"")).match(B)}function C(t){let n=function(t){let n="",s=t
for(;T(s);){const t=u(s)
...
let s,e
n?(s=function(t){return t[0].includes("k")?"k":t[0].includes("f")?"fsp":"stam"}(n),[e]=n[0].match(/([+-]?[.\d]+)/)):(s="unknown",e="1"),j.buffs[u(t)]=[parseFloat(e),s],j.count+=1}(t):(j.count-=1,delete j.buffs[s]),j.count>0?L():(r("&nbsp;",i("buffCost")),j.buffCostTotalText="")}function v(t){if("fshSendBuffMsg"===t.target.id)return void function(t){t.count>0&&$(t)}(j)
const n=function t(n){return n.tagName&&"SPAN"!==n.tagName?t(n.parentNode):n}(t.target);(function(t){return t.classList&&c("buffLink",t)})(n)&&N(n)}function A(t,n,s){return t.replace(n,`<span id="fshBuff${s}" class="buffLink fshBlue">${n.replace(/(`~)|(~`)|(\{b\})|(\{\/b\})/g,"")}</span>`)}function F(t){let n=t.replace(/\{b\}/g,"`~").replace(/\{\/b\}/g,"~`")
const s=n.match(/`~([^~]|~(?!`))*~`/g)
if(s)return n=s.reduce(A,n),n.indexOf("[cmd]")<0&&(n+="[cmd]"),n=n.replace("[cmd]",'<br><input id="fshSendBuffMsg" class="custombutton" type="button" value="Ask For Buffs"><br><span id="buffCost" class="fshRed">&nbsp;</span>'),n}export{v as b,F as r}
//# sourceMappingURL=render-ea2fab71.js.map
