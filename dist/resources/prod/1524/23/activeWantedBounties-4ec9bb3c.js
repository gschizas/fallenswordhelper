import{u as e,B as t,C as n,bx as s,G as a,S as r,Y as i,y as o,q as c,K as l,c as u,m as d,bJ as f,bz as b,A as p,bM as h,h as m,i as y,v as L,x as g,o as v}from"./calfSystem-019de1cf.js"
import"./insertElementBefore-f1fdb06b.js"
import{i as $}from"./insertElementAfterBegin-da8071d0.js"
import{c as w}from"./createSpan-c11958c4.js"
import"./csvSplit-4ba7a6af.js"
import{s as x}from"./shouldBeArray-f051bc29.js"
...
function _(e,t){B=s("bountyList"),T=s("wantedList"),S=a("bountyListRefreshTime"),M=a("bwNeedsRefresh"),M||E()&&(M=!0),Z.some(N)?(T={},T.bounty=[],T.isRefreshed=!0,T.lastUpdate=r,j=!1,W=x("wantedNames"),i("bwNeedsRefresh",!1),R(1).then(V)):function(e,t){t&&(T.isRefreshed=!1,F()),e&&(B.isRefreshed=!1,D())}(e,t)}function ee(e){e.target===K&&(b("bountyList",null),_(u.enableActiveBountyList,u.enableWantedList)),e.target===X&&(b("wantedList",null),_(u.enableActiveBountyList,u.enableWantedList))}export default function(){g()||(u.enableWantedList&&(q=Y(),$(f,q)),u.enableActiveBountyList&&(O=Y(),$(f,O)),O&&v(O,ee),q&&v(q,ee),_(u.enableActiveBountyList,u.enableWantedList))}
//# sourceMappingURL=activeWantedBounties-4ec9bb3c.js.map
