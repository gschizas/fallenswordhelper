import{aT as t,D as n,e,t as a,aU as s,d as r,w as o,q as i,x as c,U as d}from"./calfSystem-019de1cf.js"
import{i as f}from"./isArray-de90de98.js"
import{s as l}from"./setTipped-d4d554a0.js"
import{c as u}from"./currentGuildId-a399e8da.js"
import{i as m}from"./intValue-0e84cdad.js"
import{s as p,g as v}from"./idb-1bb3cee2.js"
import{i as h}from"./interceptSubmit-7b40d68d.js"
import{c as b}from"./closestTr-ad14f34f.js"
import{l as g,p as x}from"./lvlTests-8fcd92f9.js"
import{l as y}from"./loadDataTables-be4d5e60.js"
import{a as L}from"./allthen-f8a5c187.js"
import{c as M}from"./changeMinMax-29622459.js"
import{f as T,a as j,m as _,t as k}from"./assets-06ec229a.js"
...
var e})(t,e)&&V(n)}function P(t,n,e){l(e.players.map(a(O,t)).join("<br>"),n),n.classList.add("tip-static"),t&&"Join"===n.value&&function(t,n,e){e.players.filter(n=>n.guild_id===t).length===e.max_players/4&&V(n)}(t,n,e)}const Q=[t,t=>f(t.players),t=>t.players.length>0]
...
1===t.length?L([v(T),v("fsh_arenaFull"),tt().catch(()=>({})),y()],a(st,t)):d("arena","Join error screen ?")}var ot=Object.freeze({__proto__:null,default:rt})
export{Z as a,ot as b,rt as i,tt as v}
//# sourceMappingURL=arena-fbc47ae5.js.map
