import{t,aE as e,a1 as n,i as s,h as a,o,D as r,C as i,G as c,c as l,bZ as f,U as d,B as p,m as u,u as h,A as m,x as b}from"./calfSystem-019de1cf.js"
import{c as g}from"./createInput-939428fe.js"
import{o as j}from"./onlineDot-b729ce9d.js"
...
import"./createUl-80b6130b.js"
import"./idb-1bb3cee2.js"
import"./createButton-d01168f9.js"
import"./createLi-ff517651.js"
import{h as C}from"./hideElement-48576eeb.js"
import"./indexAjaxJson-d1b1f9ac.js"
import"./cmdExport-ca1fffed.js"
import{c as x}from"./csvSplit-4ba7a6af.js"
import{g as S}from"./getMembrList-cc8f3aea.js"
import{d as w,g as v}from"./getGroupStats-a516f2de.js"
import"./groupViewStats-4a9fbfc2.js"
...
!function(e,n){h({cmd:"guild",subcmd:"groups",subcmd2:"join",group_id:e}).then(t(z,n))}(/confirmJoin\((\d+)\)/.exec(e.href)[1],n)}}function H(){d("groups","joinAllGroupsUnderSize"),r('#pCC a[href*="confirmJoin"]').forEach(F)}function O(){const t=i('#pCC input[value="Join All Available Groups"]'),e=t.parentNode
...
o(e,L)}(e),l.subcmd2===f&&H()}export default function(){b()||(S(!1).then(y),function(){const t=c("minGroupLevel")
...
//# sourceMappingURL=groups-5f398be6.js.map
