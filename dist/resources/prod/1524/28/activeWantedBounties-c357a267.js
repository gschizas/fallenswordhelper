import{u as e,B as t,C as n,bt as s,H as a,S as r,Y as i,y as o,q as c,G as l,c as u,m as f,bF as d,bv as b,A as p,bK as h,h as m,i as y,v as L,x as g,o as v}from"./calfSystem-a5da5210.js"
import"./insertElementBefore-eada6f05.js"
import{i as $}from"./insertElementAfterBegin-619f3b2f.js"
import{c as w}from"./createSpan-8b1ff67f.js"
import"./csvSplit-ab694daa.js"
import{s as x}from"./shouldBeArray-ce366392.js"
...
function z(){return f({className:"minibox"})}function D(){b("bountyList",B),p("",O)
...
function _(e,t){B=s("bountyList"),T=s("wantedList"),S=a("bountyListRefreshTime"),W=a("bwNeedsRefresh"),W||P()&&(W=!0),Z.some(N)?(T={},T.bounty=[],T.isRefreshed=!0,T.lastUpdate=r,j=!1,C=x("wantedNames"),i("bwNeedsRefresh",!1),R(1).then(V)):function(e,t){t&&(T.isRefreshed=!1,I()),e&&(B.isRefreshed=!1,D())}(e,t)}function ee(e){e.target===K&&(b("bountyList",null),_(u.enableActiveBountyList,u.enableWantedList)),e.target===X&&(b("wantedList",null),_(u.enableActiveBountyList,u.enableWantedList))}function te(){g()||(u.enableWantedList&&(q=z(),$(d,q)),u.enableActiveBountyList&&(O=z(),$(d,O)),O&&v(O,ee),q&&v(q,ee),_(u.enableActiveBountyList,u.enableWantedList))}export default te
//# sourceMappingURL=activeWantedBounties-c357a267.js.map
