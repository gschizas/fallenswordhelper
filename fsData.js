	...
	buffList: function() {
		if (!Data.buffArray) {
			Data.buffArray = [
				...
				{name: "Gloat",              stamina: 25, "duration": 60,   minCastLevel: 900, treeId: 2, skillId: 81, buff: "+0.5% per point increase to the PvP Rating points transferred upon victory. Note if you lose to a player who has the Honor skill active, you will lose and additional 50% PvP Rating.", nicks: "gloat"},
